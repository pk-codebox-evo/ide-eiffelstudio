...
feature -- Properties
	...
	object_scoop_processor_id: NATURAL_16
		...
		do
			...
			if Result = 0 then
				if attached debugger_manager.application as app then
					i := app.remote_rt_scoop_manager.processor_id_from_object (object_address, object_dynamic_class)
...
feature -- Element change
	...
	set_object_scoop_processor_id (a_id: like object_scoop_processor_id)
		...
		do
			...
			scoop_pid_set: internal_object_scoop_processor_id = object_scoop_processor_id
		end
