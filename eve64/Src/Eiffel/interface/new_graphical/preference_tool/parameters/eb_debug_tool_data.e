...
feature {EB_SHARED_PREFERENCES, ES_DOCKABLE_TOOL_PANEL} -- Value
	...
	project_toolbar_layout: ARRAY [STRING]
		...
		do
			Result := <<"System_tool__visible", "Melt_project__visible", "Proof__visible", "AutoTest__visible", "Open_help_tool__visible", "System_info__visible", "Force_debug_mode__visible",
