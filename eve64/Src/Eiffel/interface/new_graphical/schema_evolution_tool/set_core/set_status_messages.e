...
feature -- Filter-related
        ...
        main_filter_dir_created (name: STRING): STRING is
...
feature -- Project release-related
        ...
        release (release_path: STRING): STRING is
                        -- Project released message.
                do
                        Result := "Project released at %"" + release_path + "%" folder."
                end

        handler_released (path: STRING): STRING is
