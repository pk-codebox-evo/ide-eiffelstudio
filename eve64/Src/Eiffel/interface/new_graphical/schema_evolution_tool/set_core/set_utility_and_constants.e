...
feature -- Constants
	...
	class_version (name: STRING; repo_ver: INTEGER): INTEGER is
	...
	current_dir: STRING is
			-- Current root directory.
		do
			Result := workbench.project_location.location
		end

	attributes_from_file (file: PLAIN_TEXT_FILE): DS_HASH_TABLE [STRING, STRING] is
...
--		end
	...
	copy_system_classes (i:INTEGER): DS_ARRAYED_LIST [DIRECTORY] is
	...
	filtered_fields_defaults (dir: DIRECTORY; class_name: STRING): DS_HASH_TABLE[STRING,STRING] is
...
feature -- Boolean queries
	...
	is_modified (file: PLAIN_TEXT_FILE): BOOLEAN is
...
feature {NONE} --implementation
	...
	attributes_from_ast (ast: CLASS_AS): DS_HASH_TABLE [STRING, STRING] is
		...
		do
			...
			feat := tmp.item_for_iteration
				if feat.is_attribute then
					...
					loop
						Result.force (type, feat.feature_names.item_for_iteration.visual_name)
...
--		end
	...
	copy_all (dir: DIRECTORY; res: DS_ARRAYED_LIST [DIRECTORY]) is
