note
	description: "Refinement of class profile, for display with EiffelVision."
	author: "Martino Trosi, ETH Zürich"
	date: "$Date$"
	revision: "$Revision$"

class
	SCOOP_PROFILER_EV_CLASS_PROFILE
...
feature -- Access
	...
	features: HASH_TABLE [SCOOP_PROFILER_EV_FEATURE_PROFILE, STRING]
