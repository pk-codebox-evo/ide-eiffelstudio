indexing
	...
	file:        "$URL: http://www.openehr.org/svn/ref_impl_eiffel/TRUNK/components/adl_parser/src/wrapper/c/shared_adl_objects.e $"
...
feature -- Access
	...
	integer_interval(a_handle: INTEGER): INTERVAL_EHR[INTEGER] is
		require
	...
	real_interval(a_handle: INTEGER): INTERVAL_EHR[REAL] is
		require
...
feature -- Commands
	...
	put_integer_interval(an_item: INTERVAL_EHR[INTEGER]; a_handle: INTEGER) is
		require
	...
	put_real_interval(an_item: INTERVAL_EHR[REAL]; a_handle: INTEGER) is
		require
