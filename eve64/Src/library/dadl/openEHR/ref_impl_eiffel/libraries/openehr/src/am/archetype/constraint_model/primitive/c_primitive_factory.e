indexing
	...
	file:        "$URL: http://www.openehr.org/svn/ref_impl_eiffel/TRUNK/libraries/openehr/src/am/archetype/constraint_model/primitive/c_primitive_factory.e $"
...
feature -- Factory
	...
	create_integer_interval_make_bounded (a_lower, an_upper: INTEGER; include_lower, include_upper: BOOLEAN): INTERVAL_EHR[INTEGER] is
	...
	create_integer_interval_make_lower_unbounded (an_upper: INTEGER; include_upper: BOOLEAN): INTERVAL_EHR[INTEGER] is
			-- create Result from -infinity to `an_upper'
		do
			create Result.make_lower_unbounded(an_upper, include_upper)
		end

	create_integer_interval_make_upper_unbounded (a_lower: INTEGER; include_lower: BOOLEAN): INTERVAL_EHR[INTEGER] is
	...
	create_real_interval_make_bounded (a_lower, an_upper: REAL; include_lower, include_upper: BOOLEAN): INTERVAL_EHR[REAL] is
			-- create Result with both limits set
		require
			valid_order: a_lower <= an_upper
		do
	...
	create_real_interval_make_lower_unbounded (an_upper: REAL; include_upper: BOOLEAN): INTERVAL_EHR[REAL] is
			-- create Result from -infinity to `an_upper'
		do
			create Result.make_lower_unbounded(an_upper, include_upper)
		end

	create_real_interval_make_upper_unbounded (a_lower: REAL; include_lower: BOOLEAN): INTERVAL_EHR[REAL] is
			-- create Result from `a_lower' to +infinity
		do
			create Result.make_upper_unbounded(a_lower, include_lower)
		end
	...
	create_c_integer_make_bounded (a_lower, an_upper: INTEGER; include_lower, include_upper: BOOLEAN): C_INTEGER is
		...
		require
			valid_order: a_lower <= an_upper
		do
			create Result.make_interval(create {INTERVAL_EHR[INTEGER]}.make_bounded(a_lower, an_upper, include_lower, include_upper))
		end

	create_c_integer_make_lower_unbounded (an_upper: INTEGER; include_upper: BOOLEAN): C_INTEGER is
			-- create Result from -infinity to `an_upper'
		do
			create Result.make_interval(create {INTERVAL_EHR[INTEGER]}.make_lower_unbounded(an_upper, include_upper))
		end

	create_c_integer_make_upper_unbounded (a_lower: INTEGER; include_lower: BOOLEAN): C_INTEGER is
			-- create Result from `a_lower' to +infinity
		do
			create Result.make_interval(create {INTERVAL_EHR[INTEGER]}.make_upper_unbounded(a_lower, include_lower))
		end
	...
	create_c_real_make_bounded (a_lower, an_upper: REAL; include_lower, include_upper: BOOLEAN): C_REAL is
		...
		require
			valid_order: a_lower <= an_upper
		do
			create Result.make_interval(create {INTERVAL_EHR[REAL]}.make_bounded(a_lower, an_upper, include_lower, include_upper))
		end

	create_c_real_make_lower_unbounded (an_upper: REAL; include_upper: BOOLEAN): C_REAL is
			-- create Result from -infinity to `an_upper'
		do
			create Result.make_interval(create {INTERVAL_EHR[REAL]}.make_lower_unbounded(an_upper, include_upper))
		end

	create_c_real_make_upper_unbounded (a_lower: REAL; include_lower: BOOLEAN): C_REAL is
			-- create Result from `a_lower' to +infinity
		do
			create Result.make_interval(create {INTERVAL_EHR[REAL]}.make_upper_unbounded(a_lower, include_lower))
		end
	...
	create_c_string_make_any: C_STRING_2 is
			-- create Result completely open
		do
			create Result.make_any
		end

	create_c_string_make_from_string (str: STRING): C_STRING_2 is
	...
	create_c_string_make_from_regexp (str: STRING): C_STRING_2 is
	...
	create_c_string_make_from_string_list (lst: LIST [STRING]): C_STRING_2 is
	...
	create_c_date_make_bounded (a_lower, an_upper: STRING): C_DATE_2 is
	...
	create_c_date_make_lower_unbounded (an_upper: STRING): C_DATE_2 is
	...
	create_c_date_make_upper_unbounded (a_lower: STRING): C_DATE_2 is
	...
	create_c_date_make_unbounded: C_DATE_2 is
			-- create Result as unbounded interval
		do
			create Result.make_string_interval(Void, Void)
		end

	create_c_date_make_pattern (a_pattern: STRING): C_DATE_2 is
