indexing
	...
	file:        "$URL: http://www.openehr.org/svn/ref_impl_eiffel/TRUNK/libraries/openehr/src/am/openehr_profile/data_types/quantity/c_dv_quantity.e $"
...
feature -- Access
	...
	default_value: QUANTITY is
		...
		local
			a_mag: REAL
			a_mag_ivl: INTERVAL_EHR [REAL]
			a_prec: INTEGER
			a_prec_ivl: INTERVAL_EHR [INTEGER]
 		do
...
feature -- Modification
	...
	add_unit_constraint (a_units: STRING; a_magnitude: INTERVAL_EHR [REAL]; a_precision: INTERVAL_EHR [INTEGER]) is
