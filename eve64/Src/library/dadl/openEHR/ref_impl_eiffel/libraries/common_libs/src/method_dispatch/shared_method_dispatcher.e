indexing
	...
	file:        "$URL: http://www.openehr.org/svn/ref_impl_eiffel/TRUNK/libraries/common_libs/src/method_dispatch/shared_method_dispatcher.e $"
...
--| License.
--|
--| The Original Code is shared_method_dispatcher.e.
--|
