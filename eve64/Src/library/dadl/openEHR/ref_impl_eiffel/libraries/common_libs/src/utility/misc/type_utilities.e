indexing
	...
	file:        "$URL: http://www.openehr.org/svn/ref_impl_eiffel/TRUNK/libraries/common_libs/src/utility/misc/type_utilities.e $"
...
feature -- Conversion
	...
	interval_integer_to_interval_integer_ref(a_ivl_integer: INTERVAL_EHR[INTEGER]): INTERVAL_EHR [INTEGER_REF] is
	...
	interval_real_to_interval_real_ref(a_ivl_real: INTERVAL_EHR[REAL]): INTERVAL_EHR [REAL_REF] is
	...
	interval_integer_ref_to_interval_integer(a_ivl_integer_ref: INTERVAL_EHR[INTEGER_REF]): INTERVAL_EHR [INTEGER] is
	...
	interval_real_ref_to_interval_real(a_ivl_real_ref: INTERVAL_EHR[REAL_REF]): INTERVAL_EHR [REAL] is
	...
	interval_double_ref_to_interval_double(a_ivl_ref: INTERVAL_EHR[DOUBLE_REF]): INTERVAL_EHR [DOUBLE] is
