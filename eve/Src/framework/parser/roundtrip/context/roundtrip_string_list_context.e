...
feature -- Operation
	...
	cursor_to_current_position: LINKED_LIST_CURSOR[STRING]
	...
	insert_after_cursor (s: STRING; c: LINKED_LIST_CURSOR[STRING])
			-- Insert `s' after `c'.
		do
			ctxt.go_to (c)
			ctxt.put_right (s)
	...
	valid_cursor(c: LINKED_LIST_CURSOR[STRING]): BOOLEAN
