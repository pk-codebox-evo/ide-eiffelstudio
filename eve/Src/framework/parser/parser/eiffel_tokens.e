...
feature -- Token codes
	...
	TE_LARRAY: INTEGER is 295
	TE_RARRAY: INTEGER is 296
	TE_RPARAN: INTEGER is 297
	TE_LCURLY: INTEGER is 298
	TE_RCURLY: INTEGER is 299
	TE_BANG: INTEGER is 300
	TE_SEMICOLON: INTEGER is 301
	TE_COLON: INTEGER is 302
	TE_COMMA: INTEGER is 303
	TE_CONSTRAIN: INTEGER is 304
	TE_QUESTION: INTEGER is 305
	...
	TE_PARTIAL_CLASS: INTEGER is 316
	TE_INFIX: INTEGER is 317
	TE_CREATION: INTEGER is 318
	TE_PRECURSOR: INTEGER is 319
	TE_PREFIX: INTEGER is 320
	TE_IS: INTEGER is 321
	TE_AGENT: INTEGER is 322
	TE_ALIAS: INTEGER is 323
	TE_ALL: INTEGER is 324
	TE_AS: INTEGER is 325
	...
	TE_HANDLER: INTEGER is 342
	TE_INDEXING: INTEGER is 343
	TE_INHERIT: INTEGER is 344
	TE_INSPECT: INTEGER is 345
	TE_INVARIANT: INTEGER is 346
	TE_LIKE: INTEGER is 347
	TE_LOCAL: INTEGER is 348
	TE_LOOP: INTEGER is 349
	TE_NOTE: INTEGER is 350
	TE_OBSOLETE: INTEGER is 351
	TE_ONCE: INTEGER is 352
	TE_ONCE_STRING: INTEGER is 353
	TE_REDEFINE: INTEGER is 354
	TE_REFERENCE: INTEGER is 355
	TE_RENAME: INTEGER is 356
	TE_REQUIRE: INTEGER is 357
	TE_RESCUE: INTEGER is 358
	TE_SELECT: INTEGER is 359
	TE_SEPARATE: INTEGER is 360
	TE_THEN: INTEGER is 361
	TE_UNDEFINE: INTEGER is 362
	TE_UNTIL: INTEGER is 363
	TE_VARIANT: INTEGER is 364
	TE_WHEN: INTEGER is 365
	TE_ACROSS: INTEGER is 366
	TE_ASSIGN: INTEGER is 367
	TE_ATTRIBUTE: INTEGER is 368
	TE_ATTACHED: INTEGER is 369
	TE_DETACHABLE: INTEGER is 370
	TE_SOME: INTEGER is 371
	TE_STRING: INTEGER is 372
	TE_EMPTY_STRING: INTEGER is 373
	TE_VERBATIM_STRING: INTEGER is 374
	TE_EMPTY_VERBATIM_STRING: INTEGER is 375
	TE_STR_LT: INTEGER is 376
	TE_STR_LE: INTEGER is 377
	TE_STR_GT: INTEGER is 378
	TE_STR_GE: INTEGER is 379
	TE_STR_MINUS: INTEGER is 380
	TE_STR_PLUS: INTEGER is 381
	TE_STR_STAR: INTEGER is 382
	TE_STR_SLASH: INTEGER is 383
	TE_STR_MOD: INTEGER is 384
	TE_STR_DIV: INTEGER is 385
	TE_STR_POWER: INTEGER is 386
	TE_STR_AND: INTEGER is 387
	TE_STR_AND_THEN: INTEGER is 388
	TE_STR_IMPLIES: INTEGER is 389
	TE_STR_OR: INTEGER is 390
	TE_STR_OR_ELSE: INTEGER is 391
	TE_STR_XOR: INTEGER is 392
	TE_STR_NOT: INTEGER is 393
	TE_STR_FREE: INTEGER is 394
	TE_STR_BRACKET: INTEGER is 395
