...
feature -- Token codes
	...
	TE_AGENT: INTEGER = 321
	TE_ALIAS: INTEGER = 322
	TE_ALL: INTEGER = 323
	TE_AS: INTEGER = 324
	TE_BIT: INTEGER = 325
	TE_CHECK: INTEGER = 326
	TE_CLASS: INTEGER = 327
	TE_CONVERT: INTEGER = 328
	TE_CREATE: INTEGER = 329
	TE_DEBUG: INTEGER = 330
	TE_DO: INTEGER = 331
	TE_ELSE: INTEGER = 332
	TE_ELSEIF: INTEGER = 333
	TE_ENSURE: INTEGER = 334
	TE_EXPANDED: INTEGER = 335
	TE_EXPORT: INTEGER = 336
	TE_EXTERNAL: INTEGER = 337
	TE_FEATURE: INTEGER = 338
	TE_FROM: INTEGER = 339
	TE_IF: INTEGER = 340
	TE_INHERIT: INTEGER = 341
	TE_INSPECT: INTEGER = 342
	TE_INVARIANT: INTEGER = 343
	TE_LIKE: INTEGER = 344
	TE_LOCAL: INTEGER = 345
	TE_LOOP: INTEGER = 346
	TE_OBSOLETE: INTEGER = 347
	TE_ONCE: INTEGER = 348
	TE_ONCE_STRING: INTEGER = 349
	TE_REDEFINE: INTEGER = 350
	TE_REFERENCE: INTEGER = 351
	TE_RENAME: INTEGER = 352
	TE_REQUIRE: INTEGER = 353
	TE_RESCUE: INTEGER = 354
	TE_SELECT: INTEGER = 355
	TE_SEPARATE: INTEGER = 356
	TE_THEN: INTEGER = 357
	TE_UNDEFINE: INTEGER = 358
	TE_UNTIL: INTEGER = 359
	TE_VARIANT: INTEGER = 360
	TE_WHEN: INTEGER = 361
	TE_ACROSS: INTEGER = 362
	TE_ASSIGN: INTEGER = 363
	TE_ATTRIBUTE: INTEGER = 364
	TE_ATTACHED: INTEGER = 365
	TE_DETACHABLE: INTEGER = 366
	TE_INDEXING: INTEGER = 367
	TE_IS: INTEGER = 368
	TE_NOTE: INTEGER = 369
	TE_SOME: INTEGER = 370
	TE_HANDLER: INTEGER = 371
	TE_STRING: INTEGER = 372
	TE_EMPTY_STRING: INTEGER = 373
	TE_VERBATIM_STRING: INTEGER = 374
	TE_EMPTY_VERBATIM_STRING: INTEGER = 375
	TE_STR_LT: INTEGER = 376
	TE_STR_LE: INTEGER = 377
	TE_STR_GT: INTEGER = 378
	TE_STR_GE: INTEGER = 379
	TE_STR_MINUS: INTEGER = 380
	TE_STR_PLUS: INTEGER = 381
	TE_STR_STAR: INTEGER = 382
	TE_STR_SLASH: INTEGER = 383
	TE_STR_MOD: INTEGER = 384
	TE_STR_DIV: INTEGER = 385
	TE_STR_POWER: INTEGER = 386
	TE_STR_AND: INTEGER = 387
	TE_STR_AND_THEN: INTEGER = 388
	TE_STR_IMPLIES: INTEGER = 389
	TE_STR_OR: INTEGER = 390
	TE_STR_OR_ELSE: INTEGER = 391
	TE_STR_XOR: INTEGER = 392
	TE_STR_NOT: INTEGER = 393
	TE_STR_FREE: INTEGER = 394
	TE_STR_BRACKET: INTEGER = 395
