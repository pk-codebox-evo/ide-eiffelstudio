...
feature -- Project file/directory warnings
	...
	w_Cannot_create_project_directory (dir_name: STRING): STRING_32
		require
	...
	w_Project_directory_not_exist (file_name, dir_name: STRING): STRING_32
	...
	w_Project_corrupted (dir_name: STRING_GENERAL): STRING_32
		require
			dir_name_not_void: dir_name /= Void
		do
	...
	w_configuration_files_needs_to_be_converted (a_file_name: STRING_GENERAL): STRING_32
		require
	...
	w_Project_incompatible (dir_name: STRING_GENERAL; comp_version, incomp_version: STRING_GENERAL): STRING_32
		require
			dir_name_not_void: dir_name /= Void
	...
	w_Project_incompatible_version (dir_name: STRING_GENERAL; comp_version, incomp_version: STRING_GENERAL): STRING_32
		require
	...
	w_unable_to_write_file (a_name: STRING_GENERAL): STRING_32 do Result := locale.formatted_string (locale.translation ("Unable to write file: $1"), [a_name]) end;

	w_file_is_corrupted (a_name: STRING_GENERAL): STRING_32 do Result := locale.formatted_string (locale.translation ("File $1 is corrupted"), [a_name]) end;

	w_file_can_not_be_open (a_name: STRING_GENERAL): STRING_32 do Result := locale.formatted_string (locale.translation ("File $1 cannot not be open"), [a_name]) end;

feature -- File warnings

	w_Cannot_create_file (file_name: STRING_GENERAL): STRING_32
		require
	...
	w_Cannot_create_directory (file_name: STRING_GENERAL): STRING_32
		require
			file_name_not_void: file_name /= Void
		do
	...
	w_Cannot_read_file (file_name: STRING_GENERAL): STRING_32
		require
			file_name_not_void: file_name /= Void
		do
	...
	w_cannot_read_ace_file_from_epr (epr_name, file_name: STRING_GENERAL): STRING_32
		require
	...
	w_file_not_exist (f_name: STRING): STRING
	...
	w_File_does_not_exist_execution_impossible (a_file_name: STRING_GENERAL): STRING_32
		require
			a_file_name_not_void: a_file_name /= Void
		do
	...
	w_Directory_not_exist (dir_name: STRING_GENERAL): STRING_32
	...
	w_Not_a_plain_file (file_name: STRING_GENERAL): STRING_32
		require
			file_name_not_void: file_name /= Void
		do
	...
	w_Not_creatable (file_name: STRING_GENERAL): STRING_32
		require
			file_name_not_void: file_name /= Void
		do
	...
	w_Not_creatable_choose_to_save (file_name: STRING_GENERAL): STRING_32
		require
			file_name_not_void: file_name /= Void
		do
	...
	w_Not_writable (file_name: STRING_GENERAL): STRING_32
		require
			file_name_not_void: file_name /= Void
		do
	...
	w_Still_referenced (a_class_name: STRING_GENERAL; referenced_classes: STRING_GENERAL): STRING_32
		require
	...
	w_File_exists (file_name: STRING_GENERAL): STRING_32
		require
			file_name_not_void: file_name /= Void
		do
	...
	w_Not_a_directory (dir_name: STRING_GENERAL): STRING_32
		require
			dir_name_not_void: dir_name /= Void
		do
	...
	w_Not_a_file (file_name: STRING_GENERAL): STRING_32
		require
			file_name_not_void: file_name /= Void
		do
	...
	w_Not_a_file_retry (file_name: STRING_GENERAL): STRING_32
		require
			file_name_not_void: file_name /= Void
		local
			l_str: STRING_32
	...
	w_Not_rename_swp (a_file_name, a_new_name: STRING_GENERAL): STRING_32
	...
	w_Not_rename (a_file_name, a_new_name: STRING_GENERAL): STRING_32
...
feature -- Debug warnings
	...
	w_Invalid_working_directory (wd: STRING_GENERAL): STRING_32
	...
	w_Not_a_condition (expr: STRING_GENERAL): STRING_32
	...
	w_Invalid_address (addr: STRING_GENERAL): STRING_32
	...
	w_Syntax_error_in_expression (expr: STRING_GENERAL): STRING_32
...
feature -- Cluster tree warnings
	...
	w_Class_already_in_cluster (base_name: STRING_GENERAL): STRING_32
		require
	...
	w_Class_already_exists (class_name: STRING_GENERAL): STRING_32
		require
			class_name_not_void: class_name /= Void
		do
	...
	w_Invalid_class_name (class_name: STRING_GENERAL): STRING_32
		require
			class_name_not_void: class_name /= Void
		local
			l_str: STRING_32
	...
	w_Invalid_cluster_name (cluster_name: STRING_GENERAL): STRING_32
		require
			cluster_name_not_void: cluster_name /= Void
		local
			l_str: STRING_32
	...
	w_Invalid_feature_name (feature_name: STRING_GENERAL): STRING_32
		require
	...
	w_Confirm_delete_class (class_name: STRING_GENERAL): STRING_32
		do
	...
	w_Confirm_delete_cluster (cluster_name: STRING_GENERAL): STRING_32
		do
	...
	w_Confirm_delete_cluster_debug (cluster_name: STRING_GENERAL): STRING_32
		do
	...
	w_Could_not_locate (cl_name: STRING_GENERAL): STRING_32
...
feature -- Dynamic library warnings
	...
	w_Not_a_compiled_class (cl_name: STRING_GENERAL): STRING_32
	...
	w_Not_a_compiled_class_line (cl_name: STRING_GENERAL): STRING_32
			-- The `cl_name' does not represent a valid class.
		do
			if cl_name /= Void then
				Result := locale.formatted_string (locale.translation ("%"$1%" is not a compiled class."), [cl_name])
	...
	w_No_exported_feature (f_name, cl_name: STRING_GENERAL): STRING_32
	...
	w_Cannot_load_library (fn: STRING_GENERAL): STRING_32
	...
	w_Cannot_save_library (fn: STRING_GENERAL): STRING_32
...
feature -- Project creation, retrieval, ...
	...
	w_Invalid_directory_or_cannot_be_created (a_directory_name: STRING_GENERAL): STRING_32
		do
			Result := locale.formatted_string (locale.translation (
	...
	w_Environment_changed (a_key, a_old_val, a_new_val: STRING_GENERAL): STRING_32
		local
...
feature -- Contract tool
	...
	w_contract_tool_merge_changes (a_name: STRING_GENERAL): STRING_32
		do
	...
	w_contract_tool_merge_syntax_invalid_changes (a_name: STRING_GENERAL): STRING_32
		do
...
feature -- Warning messages
	...
	w_class_attribute_expected (a_name: STRING_GENERAL; a_id: STRING_GENERAL): STRING_32
		do
			Result := locale.formatted_string (locale.translation ("class $1 $2 attribute expected"), [a_name, a_id])
		end

	w_class_attributes_expected (a_name: STRING_GENERAL; a_id: STRING_GENERAL): STRING_32
		do
			Result := locale.formatted_string (locale.translation ("class? $1, $2 attributes expected"), [a_name, a_id])
		end

	w_cluster_attribute_expected (a_name: STRING_GENERAL; a_id: STRING_GENERAL): STRING_32
		do
	...
	w_cannot_save_file (a_file_name: STRING_GENERAL): STRING_32
		do
	...
	w_cannot_convert_file (a_file_name: STRING_GENERAL): STRING_32
		require
			a_file_name_not_void: a_file_name /= Void
		do
	...
	w_cannot_save_png_file (a_file_name: STRING_GENERAL): STRING_32
		do
			if a_file_name /= Void then
	...
	w_Makefile_more_recent (make_file: STRING_GENERAL): STRING_32
		require
	...
	w_Makefile_does_not_exist (make_file: STRING_GENERAL): STRING_32
		require
			make_file_not_void: make_file /= Void
		do
			Result := locale.formatted_string (locale.translation (
	...
	w_File_changed (class_name: STRING_GENERAL): STRING_32
		do
	...
	w_Unable_to_execute_wizard (wizard_file: STRING_GENERAL): STRING_32
		do
			Result := locale.formatted_string (locale.translation (
	...
	w_short_internal_error (a_code: STRING_GENERAL): STRING_32
	...
	w_value_of_element_is_not_valid (a_name: STRING_GENERAL): STRING_32 do Result := locale.formatted_string (locale.translation ("Value of element $1 is not valid."), [a_name]) end;
	w_element_expected_not_found (a_name: STRING_GENERAL): STRING_32 do Result := locale.formatted_string (locale.translation ("Element $1 expected but not found."), [a_name]) end;
	...
	w_file_not_valid_assembly (a_file: STRING_GENERAL): STRING_32
		require
