...
feature{NONE} -- Prepared Statements
	...
	prepare_statements
		...
		do
			...
			mysql.prepare_statement (once "INSERT DELAYED INTO `semantic_search`.`PropertyBindings1` VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)")
			stmt_insert_bindings.put (mysql.last_statement, 1)
			mysql.prepare_statement (once "INSERT DELAYED INTO `semantic_search`.`PropertyBindings2` VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)")
			stmt_insert_bindings.put (mysql.last_statement, 2)
			mysql.prepare_statement (once "INSERT DELAYED INTO `semantic_search`.`PropertyBindings3` VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)")
			stmt_insert_bindings.put (mysql.last_statement, 3)
			mysql.prepare_statement (once "INSERT DELAYED INTO `semantic_search`.`PropertyBindings4` VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)")
			stmt_insert_bindings.put (mysql.last_statement, 4)
			mysql.prepare_statement (once "INSERT DELAYED INTO `semantic_search`.`PropertyBindings5` VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)")
			stmt_insert_bindings.put (mysql.last_statement, 5)
			mysql.prepare_statement (once "INSERT DELAYED INTO `semantic_search`.`PropertyBindings6` VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)")
			stmt_insert_bindings.put (mysql.last_statement, 6)
			mysql.prepare_statement (once "INSERT DELAYED INTO `semantic_search`.`PropertyBindings7` VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)")
			stmt_insert_bindings.put (mysql.last_statement, 7)
			mysql.prepare_statement (once "INSERT DELAYED INTO `semantic_search`.`PropertyBindings8` VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)")
			stmt_insert_bindings.put (mysql.last_statement, 8)
			mysql.prepare_statement (once "INSERT DELAYED INTO `semantic_search`.`PropertyBindings9` VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)")
