...
--	selected_assertions (a_attributes_retriever: FUNCTION [ANY, TUPLE [SEM_TRANSITION], EPA_STATE]; a_pre_state: BOOLEAN): DS_HASH_TABLE [TYPE_A, STRING]
...
--				loop
--					if l_selection_function = Void or else l_selection_function.item ([l_state_cursor.item, l_transition, a_pre_state]) then
