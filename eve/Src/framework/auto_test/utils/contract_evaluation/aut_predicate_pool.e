...
feature{NONE} -- Implementation
	...
	sorted_valuation_cursors (a_constraint: AUT_PREDICATE_CONSTRAINT; a_candidate: ARRAY [detachable ITP_VARIABLE]; a_config: TEST_GENERATOR_CONF_I): DS_ARRAYED_LIST [AUT_PREDICATE_VALUATION_CURSOR] is
