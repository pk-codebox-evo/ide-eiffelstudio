note
	description: "Summary description for {AUT_RANDOM_UNTRIED_SOURCE_OBJECT_STATE_INPUT_CREATOR}."
	author: ""
	date: "$Date$"
	revision: "$Revision$"

class
	AUT_RANDOM_UNTRIED_SOURCE_OBJECT_STATE_INPUT_CREATOR

inherit
	AUT_RANDOM_INPUT_CREATOR
		rename
