...
class
	EPA_AST_STRUCTURE_NODE_GENERATOR
...
feature -- Access
	...
	structure: detachable EPA_FEATURE_AST_STRUCTURE_NODE
			...
			if attached {BODY_AS} a_feature_as.body as l_body then
				if attached {ROUTINE_AS} l_body.content as l_routine then
					if attached {DO_AS} l_routine.routine_body as l_do then
						...
						create {EPA_FEATURE_AST_STRUCTURE_NODE} structure.make (l_ast, a_class, a_feature, 0, Void)
...
feature{NONE} -- Impelementation
	...
	parent_node: detachable EPA_AST_STRUCTURE_NODE
...
feature{NONE} -- Implementation
	...
	hashable_ast (a_ast: AST_EIFFEL): EPA_HASHABLE_AST
