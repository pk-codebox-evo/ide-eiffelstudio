note
	description: "Structural copy from {AST_VISITOR} to add post-process methods for AST iteration."
	date: "$Date$"
	revision: "$Revision$"
...
feature -- Quantification
	...
	post_process_there_exists_as (a_as: THERE_EXISTS_AS)
			-- Process `a_as'.
		deferred
		end

	post_process_for_all_as (a_as: FOR_ALL_AS)
			-- Process `a_as'.
		deferred
		end
