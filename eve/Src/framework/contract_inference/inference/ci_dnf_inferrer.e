...
feature -- Basic operations
	...
	infer (a_data: like data)
		...
		do
			...
			validate_candiate_properties (candidate_properties, operand_map_table, "Start validating DNF properties.")
			log_candidate_properties (candidate_properties, "Valid properties:")
...
--	generate_inferred_contracts (a_candidates: DS_HASH_SET [EPA_FUNCTION]; a_operand_map_table: DS_HASH_TABLE [HASH_TABLE [INTEGER_32, INTEGER_32], EPA_FUNCTION])
