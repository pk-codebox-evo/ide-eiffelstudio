...
feature {NONE} -- Initialization
	...
	make (a_out_stream: like out_stream; a_parsed_class: like parsed_class; a_matchlist: like match_list)
			-- Initialization.
		require
		...
		do
			...
			set_match_list (a_matchlist)
			set_parsed_class (a_parsed_class)
			set_will_process_leading_leaves (False)
			set_will_process_trailing_leaves (False)
		end
...
feature {CLASS_AS, CA_FIX} -- Process leafs
...
feature {CLASS_AS, CA_FIX} -- Class Declarations
...
feature {CLASS_AS, CA_FIX} -- Indexing
...
feature {CLASS_AS, CA_FIX} -- Inheritance
...
feature {CLASS_AS, CA_FIX} -- Generics
...
feature {CLASS_AS, CA_FIX} -- Creators
...
feature {CLASS_AS, CA_FIX} -- Convertors
...
feature {CLASS_AS, CA_FIX} -- Features
...
feature {CLASS_AS, CA_FIX} -- Routine
...
feature {CLASS_AS, CA_FIX} -- Instructions
