...
feature -- Basic operation
	...
	generate_change_requirements (a_target: AFX_FIXING_TARGET)
		...
		local
			l_target_expressions: EPA_HASH_SET [AFX_PROGRAM_STATE_EXPRESSION]
	...
	generate_for_two_expression
		...
		local
			l_target_expressions: EPA_HASH_SET [AFX_PROGRAM_STATE_EXPRESSION]
			l_expr1, l_expr2, l_new_expr: AFX_PROGRAM_STATE_EXPRESSION
			l_requirement: AFX_STATE_CHANGE_REQUIREMENT
			l_requirements: DS_LINKED_LIST[TUPLE[expr1: AFX_PROGRAM_STATE_EXPRESSION; expr2: AFX_PROGRAM_STATE_EXPRESSION]]
		do
			...
			create l_new_expr.make_with_text (l_expr2.class_, l_expr2.feature_, l_expr2.text + " + 1", l_expr2.written_class, l_expr2.breakpoint_slot)
			...
			create l_new_expr.make_with_text (l_expr1.class_, l_expr1.feature_, l_expr1.text + " + 1", l_expr1.written_class, l_expr1.breakpoint_slot)
			...
			create l_new_expr.make_with_text (l_expr2.class_, l_expr2.feature_, l_expr1.text, l_expr2.written_class, l_expr2.breakpoint_slot)
			l_requirements.force_last ([l_expr2, l_new_expr])

			create l_new_expr.make_with_text (l_expr2.class_, l_expr2.feature_, l_expr1.text + " + 1", l_expr2.written_class, l_expr2.breakpoint_slot)
			l_requirements.force_last ([l_expr2, l_new_expr])
			...
			create l_new_expr.make_with_text (l_expr1.class_, l_expr1.feature_, l_expr2.text, l_expr1.written_class, l_expr1.breakpoint_slot)
			l_requirements.force_last ([l_expr1, l_new_expr])

			create l_new_expr.make_with_text (l_expr1.class_, l_expr1.feature_, l_expr2.text + " + 1", l_expr1.written_class, l_expr1.breakpoint_slot)
			l_requirements.force_last ([l_expr1, l_new_expr])
...
--			l_requirements.force_last ([l_expr2, l_new_expr])
			...
			loop
				create l_requirement.make (l_requirements.item_for_iteration.expr1, l_requirements.item_for_iteration.expr2, current_fixing_target)
	...
	generate_for_one_expression
		...
		local
			l_target_expressions: EPA_HASH_SET [AFX_PROGRAM_STATE_EXPRESSION]
			l_expr, l_new_expr: AFX_PROGRAM_STATE_EXPRESSION
			l_requirement: AFX_STATE_CHANGE_REQUIREMENT
		...
		do
			...
			if l_expr.type.is_boolean then
				create l_new_expr.make_with_text (l_expr.class_, l_expr.feature_, "not (" + l_expr.text + ")", l_expr.written_class, l_expr.breakpoint_slot)
				create l_requirement.make (l_expr, l_new_expr, current_fixing_target)
				last_generated_requirements.force_last (l_requirement)
