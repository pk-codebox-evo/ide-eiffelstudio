...
feature -- Setting
	...
	extend_trunk
		...
		do
			children.extend (create {LINKED_LIST [EPA_AST_STRUCTURE_NODE]}.make)
		end
...
feature -- AST node
	...
	ast_nodes_string_representation (a_nodes: LINKED_LIST[EPA_AST_STRUCTURE_NODE]; a_level: INTEGER): STRING
	...
	ast_node_string_representation (a_node: EPA_AST_STRUCTURE_NODE; a_level: INTEGER): STRING
			-- String representation for `a_node' at indentation level `a_level'
		local
			l_cursor: CURSOR
			l_cursor2: CURSOR
			l_nodes: LINKED_LIST [EPA_AST_STRUCTURE_NODE]
		do
			create Result.make (1024)
