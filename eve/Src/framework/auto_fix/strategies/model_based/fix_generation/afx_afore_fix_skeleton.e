		...
		do
			if not a_ignore_state_change then
				...
				loop
					...
					fixes.force_last (fix_with_text ("%N" + l_fix_text, a_snippets.item_for_iteration.ranking, a_precondition, a_postcondition))
					a_snippets.forth
				end
			end
		end

	fix_with_text (a_text: STRING; a_snippet_ranking: INTEGER; a_precondition: EPA_STATE; a_postcondition: EPA_STATE): AFX_FIX
