...
feature -- Access
	...
	state_for_fault (a_tc: EPA_TEST_CASE_SIGNATURE): detachable like state_type
...
feature -- Status report
	...
	hast_state_for_fault (a_tc: EPA_TEST_CASE_SIGNATURE): BOOLEAN
...
feature -- Setting
	...
	put_state_for_fault (a_tc: EPA_TEST_CASE_SIGNATURE; a_state: like state_type)
			-- Associate fault indicated in `a_tc' with state `a_state'.
		do
			state.force (a_state, a_tc)
		end

	state: HASH_TABLE [like state_type, EPA_TEST_CASE_SIGNATURE]
