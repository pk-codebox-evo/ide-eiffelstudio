...
feature -- Access
	...
	node_name_set: DS_HASH_SET [STRING]
		...
		once
			...
			Result.force (node_compiler_array_as)
			Result.force (node_compiler_external_lang_as)
			Result.force (node_constant_as)
			Result.force (node_constraining_type_as)
			Result.force (node_constraint_list_as)
			...
			Result.force (node_formal_constraint_as)
			...
			Result.force (node_integer_constant)
			...
			Result.force (node_static_access_expr_as)
