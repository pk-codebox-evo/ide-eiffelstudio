...
feature -- Output
	...
	as_string: STRING
			-- String representation of current snippet containing
			-- operand definition and snippet content.
		local
...
feature -- Utility
	...
	operands: HASH_TABLE [STRING, STRING]
			...
			-- Keys are variable names (in lower case),
			-- values are types of those variables.
		do
			create Result.make (
