...
feature {NONE} -- Creation
	...
	make_with_arguments (a_output: like output; a_holes_by_location: like holes_by_location)
			-- Make with `a_output' and initialize empty `annotations'.
		require
			attached a_output
			attached a_holes_by_location
		do
			make_with_output (a_output)
			holes_by_location := a_holes_by_location
		end

feature -- Access

	holes_by_location: HASH_TABLE [EXT_HOLE, AST_PATH]
			-- Location information of holes.
