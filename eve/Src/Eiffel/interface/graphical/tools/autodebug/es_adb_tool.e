frozen class ES_ADB_TOOL

inherit
	ES_TOOL [ES_ADB_TOOL_PANEL]
...
feature {NONE} -- Factory
	...
	to_be_removed
		local
			l_1: ES_ADB_FIX_AUTOMATIC
			l_2: ES_ADB_FIX_CONTRACT
			l_3: ES_ADB_FIX_IMPLEMENTATION
			l_4: ES_ADB_FIX_MANUAL
			l_5: ES_ADB_TOOL_PANEL
			l_6: ES_ADB_EXTERNAL_PROCESS_LAUNCHER
		do

		end

	new_tool: ES_ADB_TOOL_PANEL
			-- <Precursor>
		do
