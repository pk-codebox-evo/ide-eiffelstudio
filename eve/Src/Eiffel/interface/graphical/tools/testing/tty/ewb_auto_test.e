...
feature {NONE} -- Initialization
	...
	make_with_arguments (a_arguments: LINKED_LIST [STRING_8])
			-- Initialize `auto_test_arguments' with `a_arguments'.
		require
			a_arguments_attached: a_arguments /= Void
		do
			create {DS_LINKED_LIST [STRING_8]} auto_test_arguments.make
...
feature -- Execution
	...
	auto_test_arguments: detachable DS_LIST [STRING_8]
	...
	check_arguments_and_execute
		...
		local
			i: INTEGER
			l_args: DS_LINKED_LIST [STRING_8]
		do
