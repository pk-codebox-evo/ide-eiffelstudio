...
feature -- Setters
	...
	set_version1_int (v1: INTEGER) is
			-- Set version1.
		require
	...
	set_version2_int (v2: INTEGER) is
			-- Set version2.
		require
...
feature -- Schema evolution handler
	...
	schema_evolution_handler: TUPLE [DS_ARRAYED_LIST [STRING], DS_HASH_TABLE [STRING, STRING]] is
...
feature {NONE} -- Recursive implementation
	...
	create_schema_evolution_handler (v1_dir, v2_dir: DIRECTORY; process: DS_HASH_TABLE[STRING,STRING]): DS_ARRAYED_LIST[STRING] is
	...
	create_schema_evolution_handler_file (v1,v2: INTEGER; class_name: STRING; process: DS_HASH_TABLE[STRING,STRING]; v1_file,v2_file: DS_HASH_TABLE[STRING,STRING]): DS_ARRAYED_LIST[STRING] is
