...
feature -- Basic operations
	...
	release: DS_ARRAYED_LIST[STRING] is
	...
	release_schema_evolution_handler: DS_ARRAYED_LIST [STRING] is
...
feature {NONE} --implementation
	...
	copy_all (current_dir, repo_dir: DIRECTORY; versions: SET_CLASSES_VERSIONS_MANAGER; release_number: INTEGER) is
	...
	update_file_with_version (file: PLAIN_TEXT_FILE; versions: SET_CLASSES_VERSIONS_MANAGER; release_number: INTEGER): STRING is
