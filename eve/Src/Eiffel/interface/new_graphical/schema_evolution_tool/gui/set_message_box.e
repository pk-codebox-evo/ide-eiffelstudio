...
feature -- Operation on messages.
	...
	print_message (txt: STRING) is
			-- Print a single text message.
		do
			append_text ("* " + txt + "%N")
		end

	print_messages (msgs: DS_ARRAYED_LIST[STRING]) is
			-- Print more messages.
		do
	...
	print_release (release_path: STRING) is
			-- Print the release message.
		do
			print_message (messages.release (release_path))
		end

	print_handlers_dir_creation (name: STRING) is
	...
	print_repo_handlers_dir_creation (name:STRING) is
