note
	description	: "Class which is launching SCOOP record/replay wizard."
	author		: "Rusakov Andrey"
	date		: "$Date$"
	revision	: "$Revision$"

class
	EB_SCOOP_REPLAY_WIZARD_MANAGER
...
feature {NONE} -- Initialization
	...
	make_and_launch (a_parent_window: EV_WINDOW)
			-- Create and display the SCOOP execution replay wizard.
			-- The window is shown modal to `a_parent_window'.
		local
			wizard_initial_state: EB_SCOOP_REPLAY_WIZARD_INITIAL_STATE
			wizard_initial_info: EB_SCOOP_REPLAY_WIZARD_INFORMATION
		do
...
feature {NONE} -- Implementation
	...
	wizard_title: STRING_GENERAL
		...
		do
			Result := Interface_names.t_SCOOP_replay_wizard
		end
