...
feature -- Query
	...
	test_command: EB_AUTO_TEST_COMMAND
			-- AutoTest command
...
--		end
	...
	set_test_command (a_command: like test_command)
			-- Sets `test_command' with `a_command'
		do
			test_command := a_command
		ensure
			test_command_set: test_command = a_command
		end
