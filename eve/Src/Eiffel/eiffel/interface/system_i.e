					...
					agent (a_class_c: CLASS_C)
						...
						do
							...
							then
								...
								a_class_c.lace_class.config_class.invalidate
								a_class_c.original_class.reset_compiled_class
								system.remove_unref_class (a_class_c.lace_class)
								system.classes.remove (a_class_c.class_id)
								system.remove_class (a_class_c)
								system.force_rebuild

								degree_5.remove_class (a_class_c)
								degree_4.remove_class (a_class_c)
								degree_3.remove_class (a_class_c)
								degree_scoop.remove_class (a_class_c)
								degree_2.remove_class (a_class_c)
								degree_1.remove_class (a_class_c)
								degree_minus_1.remove_class (a_class_c)
							end
