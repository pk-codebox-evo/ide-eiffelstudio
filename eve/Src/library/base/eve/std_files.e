...
--		end
	...
	last_integer: INTEGER--, lastint, last_integer_32: INTEGER
...
--		end
	...
	last_string: STRING--, laststring: STRING
...
--		end
	...
	put_string (s: STRING)--, putstring (s: STRING)
...
--		end
	...
	put_integer (i: INTEGER)--, putint, put_integer_32 (i: INTEGER)
...
feature -- EVE
	...
	internal_last_string_: V_STRING

	last_string_: V_STRING
			-- Last string read by `read_line'.
		do
			Result := internal_last_string_
		ensure
			Result = internal_last_string_
		end
