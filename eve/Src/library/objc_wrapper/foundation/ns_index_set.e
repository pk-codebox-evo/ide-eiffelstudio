...
--	objc_enumerate_ranges_using_block_ (an_item: POINTER; a_block: UNSUPPORTED_TYPE)
--			-- Auto generated Objective-C wrapper.
--		external
--			"C inline use <Foundation/Foundation.h>"
--		alias
--			"[
--				[(NSIndexSet *)$an_item enumerateRangesUsingBlock:];
--			 ]"
--		end

--	objc_enumerate_ranges_with_options__using_block_ (an_item: POINTER; a_opts: NATURAL_64; a_block: UNSUPPORTED_TYPE)
--			-- Auto generated Objective-C wrapper.
--		external
--			"C inline use <Foundation/Foundation.h>"
--		alias
--			"[
--				[(NSIndexSet *)$an_item enumerateRangesWithOptions:$a_opts usingBlock:];
--			 ]"
--		end

--	objc_enumerate_ranges_in_range__options__using_block_ (an_item: POINTER; a_range: POINTER; a_opts: NATURAL_64; a_block: UNSUPPORTED_TYPE)
--			-- Auto generated Objective-C wrapper.
--		external
--			"C inline use <Foundation/Foundation.h>"
--		alias
--			"[
--				[(NSIndexSet *)$an_item enumerateRangesInRange:*((NSRange *)$a_range) options:$a_opts usingBlock:];
--			 ]"
--		end
...
--	enumerate_ranges_using_block_ (a_block: UNSUPPORTED_TYPE)
--			-- Auto generated Objective-C wrapper.
--		local
--		do
--			objc_enumerate_ranges_using_block_ (item, )
--		end

--	enumerate_ranges_with_options__using_block_ (a_opts: NATURAL_64; a_block: UNSUPPORTED_TYPE)
--			-- Auto generated Objective-C wrapper.
--		local
--		do
--			objc_enumerate_ranges_with_options__using_block_ (item, a_opts, )
--		end

--	enumerate_ranges_in_range__options__using_block_ (a_range: NS_RANGE; a_opts: NATURAL_64; a_block: UNSUPPORTED_TYPE)
--			-- Auto generated Objective-C wrapper.
--		local
--		do
--			objc_enumerate_ranges_in_range__options__using_block_ (item, a_range.item, a_opts, )
--		end
