...
--		end
	...
	objc_set_attributes_with_dictionary_ (an_item: POINTER; a_attributes: POINTER)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <Foundation/Foundation.h>"
		alias
			"[
				[(NSXMLElement *)$an_item setAttributesWithDictionary:$a_attributes];
			 ]"
		end
...
feature -- NSXMLElement
	...
	set_attributes_with_dictionary_ (a_attributes: detachable NS_DICTIONARY)
			-- Auto generated Objective-C wrapper.
		local
			a_attributes__item: POINTER
		do
			...
			objc_set_attributes_with_dictionary_ (item, a_attributes__item)
		end
