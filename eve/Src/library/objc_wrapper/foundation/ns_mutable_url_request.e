...
feature -- NSMutableURLRequest
	...
	set_network_service_type_ (a_network_service_type: NATURAL_64)
			-- Auto generated Objective-C wrapper.
		local
		do
			objc_set_network_service_type_ (item, a_network_service_type)
		end
...
feature {NONE} -- NSMutableURLRequest Externals
	...
	objc_set_network_service_type_ (an_item: POINTER; a_network_service_type: NATURAL_64)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <Foundation/Foundation.h>"
		alias
			"[
				[(NSMutableURLRequest *)$an_item setNetworkServiceType:$a_network_service_type];
			 ]"
		end
...
feature -- NSMutableHTTPURLRequest
	...
	set_http_should_use_pipelining_ (a_should_use_pipelining: BOOLEAN)
			-- Auto generated Objective-C wrapper.
		local
		do
			objc_set_http_should_use_pipelining_ (item, a_should_use_pipelining)
		end
...
feature {NONE} -- NSMutableHTTPURLRequest Externals
	...
	objc_set_http_should_use_pipelining_ (an_item: POINTER; a_should_use_pipelining: BOOLEAN)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <Foundation/Foundation.h>"
		alias
			"[
				[(NSMutableURLRequest *)$an_item setHTTPShouldUsePipelining:$a_should_use_pipelining];
			 ]"
		end
