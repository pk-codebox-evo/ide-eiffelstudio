...
feature -- NSUndoManager
	...
	set_action_is_discardable_ (a_discardable: BOOLEAN)
			-- Auto generated Objective-C wrapper.
		local
		do
			objc_set_action_is_discardable_ (item, a_discardable)
		end

	undo_action_is_discardable: BOOLEAN
			-- Auto generated Objective-C wrapper.
		local
		do
			Result := objc_undo_action_is_discardable (item)
		end

	redo_action_is_discardable: BOOLEAN
			-- Auto generated Objective-C wrapper.
		local
		do
			Result := objc_redo_action_is_discardable (item)
		end
...
feature {NONE} -- NSUndoManager Externals
	...
	objc_set_action_is_discardable_ (an_item: POINTER; a_discardable: BOOLEAN)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <Foundation/Foundation.h>"
		alias
			"[
				[(NSUndoManager *)$an_item setActionIsDiscardable:$a_discardable];
			 ]"
		end

	objc_undo_action_is_discardable (an_item: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <Foundation/Foundation.h>"
		alias
			"[
				return [(NSUndoManager *)$an_item undoActionIsDiscardable];
			 ]"
		end

	objc_redo_action_is_discardable (an_item: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <Foundation/Foundation.h>"
		alias
			"[
				return [(NSUndoManager *)$an_item redoActionIsDiscardable];
			 ]"
		end
