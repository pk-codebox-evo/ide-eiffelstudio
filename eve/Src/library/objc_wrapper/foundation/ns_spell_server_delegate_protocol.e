...
--		end
	...
	spell_server__record_response__to_correction__for_word__language_ (a_sender: detachable NS_SPELL_SERVER; a_response: NATURAL_64; a_correction: detachable NS_STRING; a_word: detachable NS_STRING; a_language: detachable NS_STRING)
			-- Auto generated Objective-C wrapper.
		require
			has_spell_server__record_response__to_correction__for_word__language_: has_spell_server__record_response__to_correction__for_word__language_
		local
			a_sender__item: POINTER
		...
		do
			...
			objc_spell_server__record_response__to_correction__for_word__language_ (item, a_sender__item, a_response, a_correction__item, a_word__item, a_language__item)
		end
...
--		end
	...
	has_spell_server__record_response__to_correction__for_word__language_: BOOLEAN
			-- Auto generated Objective-C wrapper.
		do
			Result := objc_has_spell_server__record_response__to_correction__for_word__language_ (item)
		end
...
--		end
	...
	objc_has_spell_server__record_response__to_correction__for_word__language_ (an_item: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <Foundation/Foundation.h>"
		alias
			"[
				return [(id)$an_item respondsToSelector:@selector(spellServer:recordResponse:toCorrection:forWord:language:)];
			 ]"
		end
...
--		end
	...
	objc_spell_server__record_response__to_correction__for_word__language_ (an_item: POINTER; a_sender: POINTER; a_response: NATURAL_64; a_correction: POINTER; a_word: POINTER; a_language: POINTER)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <Foundation/Foundation.h>"
		alias
			"[
				[(id <NSSpellServerDelegate>)$an_item spellServer:$a_sender recordResponse:$a_response toCorrection:$a_correction forWord:$a_word language:$a_language];
			 ]"
		end
