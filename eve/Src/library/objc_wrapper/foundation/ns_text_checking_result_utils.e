...
--	regular_expression_checking_result_with_ranges__count__regular_expression_ (a_ranges: UNSUPPORTED_TYPE; a_count: NATURAL_64; a_regular_expression: detachable NS_REGULAR_EXPRESSION): detachable NS_TEXT_CHECKING_RESULT
--			-- Auto generated Objective-C wrapper.
--		local
--			result_pointer: POINTER
--			l_objc_class: OBJC_CLASS
--			a_ranges__item: POINTER
--			a_regular_expression__item: POINTER
--		do
--			if attached a_ranges as a_ranges_attached then
--				a_ranges__item := a_ranges_attached.item
--			end
--			if attached a_regular_expression as a_regular_expression_attached then
--				a_regular_expression__item := a_regular_expression_attached.item
--			end
--			create l_objc_class.make_with_name (get_class_name)
--			check l_objc_class_registered: l_objc_class.registered end
--			result_pointer := objc_regular_expression_checking_result_with_ranges__count__regular_expression_ (l_objc_class.item, a_ranges__item, a_count, a_regular_expression__item)
--			if result_pointer /= default_pointer then
--				if attached objc_get_eiffel_object (result_pointer) as existing_eiffel_object then
--					check attached {like regular_expression_checking_result_with_ranges__count__regular_expression_} existing_eiffel_object as valid_result then
--						Result := valid_result
--					end
--				else
--					check attached {like regular_expression_checking_result_with_ranges__count__regular_expression_} new_eiffel_object (result_pointer, True) as valid_result_pointer then
--						Result := valid_result_pointer
--					end
--				end
--			end
--		end
	...
	phone_number_checking_result_with_range__phone_number_ (a_range: NS_RANGE; a_phone_number: detachable NS_STRING): detachable NS_TEXT_CHECKING_RESULT
			-- Auto generated Objective-C wrapper.
		local
			result_pointer: POINTER
			l_objc_class: OBJC_CLASS
			a_phone_number__item: POINTER
		do
			if attached a_phone_number as a_phone_number_attached then
				a_phone_number__item := a_phone_number_attached.item
			end
			create l_objc_class.make_with_name (get_class_name)
			check l_objc_class_registered: l_objc_class.registered end
			result_pointer := objc_phone_number_checking_result_with_range__phone_number_ (l_objc_class.item, a_range.item, a_phone_number__item)
			if result_pointer /= default_pointer then
				if attached objc_get_eiffel_object (result_pointer) as existing_eiffel_object then
					check attached {like phone_number_checking_result_with_range__phone_number_} existing_eiffel_object as valid_result then
						Result := valid_result
					end
				else
					check attached {like phone_number_checking_result_with_range__phone_number_} new_eiffel_object (result_pointer, True) as valid_result_pointer then
						Result := valid_result_pointer
					end
				end
			end
	...
	transit_information_checking_result_with_range__components_ (a_range: NS_RANGE; a_components: detachable NS_DICTIONARY): detachable NS_TEXT_CHECKING_RESULT
			-- Auto generated Objective-C wrapper.
		local
			result_pointer: POINTER
			l_objc_class: OBJC_CLASS
		...
		do
			...
			create l_objc_class.make_with_name (get_class_name)
			check l_objc_class_registered: l_objc_class.registered end
			result_pointer := objc_transit_information_checking_result_with_range__components_ (l_objc_class.item, a_range.item, a_components__item)
			if result_pointer /= default_pointer then
				if attached objc_get_eiffel_object (result_pointer) as existing_eiffel_object then
					check attached {like transit_information_checking_result_with_range__components_} existing_eiffel_object as valid_result then
						Result := valid_result
					end
				else
					check attached {like transit_information_checking_result_with_range__components_} new_eiffel_object (result_pointer, True) as valid_result_pointer then
						Result := valid_result_pointer
					end
				end
			end
...
--	objc_regular_expression_checking_result_with_ranges__count__regular_expression_ (a_class_object: POINTER; a_ranges: UNSUPPORTED_TYPE; a_count: NATURAL_64; a_regular_expression: POINTER): POINTER
--			-- Auto generated Objective-C wrapper.
--		external
--			"C inline use <Foundation/Foundation.h>"
--		alias
--			"[
--				return (EIF_POINTER)[(Class)$a_class_object regularExpressionCheckingResultWithRanges: count:$a_count regularExpression:$a_regular_expression];
--			 ]"
--		end

	objc_phone_number_checking_result_with_range__phone_number_ (a_class_object: POINTER; a_range: POINTER; a_phone_number: POINTER): POINTER
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <Foundation/Foundation.h>"
		alias
			"[
				return (EIF_POINTER)[(Class)$a_class_object phoneNumberCheckingResultWithRange:*((NSRange *)$a_range) phoneNumber:$a_phone_number];
			 ]"
		end

	objc_transit_information_checking_result_with_range__components_ (a_class_object: POINTER; a_range: POINTER; a_components: POINTER): POINTER
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <Foundation/Foundation.h>"
		alias
			"[
				return (EIF_POINTER)[(Class)$a_class_object transitInformationCheckingResultWithRange:*((NSRange *)$a_range) components:$a_components];
			 ]"
		end
