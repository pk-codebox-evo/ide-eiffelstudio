...
--		end
	...
	dispatch_with_components_ (a_components: detachable NS_ARRAY)
			-- Auto generated Objective-C wrapper.
		local
		...
		do
			...
			objc_dispatch_with_components_ (item, a_components__item)
		end
...
--		end
	...
	objc_dispatch_with_components_ (an_item: POINTER; a_components: POINTER)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <Foundation/Foundation.h>"
		alias
			"[
				[(NSConnection *)$an_item dispatchWithComponents:$a_components];
			 ]"
		end
