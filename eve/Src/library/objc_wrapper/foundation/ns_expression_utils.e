...
feature -- NSExpression
	...
	expression_with_format__argument_array_ (a_expression_format: detachable NS_STRING; a_arguments: detachable NS_ARRAY): detachable NS_EXPRESSION
			-- Auto generated Objective-C wrapper.
		local
			result_pointer: POINTER
			l_objc_class: OBJC_CLASS
			a_expression_format__item: POINTER
			a_arguments__item: POINTER
		do
			if attached a_expression_format as a_expression_format_attached then
				a_expression_format__item := a_expression_format_attached.item
			end
			...
			result_pointer := objc_expression_with_format__argument_array_ (l_objc_class.item, a_expression_format__item, a_arguments__item)
			if result_pointer /= default_pointer then
				if attached objc_get_eiffel_object (result_pointer) as existing_eiffel_object then
					check attached {like expression_with_format__argument_array_} existing_eiffel_object as valid_result then
						Result := valid_result
					end
				else
					check attached {like expression_with_format__argument_array_} new_eiffel_object (result_pointer, True) as valid_result_pointer then
...
--	expression_with_format__arguments_ (a_expression_format: detachable NS_STRING; a_arg_list: UNSUPPORTED_TYPE): detachable NS_EXPRESSION
--			-- Auto generated Objective-C wrapper.
--		local
--			result_pointer: POINTER
--			l_objc_class: OBJC_CLASS
...
--			create l_objc_class.make_with_name (get_class_name)
--			check l_objc_class_registered: l_objc_class.registered end
--			result_pointer := objc_expression_with_format__arguments_ (l_objc_class.item, a_expression_format__item, a_arg_list__item)
--			if result_pointer /= default_pointer then
--				if attached objc_get_eiffel_object (result_pointer) as existing_eiffel_object then
--					check attached {like expression_with_format__arguments_} existing_eiffel_object as valid_result then
--						Result := valid_result
--					end
--				else
--					check attached {like expression_with_format__arguments_} new_eiffel_object (result_pointer, True) as valid_result_pointer then
--						Result := valid_result_pointer
--					end
--				end
--			end
...
feature {NONE} -- NSExpression Externals
	...
	objc_expression_with_format__argument_array_ (a_class_object: POINTER; a_expression_format: POINTER; a_arguments: POINTER): POINTER
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <Foundation/Foundation.h>"
		alias
			"[
				return (EIF_POINTER)[(Class)$a_class_object expressionWithFormat:$a_expression_format argumentArray:$a_arguments];
			 ]"
		end

--	objc_expression_with_format__arguments_ (a_class_object: POINTER; a_expression_format: POINTER; a_arg_list: UNSUPPORTED_TYPE): POINTER
--			-- Auto generated Objective-C wrapper.
--		external
--			"C inline use <Foundation/Foundation.h>"
--		alias
--			"[
--				return (EIF_POINTER)[(Class)$a_class_object expressionWithFormat:$a_expression_format arguments:];
--			 ]"
--		end
