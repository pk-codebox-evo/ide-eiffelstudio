...
feature -- NSURLConnectionQueuedLoading

--	send_asynchronous_request__queue__completion_handler_ (a_request: detachable NS_URL_REQUEST; a_queue: detachable NS_OPERATION_QUEUE; a_handler: UNSUPPORTED_TYPE)
--			-- Auto generated Objective-C wrapper.
--		local
--			l_objc_class: OBJC_CLASS
--			a_request__item: POINTER
...
--			create l_objc_class.make_with_name (get_class_name)
--			check l_objc_class_registered: l_objc_class.registered end
--			objc_send_asynchronous_request__queue__completion_handler_ (l_objc_class.item, a_request__item, a_queue__item, )
--		end

feature {NONE} -- NSURLConnectionQueuedLoading Externals

--	objc_send_asynchronous_request__queue__completion_handler_ (a_class_object: POINTER; a_request: POINTER; a_queue: POINTER; a_handler: UNSUPPORTED_TYPE)
--			-- Auto generated Objective-C wrapper.
--		external
--			"C inline use <Foundation/Foundation.h>"
--		alias
--			"[
--				[(Class)$a_class_object sendAsynchronousRequest:$a_request queue:$a_queue completionHandler:];
--			 ]"
--		end
