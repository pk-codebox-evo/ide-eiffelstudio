...
feature {NONE} -- Required Methods Externals
	...
	objc_class_objc (an_item: POINTER): POINTER
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <Foundation/Foundation.h>, <objc/runtime.h>"
		alias
			"[
				//NSLog(@"%p",objc_getClass(class_getName([(id <NSObject>)$an_item class])));
				return (EIF_POINTER)objc_getClass(class_getName([(id <NSObject>)$an_item class]));
