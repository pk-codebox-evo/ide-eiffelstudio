...
feature -- NSProcessInfo
	...
	disable_automatic_termination_ (a_reason: detachable NS_STRING)
			-- Auto generated Objective-C wrapper.
		local
		...
		do
			...
			objc_disable_automatic_termination_ (item, a_reason__item)
		end

	enable_automatic_termination_ (a_reason: detachable NS_STRING)
			-- Auto generated Objective-C wrapper.
		local
			a_reason__item: POINTER
		do
			...
			objc_enable_automatic_termination_ (item, a_reason__item)
		end

	set_automatic_termination_support_enabled_ (a_flag: BOOLEAN)
			-- Auto generated Objective-C wrapper.
		local
		do
			objc_set_automatic_termination_support_enabled_ (item, a_flag)
		end

	automatic_termination_support_enabled: BOOLEAN
			-- Auto generated Objective-C wrapper.
		local
		do
			Result := objc_automatic_termination_support_enabled (item)
		end
...
feature {NONE} -- NSProcessInfo Externals
	...
	objc_disable_automatic_termination_ (an_item: POINTER; a_reason: POINTER)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <Foundation/Foundation.h>"
		alias
			"[
				[(NSProcessInfo *)$an_item disableAutomaticTermination:$a_reason];
			 ]"
		end

	objc_enable_automatic_termination_ (an_item: POINTER; a_reason: POINTER)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <Foundation/Foundation.h>"
		alias
			"[
				[(NSProcessInfo *)$an_item enableAutomaticTermination:$a_reason];
			 ]"
		end

	objc_set_automatic_termination_support_enabled_ (an_item: POINTER; a_flag: BOOLEAN)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <Foundation/Foundation.h>"
		alias
			"[
				[(NSProcessInfo *)$an_item setAutomaticTerminationSupportEnabled:$a_flag];
			 ]"
		end

	objc_automatic_termination_support_enabled (an_item: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <Foundation/Foundation.h>"
		alias
			"[
				return [(NSProcessInfo *)$an_item automaticTerminationSupportEnabled];
			 ]"
		end
