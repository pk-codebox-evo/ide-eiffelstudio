...
--	create_directory_at_ur_l__with_intermediate_directories__attributes__error_ (a_url: detachable NS_URL; a_create_intermediates: BOOLEAN; a_attributes: detachable NS_DICTIONARY; a_error: UNSUPPORTED_TYPE): BOOLEAN
--			-- Auto generated Objective-C wrapper.
--		local
--			a_url__item: POINTER
...
--				a_error__item := a_error_attached.item
--			end
--			Result := objc_create_directory_at_ur_l__with_intermediate_directories__attributes__error_ (item, a_url__item, a_create_intermediates, a_attributes__item, a_error__item)
--		end

--	create_symbolic_link_at_ur_l__with_destination_ur_l__error_ (a_url: detachable NS_URL; a_dest_url: detachable NS_URL; a_error: UNSUPPORTED_TYPE): BOOLEAN
--			-- Auto generated Objective-C wrapper.
--		local
--			a_url__item: POINTER
--			a_dest_url__item: POINTER
--			a_error__item: POINTER
--		do
--			if attached a_url as a_url_attached then
--				a_url__item := a_url_attached.item
--			end
--			if attached a_dest_url as a_dest_url_attached then
--				a_dest_url__item := a_dest_url_attached.item
--			end
--			if attached a_error as a_error_attached then
--				a_error__item := a_error_attached.item
--			end
--			Result := objc_create_symbolic_link_at_ur_l__with_destination_ur_l__error_ (item, a_url__item, a_dest_url__item, a_error__item)
--		end
...
--	set_ubiquitous__item_at_ur_l__destination_ur_l__error_ (a_flag: BOOLEAN; a_url: detachable NS_URL; a_destination_url: detachable NS_URL; a_error: UNSUPPORTED_TYPE): BOOLEAN
--			-- Auto generated Objective-C wrapper.
--		local
--			a_url__item: POINTER
...
--				a_error__item := a_error_attached.item
--			end
--			Result := objc_set_ubiquitous__item_at_ur_l__destination_ur_l__error_ (item, a_flag, a_url__item, a_destination_url__item, a_error__item)
--		end

	is_ubiquitous_item_at_ur_l_ (a_url: detachable NS_URL): BOOLEAN
			-- Auto generated Objective-C wrapper.
		local
			a_url__item: POINTER
		do
			...
			Result := objc_is_ubiquitous_item_at_ur_l_ (item, a_url__item)
		end

--	start_downloading_ubiquitous_item_at_ur_l__error_ (a_url: detachable NS_URL; a_error: UNSUPPORTED_TYPE): BOOLEAN
--			-- Auto generated Objective-C wrapper.
--		local
--			a_url__item: POINTER
--			a_error__item: POINTER
...
--				a_error__item := a_error_attached.item
--			end
--			Result := objc_start_downloading_ubiquitous_item_at_ur_l__error_ (item, a_url__item, a_error__item)
--		end

--	evict_ubiquitous_item_at_ur_l__error_ (a_url: detachable NS_URL; a_error: UNSUPPORTED_TYPE): BOOLEAN
--			-- Auto generated Objective-C wrapper.
--		local
--			a_url__item: POINTER
--			a_error__item: POINTER
...
--				a_error__item := a_error_attached.item
--			end
--			Result := objc_evict_ubiquitous_item_at_ur_l__error_ (item, a_url__item, a_error__item)
--		end

	url_for_ubiquity_container_identifier_ (a_container_identifier: detachable NS_STRING): detachable NS_URL
			-- Auto generated Objective-C wrapper.
		local
			result_pointer: POINTER
			a_container_identifier__item: POINTER
		do
			if attached a_container_identifier as a_container_identifier_attached then
				a_container_identifier__item := a_container_identifier_attached.item
			end
			result_pointer := objc_url_for_ubiquity_container_identifier_ (item, a_container_identifier__item)
			if result_pointer /= default_pointer then
				if attached objc_get_eiffel_object (result_pointer) as existing_eiffel_object then
					check attached {like url_for_ubiquity_container_identifier_} existing_eiffel_object as valid_result then
						Result := valid_result
					end
				else
					check attached {like url_for_ubiquity_container_identifier_} new_eiffel_object (result_pointer, True) as valid_result_pointer then
						Result := valid_result_pointer
					end
				end
			end
...
--	url_for_publishing_ubiquitous_item_at_ur_l__expiration_date__error_ (a_url: detachable NS_URL; a_out_date: UNSUPPORTED_TYPE; a_error: UNSUPPORTED_TYPE): detachable NS_URL
--			-- Auto generated Objective-C wrapper.
--		local
--			result_pointer: POINTER
--			a_url__item: POINTER
--			a_out_date__item: POINTER
--			a_error__item: POINTER
--		do
--			if attached a_url as a_url_attached then
--				a_url__item := a_url_attached.item
--			end
--			if attached a_out_date as a_out_date_attached then
--				a_out_date__item := a_out_date_attached.item
--			end
--			if attached a_error as a_error_attached then
--				a_error__item := a_error_attached.item
--			end
--			result_pointer := objc_url_for_publishing_ubiquitous_item_at_ur_l__expiration_date__error_ (item, a_url__item, a_out_date__item, a_error__item)
--			if result_pointer /= default_pointer then
--				if attached objc_get_eiffel_object (result_pointer) as existing_eiffel_object then
--					check attached {like url_for_publishing_ubiquitous_item_at_ur_l__expiration_date__error_} existing_eiffel_object as valid_result then
--						Result := valid_result
--					end
--				else
--					check attached {like url_for_publishing_ubiquitous_item_at_ur_l__expiration_date__error_} new_eiffel_object (result_pointer, True) as valid_result_pointer then
--						Result := valid_result_pointer
--					end
--				end
--			end
...
--	objc_create_directory_at_ur_l__with_intermediate_directories__attributes__error_ (an_item: POINTER; a_url: POINTER; a_create_intermediates: BOOLEAN; a_attributes: POINTER; a_error: UNSUPPORTED_TYPE): BOOLEAN
--			-- Auto generated Objective-C wrapper.
--		external
--			"C inline use <Foundation/Foundation.h>"
--		alias
--			"[
--				return [(NSFileManager *)$an_item createDirectoryAtURL:$a_url withIntermediateDirectories:$a_create_intermediates attributes:$a_attributes error:];
--			 ]"
--		end

--	objc_create_symbolic_link_at_ur_l__with_destination_ur_l__error_ (an_item: POINTER; a_url: POINTER; a_dest_url: POINTER; a_error: UNSUPPORTED_TYPE): BOOLEAN
--			-- Auto generated Objective-C wrapper.
--		external
--			"C inline use <Foundation/Foundation.h>"
--		alias
--			"[
--				return [(NSFileManager *)$an_item createSymbolicLinkAtURL:$a_url withDestinationURL:$a_dest_url error:];
--			 ]"
--		end
...
--	objc_set_ubiquitous__item_at_ur_l__destination_ur_l__error_ (an_item: POINTER; a_flag: BOOLEAN; a_url: POINTER; a_destination_url: POINTER; a_error: UNSUPPORTED_TYPE): BOOLEAN
--			-- Auto generated Objective-C wrapper.
--		external
--			"C inline use <Foundation/Foundation.h>"
--		alias
--			"[
--				return [(NSFileManager *)$an_item setUbiquitous:$a_flag itemAtURL:$a_url destinationURL:$a_destination_url error:];
--			 ]"
--		end

	objc_is_ubiquitous_item_at_ur_l_ (an_item: POINTER; a_url: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <Foundation/Foundation.h>"
		alias
			"[
				return [(NSFileManager *)$an_item isUbiquitousItemAtURL:$a_url];
			 ]"
		end

--	objc_start_downloading_ubiquitous_item_at_ur_l__error_ (an_item: POINTER; a_url: POINTER; a_error: UNSUPPORTED_TYPE): BOOLEAN
--			-- Auto generated Objective-C wrapper.
--		external
--			"C inline use <Foundation/Foundation.h>"
--		alias
--			"[
--				return [(NSFileManager *)$an_item startDownloadingUbiquitousItemAtURL:$a_url error:];
--			 ]"
--		end

--	objc_evict_ubiquitous_item_at_ur_l__error_ (an_item: POINTER; a_url: POINTER; a_error: UNSUPPORTED_TYPE): BOOLEAN
--			-- Auto generated Objective-C wrapper.
--		external
--			"C inline use <Foundation/Foundation.h>"
--		alias
--			"[
--				return [(NSFileManager *)$an_item evictUbiquitousItemAtURL:$a_url error:];
--			 ]"
--		end

	objc_url_for_ubiquity_container_identifier_ (an_item: POINTER; a_container_identifier: POINTER): POINTER
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <Foundation/Foundation.h>"
		alias
			"[
				return (EIF_POINTER)[(NSFileManager *)$an_item URLForUbiquityContainerIdentifier:$a_container_identifier];
			 ]"
		end

--	objc_url_for_publishing_ubiquitous_item_at_ur_l__expiration_date__error_ (an_item: POINTER; a_url: POINTER; a_out_date: UNSUPPORTED_TYPE; a_error: UNSUPPORTED_TYPE): POINTER
--			-- Auto generated Objective-C wrapper.
--		external
--			"C inline use <Foundation/Foundation.h>"
--		alias
--			"[
--				return (EIF_POINTER)[(NSFileManager *)$an_item URLForPublishingUbiquitousItemAtURL:$a_url expirationDate: error:];
--			 ]"
--		end
