...
feature {NONE} -- Initialization
	...
	make_with_request__delegate_ (a_request: detachable NS_URL_REQUEST; a_delegate: detachable NS_URL_DOWNLOAD_DELEGATE_PROTOCOL)
			-- Initialize `Current'.
		local
	...
	make_with_resume_data__delegate__path_ (a_resume_data: detachable NS_DATA; a_delegate: detachable NS_URL_DOWNLOAD_DELEGATE_PROTOCOL; a_path: detachable NS_STRING)
			-- Initialize `Current'.
		local
