...
feature {NONE} -- NSURLConnection Externals
	...
	objc_set_delegate_queue_ (an_item: POINTER; a_queue: POINTER)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <Foundation/Foundation.h>"
		alias
			"[
				[(NSURLConnection *)$an_item setDelegateQueue:$a_queue];
			 ]"
		end
...
feature -- NSURLConnection
	...
	set_delegate_queue_ (a_queue: detachable NS_OPERATION_QUEUE)
			-- Auto generated Objective-C wrapper.
		local
		...
		do
			...
			objc_set_delegate_queue_ (item, a_queue__item)
		end
