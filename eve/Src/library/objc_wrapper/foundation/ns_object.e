...
--		end
	...
	mutable_ordered_set_value_for_key_ (a_key: detachable NS_STRING): detachable NS_MUTABLE_ORDERED_SET
			-- Auto generated Objective-C wrapper.
		local
			result_pointer: POINTER
			a_key__item: POINTER
		do
			...
			result_pointer := objc_mutable_ordered_set_value_for_key_ (item, a_key__item)
			if result_pointer /= default_pointer then
				if attached objc_get_eiffel_object (result_pointer) as existing_eiffel_object then
					check attached {like mutable_ordered_set_value_for_key_} existing_eiffel_object as valid_result then
						Result := valid_result
					end
				else
					check attached {like mutable_ordered_set_value_for_key_} new_eiffel_object (result_pointer, True) as valid_result_pointer then
						Result := valid_result_pointer
					end
				end
			end
...
--		end
	...
	mutable_ordered_set_value_for_key_path_ (a_key_path: detachable NS_STRING): detachable NS_MUTABLE_ORDERED_SET
			-- Auto generated Objective-C wrapper.
		local
			result_pointer: POINTER
			a_key_path__item: POINTER
		do
			...
			result_pointer := objc_mutable_ordered_set_value_for_key_path_ (item, a_key_path__item)
			if result_pointer /= default_pointer then
				if attached objc_get_eiffel_object (result_pointer) as existing_eiffel_object then
					check attached {like mutable_ordered_set_value_for_key_path_} existing_eiffel_object as valid_result then
						Result := valid_result
					end
				else
					check attached {like mutable_ordered_set_value_for_key_path_} new_eiffel_object (result_pointer, True) as valid_result_pointer then
						Result := valid_result_pointer
					end
				end
			end
...
--		end
	...
	objc_mutable_ordered_set_value_for_key_ (an_item: POINTER; a_key: POINTER): POINTER
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <Foundation/Foundation.h>"
		alias
			"[
				return (EIF_POINTER)[(NSObject *)$an_item mutableOrderedSetValueForKey:$a_key];
			 ]"
		end
...
--		end
	...
	objc_mutable_ordered_set_value_for_key_path_ (an_item: POINTER; a_key_path: POINTER): POINTER
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <Foundation/Foundation.h>"
		alias
			"[
				return (EIF_POINTER)[(NSObject *)$an_item mutableOrderedSetValueForKeyPath:$a_key_path];
			 ]"
		end
...
--	remove_observer__for_key_path__context_ (a_observer: detachable NS_OBJECT; a_key_path: detachable NS_STRING; a_context: UNSUPPORTED_TYPE)
--			-- Auto generated Objective-C wrapper.
--		local
--			a_observer__item: POINTER
--			a_key_path__item: POINTER
...
--				a_context__item := a_context_attached.item
--			end
--			objc_remove_observer__for_key_path__context_ (item, a_observer__item, a_key_path__item, a_context__item)
--		end
...
--	objc_remove_observer__for_key_path__context_ (an_item: POINTER; a_observer: POINTER; a_key_path: POINTER; a_context: UNSUPPORTED_TYPE)
--			-- Auto generated Objective-C wrapper.
--		external
--			"C inline use <Foundation/Foundation.h>"
--		alias
--			"[
--				[(NSObject *)$an_item removeObserver:$a_observer forKeyPath:$a_key_path context:];
--			 ]"
--		end
