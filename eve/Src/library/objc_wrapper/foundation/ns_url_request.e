...
feature {NONE} -- NSURLRequest Externals
	...
	objc_network_service_type (an_item: POINTER): NATURAL_64
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <Foundation/Foundation.h>"
		alias
			"[
				return [(NSURLRequest *)$an_item networkServiceType];
			 ]"
		end
...
feature -- NSURLRequest
	...
	network_service_type: NATURAL_64
			-- Auto generated Objective-C wrapper.
		local
		do
			Result := objc_network_service_type (item)
		end
...
feature -- NSHTTPURLRequest
	...
	http_should_use_pipelining: BOOLEAN
			-- Auto generated Objective-C wrapper.
		local
		do
			Result := objc_http_should_use_pipelining (item)
		end
...
feature {NONE} -- NSHTTPURLRequest Externals
	...
	objc_http_should_use_pipelining (an_item: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <Foundation/Foundation.h>"
		alias
			"[
				return [(NSURLRequest *)$an_item HTTPShouldUsePipelining];
			 ]"
		end
