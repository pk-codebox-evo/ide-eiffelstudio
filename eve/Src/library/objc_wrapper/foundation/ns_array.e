...
--	remove_observer__from_objects_at_indexes__for_key_path__context_ (a_observer: detachable NS_OBJECT; a_indexes: detachable NS_INDEX_SET; a_key_path: detachable NS_STRING; a_context: UNSUPPORTED_TYPE)
--			-- Auto generated Objective-C wrapper.
--		local
--			a_observer__item: POINTER
--			a_indexes__item: POINTER
...
--				a_context__item := a_context_attached.item
--			end
--			objc_remove_observer__from_objects_at_indexes__for_key_path__context_ (item, a_observer__item, a_indexes__item, a_key_path__item, a_context__item)
--		end
...
--	objc_remove_observer__from_objects_at_indexes__for_key_path__context_ (an_item: POINTER; a_observer: POINTER; a_indexes: POINTER; a_key_path: POINTER; a_context: UNSUPPORTED_TYPE)
--			-- Auto generated Objective-C wrapper.
--		external
--			"C inline use <Foundation/Foundation.h>"
--		alias
--			"[
--				[(NSArray *)$an_item removeObserver:$a_observer fromObjectsAtIndexes:$a_indexes forKeyPath:$a_key_path context:];
--			 ]"
--		end
