...
--		end
	...
	objc_set_uses_store_specific_migration_manager_ (an_item: POINTER; a_flag: BOOLEAN)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <CoreData/CoreData.h>"
		alias
			"[
				[(NSMigrationManager *)$an_item setUsesStoreSpecificMigrationManager:$a_flag];
			 ]"
		end

	objc_uses_store_specific_migration_manager (an_item: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <CoreData/CoreData.h>"
		alias
			"[
				return [(NSMigrationManager *)$an_item usesStoreSpecificMigrationManager];
			 ]"
		end
...
--		end
	...
	set_uses_store_specific_migration_manager_ (a_flag: BOOLEAN)
			-- Auto generated Objective-C wrapper.
		local
		do
			objc_set_uses_store_specific_migration_manager_ (item, a_flag)
		end

	uses_store_specific_migration_manager: BOOLEAN
			-- Auto generated Objective-C wrapper.
		local
		do
			Result := objc_uses_store_specific_migration_manager (item)
		end
