...
feature -- NSRelationshipDescription
	...
	set_ordered_ (a_flag: BOOLEAN)
			-- Auto generated Objective-C wrapper.
		local
		do
			objc_set_ordered_ (item, a_flag)
		end
...
feature {NONE} -- NSRelationshipDescription Externals
	...
	objc_set_ordered_ (an_item: POINTER; a_flag: BOOLEAN)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <CoreData/CoreData.h>"
		alias
			"[
				[(NSRelationshipDescription *)$an_item setOrdered:$a_flag];
			 ]"
		end

	objc_is_ordered (an_item: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <CoreData/CoreData.h>"
		alias
			"[
				return [(NSRelationshipDescription *)$an_item isOrdered];
			 ]"
		end
