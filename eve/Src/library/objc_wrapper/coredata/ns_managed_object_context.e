...
create
	make_with_concurrency_type_,
	make

feature {NONE} -- Initialization

	make_with_concurrency_type_ (a_ct: NATURAL_64)
			-- Initialize `Current'.
		local
		do
			make_with_pointer (objc_init_with_concurrency_type_(allocate_object, a_ct))
...
feature {NONE} -- NSManagedObjectContext Externals
	...
	objc_init_with_concurrency_type_ (an_item: POINTER; a_ct: NATURAL_64): POINTER
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <CoreData/CoreData.h>"
		alias
			"[
				return (EIF_POINTER)[(NSManagedObjectContext *)$an_item initWithConcurrencyType:$a_ct];
			 ]"
		end

--	objc_perform_block_ (an_item: POINTER; a_block: UNSUPPORTED_TYPE)
--			-- Auto generated Objective-C wrapper.
--		external
--			"C inline use <CoreData/CoreData.h>"
--		alias
--			"[
--				[(NSManagedObjectContext *)$an_item performBlock:];
--			 ]"
--		end

--	objc_perform_block_and_wait_ (an_item: POINTER; a_block: UNSUPPORTED_TYPE)
--			-- Auto generated Objective-C wrapper.
--		external
--			"C inline use <CoreData/CoreData.h>"
--		alias
--			"[
--				[(NSManagedObjectContext *)$an_item performBlockAndWait:];
--			 ]"
--		end
	...
	objc_set_parent_context_ (an_item: POINTER; a_parent: POINTER)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <CoreData/CoreData.h>"
		alias
			"[
				[(NSManagedObjectContext *)$an_item setParentContext:$a_parent];
			 ]"
		end

	objc_parent_context (an_item: POINTER): POINTER
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <CoreData/CoreData.h>"
		alias
			"[
				return (EIF_POINTER)[(NSManagedObjectContext *)$an_item parentContext];
			 ]"
		end
	...
	objc_user_info (an_item: POINTER): POINTER
		...
		alias
			"[
				return (EIF_POINTER)[(NSManagedObjectContext *)$an_item userInfo];
			 ]"
		end

	objc_concurrency_type (an_item: POINTER): NATURAL_64
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <CoreData/CoreData.h>"
		alias
			"[
				return [(NSManagedObjectContext *)$an_item concurrencyType];
			 ]"
		end
...
--	perform_block_ (a_block: UNSUPPORTED_TYPE)
--			-- Auto generated Objective-C wrapper.
--		local
--		do
--			objc_perform_block_ (item, )
--		end

--	perform_block_and_wait_ (a_block: UNSUPPORTED_TYPE)
--			-- Auto generated Objective-C wrapper.
--		local
--		do
--			objc_perform_block_and_wait_ (item, )
--		end
	...
	set_parent_context_ (a_parent: detachable NS_MANAGED_OBJECT_CONTEXT)
			-- Auto generated Objective-C wrapper.
		local
		...
		do
			...
			objc_set_parent_context_ (item, a_parent__item)
		end

	parent_context: detachable NS_MANAGED_OBJECT_CONTEXT
			-- Auto generated Objective-C wrapper.
		local
			result_pointer: POINTER
		do
			result_pointer := objc_parent_context (item)
			if result_pointer /= default_pointer then
				if attached objc_get_eiffel_object (result_pointer) as existing_eiffel_object then
					check attached {like parent_context} existing_eiffel_object as valid_result then
						Result := valid_result
					end
				else
					check attached {like parent_context} new_eiffel_object (result_pointer, True) as valid_result_pointer then
						Result := valid_result_pointer
					end
				end
			end
	...
	user_info: detachable NS_MUTABLE_DICTIONARY
			-- Auto generated Objective-C wrapper.
		local
			result_pointer: POINTER
		do
	...
	concurrency_type: NATURAL_64
			-- Auto generated Objective-C wrapper.
		local
		do
			Result := objc_concurrency_type (item)
		end
