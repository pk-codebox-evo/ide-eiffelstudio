...
feature -- NSAttributeDescription
	...
	allows_external_binary_data_storage: BOOLEAN
			-- Auto generated Objective-C wrapper.
		local
		do
			Result := objc_allows_external_binary_data_storage (item)
		end

	set_allows_external_binary_data_storage_ (a_flag: BOOLEAN)
			-- Auto generated Objective-C wrapper.
		local
		do
			objc_set_allows_external_binary_data_storage_ (item, a_flag)
		end
...
feature {NONE} -- NSAttributeDescription Externals
	...
	objc_allows_external_binary_data_storage (an_item: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <CoreData/CoreData.h>"
		alias
			"[
				return [(NSAttributeDescription *)$an_item allowsExternalBinaryDataStorage];
			 ]"
		end

	objc_set_allows_external_binary_data_storage_ (an_item: POINTER; a_flag: BOOLEAN)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <CoreData/CoreData.h>"
		alias
			"[
				[(NSAttributeDescription *)$an_item setAllowsExternalBinaryDataStorage:$a_flag];
			 ]"
		end
