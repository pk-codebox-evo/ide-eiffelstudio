...
--		end
	...
	correction_for_word_range__in_string__language__in_spell_document_with_tag_ (a_range: NS_RANGE; a_string: detachable NS_STRING; a_language: detachable NS_STRING; a_tag: INTEGER_64): detachable NS_STRING
			-- Auto generated Objective-C wrapper.
		local
			result_pointer: POINTER
			a_string__item: POINTER
		...
		do
			...
			result_pointer := objc_correction_for_word_range__in_string__language__in_spell_document_with_tag_ (item, a_range.item, a_string__item, a_language__item, a_tag)
			if result_pointer /= default_pointer then
				if attached objc_get_eiffel_object (result_pointer) as existing_eiffel_object then
					check attached {like correction_for_word_range__in_string__language__in_spell_document_with_tag_} existing_eiffel_object as valid_result then
						Result := valid_result
					end
				else
					check attached {like correction_for_word_range__in_string__language__in_spell_document_with_tag_} new_eiffel_object (result_pointer, True) as valid_result_pointer then
						Result := valid_result_pointer
					end
				end
			end
	...
	record_response__to_correction__for_word__language__in_spell_document_with_tag_ (a_response: INTEGER_64; a_correction: detachable NS_STRING; a_word: detachable NS_STRING; a_language: detachable NS_STRING; a_tag: INTEGER_64)
			-- Auto generated Objective-C wrapper.
		local
			a_correction__item: POINTER
			a_word__item: POINTER
			a_language__item: POINTER
		do
			if attached a_correction as a_correction_attached then
				a_correction__item := a_correction_attached.item
			end
			if attached a_word as a_word_attached then
				a_word__item := a_word_attached.item
			end
			...
			objc_record_response__to_correction__for_word__language__in_spell_document_with_tag_ (item, a_response, a_correction__item, a_word__item, a_language__item, a_tag)
		end

--	show_correction_indicator_of_type__primary_string__alternative_strings__for_string_in_rect__view__completion_handler_ (a_type: INTEGER_64; a_primary_string: detachable NS_STRING; a_alternative_strings: detachable NS_ARRAY; a_rect_of_typed_string: NS_RECT; a_view: detachable NS_VIEW; a_completion_block: UNSUPPORTED_TYPE)
--			-- Auto generated Objective-C wrapper.
--		local
--			a_primary_string__item: POINTER
--			a_alternative_strings__item: POINTER
--			a_view__item: POINTER
--		do
--			if attached a_primary_string as a_primary_string_attached then
--				a_primary_string__item := a_primary_string_attached.item
--			end
--			if attached a_alternative_strings as a_alternative_strings_attached then
--				a_alternative_strings__item := a_alternative_strings_attached.item
--			end
--			if attached a_view as a_view_attached then
--				a_view__item := a_view_attached.item
--			end
--			objc_show_correction_indicator_of_type__primary_string__alternative_strings__for_string_in_rect__view__completion_handler_ (item, a_type, a_primary_string__item, a_alternative_strings__item, a_rect_of_typed_string.item, a_view__item, )
--		end

	dismiss_correction_indicator_for_view_ (a_view: detachable NS_VIEW)
			-- Auto generated Objective-C wrapper.
		local
			a_view__item: POINTER
		do
			...
			objc_dismiss_correction_indicator_for_view_ (item, a_view__item)
		end
...
--		end
	...
	objc_correction_for_word_range__in_string__language__in_spell_document_with_tag_ (an_item: POINTER; a_range: POINTER; a_string: POINTER; a_language: POINTER; a_tag: INTEGER_64): POINTER
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return (EIF_POINTER)[(NSSpellChecker *)$an_item correctionForWordRange:*((NSRange *)$a_range) inString:$a_string language:$a_language inSpellDocumentWithTag:$a_tag];
			 ]"
		end
	...
	objc_record_response__to_correction__for_word__language__in_spell_document_with_tag_ (an_item: POINTER; a_response: INTEGER_64; a_correction: POINTER; a_word: POINTER; a_language: POINTER; a_tag: INTEGER_64)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(NSSpellChecker *)$an_item recordResponse:$a_response toCorrection:$a_correction forWord:$a_word language:$a_language inSpellDocumentWithTag:$a_tag];
			 ]"
		end

--	objc_show_correction_indicator_of_type__primary_string__alternative_strings__for_string_in_rect__view__completion_handler_ (an_item: POINTER; a_type: INTEGER_64; a_primary_string: POINTER; a_alternative_strings: POINTER; a_rect_of_typed_string: POINTER; a_view: POINTER; a_completion_block: UNSUPPORTED_TYPE)
--			-- Auto generated Objective-C wrapper.
--		external
--			"C inline use <AppKit/AppKit.h>"
--		alias
--			"[
--				[(NSSpellChecker *)$an_item showCorrectionIndicatorOfType:$a_type primaryString:$a_primary_string alternativeStrings:$a_alternative_strings forStringInRect:*((NSRect *)$a_rect_of_typed_string) view:$a_view completionHandler:];
--			 ]"
--		end

	objc_dismiss_correction_indicator_for_view_ (an_item: POINTER; a_view: POINTER)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(NSSpellChecker *)$an_item dismissCorrectionIndicatorForView:$a_view];
			 ]"
		end
