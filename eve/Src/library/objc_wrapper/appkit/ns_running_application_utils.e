...
feature -- NSRunningApplication
	...
	terminate_automatically_terminable_applications
			-- Auto generated Objective-C wrapper.
		local
			l_objc_class: OBJC_CLASS
		do
			create l_objc_class.make_with_name (get_class_name)
			check l_objc_class_registered: l_objc_class.registered end
			objc_terminate_automatically_terminable_applications (l_objc_class.item)
		end
...
feature {NONE} -- NSRunningApplication Externals
	...
	objc_terminate_automatically_terminable_applications (a_class_object: POINTER)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(Class)$a_class_object terminateAutomaticallyTerminableApplications];
			 ]"
		end
