...
feature -- NSCollectionView
	...
	frame_for_item_at_index__with_number_of_items_ (a_index: NATURAL_64; a_number_of_items: NATURAL_64): NS_RECT
			-- Auto generated Objective-C wrapper.
		local
		do
			create Result.make
			objc_frame_for_item_at_index__with_number_of_items_ (item, Result.item, a_index, a_number_of_items)
		end
...
feature {NONE} -- NSCollectionView Externals
	...
	objc_frame_for_item_at_index__with_number_of_items_ (an_item: POINTER; result_pointer: POINTER; a_index: NATURAL_64; a_number_of_items: NATURAL_64)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				*(NSRect *)$result_pointer = [(NSCollectionView *)$an_item frameForItemAtIndex:$a_index withNumberOfItems:$a_number_of_items];
			 ]"
		end
