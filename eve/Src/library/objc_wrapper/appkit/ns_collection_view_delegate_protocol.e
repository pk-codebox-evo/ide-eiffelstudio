...
--		end
	...
	collection_view__pasteboard_writer_for_item_at_index_ (a_collection_view: detachable NS_COLLECTION_VIEW; a_index: NATURAL_64): detachable NS_PASTEBOARD_WRITING_PROTOCOL
			-- Auto generated Objective-C wrapper.
		require
			has_collection_view__pasteboard_writer_for_item_at_index_: has_collection_view__pasteboard_writer_for_item_at_index_
		local
			result_pointer: POINTER
			a_collection_view__item: POINTER
		do
			...
			result_pointer := objc_collection_view__pasteboard_writer_for_item_at_index_ (item, a_collection_view__item, a_index)
			if result_pointer /= default_pointer then
				if attached objc_get_eiffel_object (result_pointer) as existing_eiffel_object then
					check attached {like collection_view__pasteboard_writer_for_item_at_index_} existing_eiffel_object as valid_result then
						Result := valid_result
					end
				else
					check attached {like collection_view__pasteboard_writer_for_item_at_index_} new_eiffel_object (result_pointer, True) as valid_result_pointer then
						Result := valid_result_pointer
					end
				end
			end
	...
	collection_view__dragging_session__will_begin_at_point__for_items_at_indexes_ (a_collection_view: detachable NS_COLLECTION_VIEW; a_session: detachable NS_DRAGGING_SESSION; a_screen_point: NS_POINT; a_indexes: detachable NS_INDEX_SET)
			-- Auto generated Objective-C wrapper.
		require
			has_collection_view__dragging_session__will_begin_at_point__for_items_at_indexes_: has_collection_view__dragging_session__will_begin_at_point__for_items_at_indexes_
		local
			a_collection_view__item: POINTER
		...
		do
			...
			objc_collection_view__dragging_session__will_begin_at_point__for_items_at_indexes_ (item, a_collection_view__item, a_session__item, a_screen_point.item, a_indexes__item)
		end

	collection_view__dragging_session__ended_at_point__drag_operation_ (a_collection_view: detachable NS_COLLECTION_VIEW; a_session: detachable NS_DRAGGING_SESSION; a_screen_point: NS_POINT; a_operation: NATURAL_64)
			-- Auto generated Objective-C wrapper.
		require
			has_collection_view__dragging_session__ended_at_point__drag_operation_: has_collection_view__dragging_session__ended_at_point__drag_operation_
		local
			a_collection_view__item: POINTER
			a_session__item: POINTER
		do
			...
			objc_collection_view__dragging_session__ended_at_point__drag_operation_ (item, a_collection_view__item, a_session__item, a_screen_point.item, a_operation)
		end

	collection_view__update_dragging_items_for_drag_ (a_collection_view: detachable NS_COLLECTION_VIEW; a_dragging_info: detachable NS_DRAGGING_INFO_PROTOCOL)
			-- Auto generated Objective-C wrapper.
		require
			has_collection_view__update_dragging_items_for_drag_: has_collection_view__update_dragging_items_for_drag_
		local
			a_collection_view__item: POINTER
			a_dragging_info__item: POINTER
		do
			...
			objc_collection_view__update_dragging_items_for_drag_ (item, a_collection_view__item, a_dragging_info__item)
		end
...
--		end
	...
	has_collection_view__pasteboard_writer_for_item_at_index_: BOOLEAN
			-- Auto generated Objective-C wrapper.
		do
			Result := objc_has_collection_view__pasteboard_writer_for_item_at_index_ (item)
		end

	has_collection_view__dragging_session__will_begin_at_point__for_items_at_indexes_: BOOLEAN
			-- Auto generated Objective-C wrapper.
		do
			Result := objc_has_collection_view__dragging_session__will_begin_at_point__for_items_at_indexes_ (item)
		end

	has_collection_view__dragging_session__ended_at_point__drag_operation_: BOOLEAN
			-- Auto generated Objective-C wrapper.
		do
			Result := objc_has_collection_view__dragging_session__ended_at_point__drag_operation_ (item)
		end

	has_collection_view__update_dragging_items_for_drag_: BOOLEAN
			-- Auto generated Objective-C wrapper.
		do
			Result := objc_has_collection_view__update_dragging_items_for_drag_ (item)
		end
...
--		end
	...
	objc_has_collection_view__pasteboard_writer_for_item_at_index_ (an_item: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(id)$an_item respondsToSelector:@selector(collectionView:pasteboardWriterForItemAtIndex:)];
			 ]"
		end

	objc_has_collection_view__dragging_session__will_begin_at_point__for_items_at_indexes_ (an_item: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(id)$an_item respondsToSelector:@selector(collectionView:draggingSession:willBeginAtPoint:forItemsAtIndexes:)];
			 ]"
		end

	objc_has_collection_view__dragging_session__ended_at_point__drag_operation_ (an_item: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(id)$an_item respondsToSelector:@selector(collectionView:draggingSession:endedAtPoint:dragOperation:)];
			 ]"
		end

	objc_has_collection_view__update_dragging_items_for_drag_ (an_item: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(id)$an_item respondsToSelector:@selector(collectionView:updateDraggingItemsForDrag:)];
			 ]"
		end
...
--		end
	...
	objc_collection_view__pasteboard_writer_for_item_at_index_ (an_item: POINTER; a_collection_view: POINTER; a_index: NATURAL_64): POINTER
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return (EIF_POINTER)[(id <NSCollectionViewDelegate>)$an_item collectionView:$a_collection_view pasteboardWriterForItemAtIndex:$a_index];
			 ]"
		end

	objc_collection_view__dragging_session__will_begin_at_point__for_items_at_indexes_ (an_item: POINTER; a_collection_view: POINTER; a_session: POINTER; a_screen_point: POINTER; a_indexes: POINTER)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(id <NSCollectionViewDelegate>)$an_item collectionView:$a_collection_view draggingSession:$a_session willBeginAtPoint:*((NSPoint *)$a_screen_point) forItemsAtIndexes:$a_indexes];
			 ]"
		end

	objc_collection_view__dragging_session__ended_at_point__drag_operation_ (an_item: POINTER; a_collection_view: POINTER; a_session: POINTER; a_screen_point: POINTER; a_operation: NATURAL_64)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(id <NSCollectionViewDelegate>)$an_item collectionView:$a_collection_view draggingSession:$a_session endedAtPoint:*((NSPoint *)$a_screen_point) dragOperation:$a_operation];
			 ]"
		end

	objc_collection_view__update_dragging_items_for_drag_ (an_item: POINTER; a_collection_view: POINTER; a_dragging_info: POINTER)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(id <NSCollectionViewDelegate>)$an_item collectionView:$a_collection_view updateDraggingItemsForDrag:$a_dragging_info];
			 ]"
		end
