...
feature -- Optional Methods
	...
	table_view__pasteboard_writer_for_row_ (a_table_view: detachable NS_TABLE_VIEW; a_row: INTEGER_64): detachable NS_PASTEBOARD_WRITING_PROTOCOL
			-- Auto generated Objective-C wrapper.
		require
			has_table_view__pasteboard_writer_for_row_: has_table_view__pasteboard_writer_for_row_
		local
			result_pointer: POINTER
			a_table_view__item: POINTER
		do
			...
			result_pointer := objc_table_view__pasteboard_writer_for_row_ (item, a_table_view__item, a_row)
			if result_pointer /= default_pointer then
				if attached objc_get_eiffel_object (result_pointer) as existing_eiffel_object then
					check attached {like table_view__pasteboard_writer_for_row_} existing_eiffel_object as valid_result then
						Result := valid_result
					end
				else
					check attached {like table_view__pasteboard_writer_for_row_} new_eiffel_object (result_pointer, True) as valid_result_pointer then
						Result := valid_result_pointer
					end
				end
			end
	...
	table_view__dragging_session__will_begin_at_point__for_row_indexes_ (a_table_view: detachable NS_TABLE_VIEW; a_session: detachable NS_DRAGGING_SESSION; a_screen_point: NS_POINT; a_row_indexes: detachable NS_INDEX_SET)
			-- Auto generated Objective-C wrapper.
		require
			has_table_view__dragging_session__will_begin_at_point__for_row_indexes_: has_table_view__dragging_session__will_begin_at_point__for_row_indexes_
		local
			a_table_view__item: POINTER
		...
		do
			...
			objc_table_view__dragging_session__will_begin_at_point__for_row_indexes_ (item, a_table_view__item, a_session__item, a_screen_point.item, a_row_indexes__item)
		end

	table_view__dragging_session__ended_at_point__operation_ (a_table_view: detachable NS_TABLE_VIEW; a_session: detachable NS_DRAGGING_SESSION; a_screen_point: NS_POINT; a_operation: NATURAL_64)
			-- Auto generated Objective-C wrapper.
		require
			has_table_view__dragging_session__ended_at_point__operation_: has_table_view__dragging_session__ended_at_point__operation_
		local
			a_table_view__item: POINTER
			a_session__item: POINTER
		do
			...
			objc_table_view__dragging_session__ended_at_point__operation_ (item, a_table_view__item, a_session__item, a_screen_point.item, a_operation)
		end

	table_view__update_dragging_items_for_drag_ (a_table_view: detachable NS_TABLE_VIEW; a_dragging_info: detachable NS_DRAGGING_INFO_PROTOCOL)
			-- Auto generated Objective-C wrapper.
		require
			has_table_view__update_dragging_items_for_drag_: has_table_view__update_dragging_items_for_drag_
		local
			a_table_view__item: POINTER
		...
		do
			...
			objc_table_view__update_dragging_items_for_drag_ (item, a_table_view__item, a_dragging_info__item)
		end
...
feature -- Status Report
	...
	has_table_view__pasteboard_writer_for_row_: BOOLEAN
			-- Auto generated Objective-C wrapper.
		do
			Result := objc_has_table_view__pasteboard_writer_for_row_ (item)
		end

	has_table_view__dragging_session__will_begin_at_point__for_row_indexes_: BOOLEAN
			-- Auto generated Objective-C wrapper.
		do
			Result := objc_has_table_view__dragging_session__will_begin_at_point__for_row_indexes_ (item)
		end

	has_table_view__dragging_session__ended_at_point__operation_: BOOLEAN
			-- Auto generated Objective-C wrapper.
		do
			Result := objc_has_table_view__dragging_session__ended_at_point__operation_ (item)
		end

	has_table_view__update_dragging_items_for_drag_: BOOLEAN
			-- Auto generated Objective-C wrapper.
		do
			Result := objc_has_table_view__update_dragging_items_for_drag_ (item)
		end
...
feature -- Status Report Externals
	...
	objc_has_table_view__pasteboard_writer_for_row_ (an_item: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(id)$an_item respondsToSelector:@selector(tableView:pasteboardWriterForRow:)];
			 ]"
		end

	objc_has_table_view__dragging_session__will_begin_at_point__for_row_indexes_ (an_item: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(id)$an_item respondsToSelector:@selector(tableView:draggingSession:willBeginAtPoint:forRowIndexes:)];
			 ]"
		end

	objc_has_table_view__dragging_session__ended_at_point__operation_ (an_item: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(id)$an_item respondsToSelector:@selector(tableView:draggingSession:endedAtPoint:operation:)];
			 ]"
		end

	objc_has_table_view__update_dragging_items_for_drag_ (an_item: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(id)$an_item respondsToSelector:@selector(tableView:updateDraggingItemsForDrag:)];
			 ]"
		end
...
feature {NONE} -- Optional Methods Externals
	...
	objc_table_view__pasteboard_writer_for_row_ (an_item: POINTER; a_table_view: POINTER; a_row: INTEGER_64): POINTER
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return (EIF_POINTER)[(id <NSTableViewDataSource>)$an_item tableView:$a_table_view pasteboardWriterForRow:$a_row];
			 ]"
		end

	objc_table_view__dragging_session__will_begin_at_point__for_row_indexes_ (an_item: POINTER; a_table_view: POINTER; a_session: POINTER; a_screen_point: POINTER; a_row_indexes: POINTER)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(id <NSTableViewDataSource>)$an_item tableView:$a_table_view draggingSession:$a_session willBeginAtPoint:*((NSPoint *)$a_screen_point) forRowIndexes:$a_row_indexes];
			 ]"
		end

	objc_table_view__dragging_session__ended_at_point__operation_ (an_item: POINTER; a_table_view: POINTER; a_session: POINTER; a_screen_point: POINTER; a_operation: NATURAL_64)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(id <NSTableViewDataSource>)$an_item tableView:$a_table_view draggingSession:$a_session endedAtPoint:*((NSPoint *)$a_screen_point) operation:$a_operation];
			 ]"
		end

	objc_table_view__update_dragging_items_for_drag_ (an_item: POINTER; a_table_view: POINTER; a_dragging_info: POINTER)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(id <NSTableViewDataSource>)$an_item tableView:$a_table_view updateDraggingItemsForDrag:$a_dragging_info];
			 ]"
		end
