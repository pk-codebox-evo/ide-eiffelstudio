...
feature -- NSConstraintBasedLayoutLayering
	...
	invalidate_intrinsic_content_size_for_cell_ (a_cell: detachable NS_CELL)
			-- Auto generated Objective-C wrapper.
		local
			a_cell__item: POINTER
		do
			...
			objc_invalidate_intrinsic_content_size_for_cell_ (item, a_cell__item)
		end

feature {NONE} -- NSConstraintBasedLayoutLayering Externals

	objc_invalidate_intrinsic_content_size_for_cell_ (an_item: POINTER; a_cell: POINTER)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(NSControl *)$an_item invalidateIntrinsicContentSizeForCell:$a_cell];
			 ]"
		end
