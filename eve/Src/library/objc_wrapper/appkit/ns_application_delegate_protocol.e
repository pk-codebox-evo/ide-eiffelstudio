...
feature -- Optional Methods
	...
	application__did_register_for_remote_notifications_with_device_token_ (a_application: detachable NS_APPLICATION; a_device_token: detachable NS_DATA)
			-- Auto generated Objective-C wrapper.
		require
			has_application__did_register_for_remote_notifications_with_device_token_: has_application__did_register_for_remote_notifications_with_device_token_
		local
			a_application__item: POINTER
			a_device_token__item: POINTER
		do
			if attached a_application as a_application_attached then
				a_application__item := a_application_attached.item
			end
			if attached a_device_token as a_device_token_attached then
				a_device_token__item := a_device_token_attached.item
			end
			objc_application__did_register_for_remote_notifications_with_device_token_ (item, a_application__item, a_device_token__item)
		end

	application__did_fail_to_register_for_remote_notifications_with_error_ (a_application: detachable NS_APPLICATION; a_error: detachable NS_ERROR)
			-- Auto generated Objective-C wrapper.
		require
			has_application__did_fail_to_register_for_remote_notifications_with_error_: has_application__did_fail_to_register_for_remote_notifications_with_error_
		local
			a_application__item: POINTER
			a_error__item: POINTER
		do
			...
			objc_application__did_fail_to_register_for_remote_notifications_with_error_ (item, a_application__item, a_error__item)
		end

	application__did_receive_remote_notification_ (a_application: detachable NS_APPLICATION; a_user_info: detachable NS_DICTIONARY)
			-- Auto generated Objective-C wrapper.
		require
			has_application__did_receive_remote_notification_: has_application__did_receive_remote_notification_
		local
			a_application__item: POINTER
		...
		do
			...
			objc_application__did_receive_remote_notification_ (item, a_application__item, a_user_info__item)
		end

	application__will_encode_restorable_state_ (a_app: detachable NS_APPLICATION; a_coder: detachable NS_CODER)
			-- Auto generated Objective-C wrapper.
		require
			has_application__will_encode_restorable_state_: has_application__will_encode_restorable_state_
		local
			a_app__item: POINTER
			a_coder__item: POINTER
		do
			if attached a_app as a_app_attached then
				a_app__item := a_app_attached.item
			end
			if attached a_coder as a_coder_attached then
				a_coder__item := a_coder_attached.item
			end
			objc_application__will_encode_restorable_state_ (item, a_app__item, a_coder__item)
		end

	application__did_decode_restorable_state_ (a_app: detachable NS_APPLICATION; a_coder: detachable NS_CODER)
			-- Auto generated Objective-C wrapper.
		require
			has_application__did_decode_restorable_state_: has_application__did_decode_restorable_state_
		local
			a_app__item: POINTER
			a_coder__item: POINTER
		do
			...
			objc_application__did_decode_restorable_state_ (item, a_app__item, a_coder__item)
		end
...
feature -- Status Report
	...
	has_application__did_register_for_remote_notifications_with_device_token_: BOOLEAN
			-- Auto generated Objective-C wrapper.
		do
			Result := objc_has_application__did_register_for_remote_notifications_with_device_token_ (item)
		end

	has_application__did_fail_to_register_for_remote_notifications_with_error_: BOOLEAN
			-- Auto generated Objective-C wrapper.
		do
			Result := objc_has_application__did_fail_to_register_for_remote_notifications_with_error_ (item)
		end

	has_application__did_receive_remote_notification_: BOOLEAN
			-- Auto generated Objective-C wrapper.
		do
			Result := objc_has_application__did_receive_remote_notification_ (item)
		end

	has_application__will_encode_restorable_state_: BOOLEAN
			-- Auto generated Objective-C wrapper.
		do
			Result := objc_has_application__will_encode_restorable_state_ (item)
		end

	has_application__did_decode_restorable_state_: BOOLEAN
			-- Auto generated Objective-C wrapper.
		do
			Result := objc_has_application__did_decode_restorable_state_ (item)
		end
...
feature -- Status Report Externals
	...
	objc_has_application__did_register_for_remote_notifications_with_device_token_ (an_item: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(id)$an_item respondsToSelector:@selector(application:didRegisterForRemoteNotificationsWithDeviceToken:)];
			 ]"
		end

	objc_has_application__did_fail_to_register_for_remote_notifications_with_error_ (an_item: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(id)$an_item respondsToSelector:@selector(application:didFailToRegisterForRemoteNotificationsWithError:)];
			 ]"
		end

	objc_has_application__did_receive_remote_notification_ (an_item: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(id)$an_item respondsToSelector:@selector(application:didReceiveRemoteNotification:)];
			 ]"
		end

	objc_has_application__will_encode_restorable_state_ (an_item: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(id)$an_item respondsToSelector:@selector(application:willEncodeRestorableState:)];
			 ]"
		end

	objc_has_application__did_decode_restorable_state_ (an_item: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(id)$an_item respondsToSelector:@selector(application:didDecodeRestorableState:)];
			 ]"
		end
...
feature {NONE} -- Optional Methods Externals
	...
	objc_application__did_register_for_remote_notifications_with_device_token_ (an_item: POINTER; a_application: POINTER; a_device_token: POINTER)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(id <NSApplicationDelegate>)$an_item application:$a_application didRegisterForRemoteNotificationsWithDeviceToken:$a_device_token];
			 ]"
		end

	objc_application__did_fail_to_register_for_remote_notifications_with_error_ (an_item: POINTER; a_application: POINTER; a_error: POINTER)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(id <NSApplicationDelegate>)$an_item application:$a_application didFailToRegisterForRemoteNotificationsWithError:$a_error];
			 ]"
		end

	objc_application__did_receive_remote_notification_ (an_item: POINTER; a_application: POINTER; a_user_info: POINTER)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(id <NSApplicationDelegate>)$an_item application:$a_application didReceiveRemoteNotification:$a_user_info];
			 ]"
		end

	objc_application__will_encode_restorable_state_ (an_item: POINTER; a_app: POINTER; a_coder: POINTER)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(id <NSApplicationDelegate>)$an_item application:$a_app willEncodeRestorableState:$a_coder];
			 ]"
		end

	objc_application__did_decode_restorable_state_ (an_item: POINTER; a_app: POINTER; a_coder: POINTER)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(id <NSApplicationDelegate>)$an_item application:$a_app didDecodeRestorableState:$a_coder];
			 ]"
		end
