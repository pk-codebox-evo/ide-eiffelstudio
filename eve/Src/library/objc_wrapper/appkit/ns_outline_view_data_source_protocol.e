...
feature -- Optional Methods
	...
	outline_view__pasteboard_writer_for_item_ (a_outline_view: detachable NS_OUTLINE_VIEW; a_item: detachable NS_OBJECT): detachable NS_PASTEBOARD_WRITING_PROTOCOL
			-- Auto generated Objective-C wrapper.
		require
			has_outline_view__pasteboard_writer_for_item_: has_outline_view__pasteboard_writer_for_item_
		local
			result_pointer: POINTER
			a_outline_view__item: POINTER
			a_item__item: POINTER
		do
			...
			result_pointer := objc_outline_view__pasteboard_writer_for_item_ (item, a_outline_view__item, a_item__item)
			if result_pointer /= default_pointer then
				if attached objc_get_eiffel_object (result_pointer) as existing_eiffel_object then
					check attached {like outline_view__pasteboard_writer_for_item_} existing_eiffel_object as valid_result then
						Result := valid_result
					end
				else
					check attached {like outline_view__pasteboard_writer_for_item_} new_eiffel_object (result_pointer, True) as valid_result_pointer then
						Result := valid_result_pointer
					end
				end
			end
	...
	outline_view__dragging_session__will_begin_at_point__for_items_ (a_outline_view: detachable NS_OUTLINE_VIEW; a_session: detachable NS_DRAGGING_SESSION; a_screen_point: NS_POINT; a_dragged_items: detachable NS_ARRAY)
			-- Auto generated Objective-C wrapper.
		require
			has_outline_view__dragging_session__will_begin_at_point__for_items_: has_outline_view__dragging_session__will_begin_at_point__for_items_
		local
			a_outline_view__item: POINTER
			a_session__item: POINTER
			a_dragged_items__item: POINTER
		do
			if attached a_outline_view as a_outline_view_attached then
				a_outline_view__item := a_outline_view_attached.item
			end
			...
			if attached a_dragged_items as a_dragged_items_attached then
				a_dragged_items__item := a_dragged_items_attached.item
			end
			objc_outline_view__dragging_session__will_begin_at_point__for_items_ (item, a_outline_view__item, a_session__item, a_screen_point.item, a_dragged_items__item)
		end

	outline_view__dragging_session__ended_at_point__operation_ (a_outline_view: detachable NS_OUTLINE_VIEW; a_session: detachable NS_DRAGGING_SESSION; a_screen_point: NS_POINT; a_operation: NATURAL_64)
			-- Auto generated Objective-C wrapper.
		require
			has_outline_view__dragging_session__ended_at_point__operation_: has_outline_view__dragging_session__ended_at_point__operation_
		local
			a_outline_view__item: POINTER
			a_session__item: POINTER
		do
			...
			objc_outline_view__dragging_session__ended_at_point__operation_ (item, a_outline_view__item, a_session__item, a_screen_point.item, a_operation)
		end
	...
	outline_view__update_dragging_items_for_drag_ (a_outline_view: detachable NS_OUTLINE_VIEW; a_dragging_info: detachable NS_DRAGGING_INFO_PROTOCOL)
			-- Auto generated Objective-C wrapper.
		require
			has_outline_view__update_dragging_items_for_drag_: has_outline_view__update_dragging_items_for_drag_
		local
			a_outline_view__item: POINTER
		...
		do
			...
			objc_outline_view__update_dragging_items_for_drag_ (item, a_outline_view__item, a_dragging_info__item)
		end
...
feature -- Status Report
	...
	has_outline_view__pasteboard_writer_for_item_: BOOLEAN
			-- Auto generated Objective-C wrapper.
		do
			Result := objc_has_outline_view__pasteboard_writer_for_item_ (item)
		end

	has_outline_view__dragging_session__will_begin_at_point__for_items_: BOOLEAN
			-- Auto generated Objective-C wrapper.
		do
			Result := objc_has_outline_view__dragging_session__will_begin_at_point__for_items_ (item)
		end

	has_outline_view__dragging_session__ended_at_point__operation_: BOOLEAN
			-- Auto generated Objective-C wrapper.
		do
			Result := objc_has_outline_view__dragging_session__ended_at_point__operation_ (item)
		end
	...
	has_outline_view__update_dragging_items_for_drag_: BOOLEAN
			-- Auto generated Objective-C wrapper.
		do
			Result := objc_has_outline_view__update_dragging_items_for_drag_ (item)
		end
...
feature -- Status Report Externals
	...
	objc_has_outline_view__pasteboard_writer_for_item_ (an_item: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(id)$an_item respondsToSelector:@selector(outlineView:pasteboardWriterForItem:)];
			 ]"
		end

	objc_has_outline_view__dragging_session__will_begin_at_point__for_items_ (an_item: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(id)$an_item respondsToSelector:@selector(outlineView:draggingSession:willBeginAtPoint:forItems:)];
			 ]"
		end

	objc_has_outline_view__dragging_session__ended_at_point__operation_ (an_item: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(id)$an_item respondsToSelector:@selector(outlineView:draggingSession:endedAtPoint:operation:)];
			 ]"
		end
	...
	objc_has_outline_view__update_dragging_items_for_drag_ (an_item: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(id)$an_item respondsToSelector:@selector(outlineView:updateDraggingItemsForDrag:)];
			 ]"
		end
...
feature {NONE} -- Optional Methods Externals
	...
	objc_outline_view__pasteboard_writer_for_item_ (an_item: POINTER; a_outline_view: POINTER; a_item: POINTER): POINTER
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return (EIF_POINTER)[(id <NSOutlineViewDataSource>)$an_item outlineView:$a_outline_view pasteboardWriterForItem:$a_item];
			 ]"
		end

	objc_outline_view__dragging_session__will_begin_at_point__for_items_ (an_item: POINTER; a_outline_view: POINTER; a_session: POINTER; a_screen_point: POINTER; a_dragged_items: POINTER)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(id <NSOutlineViewDataSource>)$an_item outlineView:$a_outline_view draggingSession:$a_session willBeginAtPoint:*((NSPoint *)$a_screen_point) forItems:$a_dragged_items];
			 ]"
		end

	objc_outline_view__dragging_session__ended_at_point__operation_ (an_item: POINTER; a_outline_view: POINTER; a_session: POINTER; a_screen_point: POINTER; a_operation: NATURAL_64)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(id <NSOutlineViewDataSource>)$an_item outlineView:$a_outline_view draggingSession:$a_session endedAtPoint:*((NSPoint *)$a_screen_point) operation:$a_operation];
			 ]"
		end
	...
	objc_outline_view__update_dragging_items_for_drag_ (an_item: POINTER; a_outline_view: POINTER; a_dragging_info: POINTER)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(id <NSOutlineViewDataSource>)$an_item outlineView:$a_outline_view updateDraggingItemsForDrag:$a_dragging_info];
			 ]"
		end
