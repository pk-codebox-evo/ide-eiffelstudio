...
--	commit_editing_and_return_error_ (a_ns_object: NS_OBJECT; a_error: UNSUPPORTED_TYPE): BOOLEAN
--			-- Auto generated Objective-C wrapper.
--		local
...
--			end
--			Result := objc_commit_editing_and_return_error_ (a_ns_object.item, a_error__item)
--		end
...
--	objc_commit_editing_and_return_error_ (an_item: POINTER; a_error: UNSUPPORTED_TYPE): BOOLEAN
--			-- Auto generated Objective-C wrapper.
--		external
--			"C inline use <AppKit/AppKit.h>"
--		alias
--			"[
--				return [(NSObject *)$an_item commitEditingAndReturnError:];
--			 ]"
--		end
