...
feature -- Optional Methods
	...
	tab_view_did_change_number_of_tab_view_items_ (a_tab_view: detachable NS_TAB_VIEW)
			-- Auto generated Objective-C wrapper.
		require
		...
		do
			...
			objc_tab_view_did_change_number_of_tab_view_items_ (item, a_tab_view__item)
		end
...
feature {NONE} -- Optional Methods Externals
	...
	objc_tab_view_did_change_number_of_tab_view_items_ (an_item: POINTER; a_tab_view: POINTER)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(id <NSTabViewDelegate>)$an_item tabViewDidChangeNumberOfTabViewItems:$a_tab_view];
			 ]"
		end
