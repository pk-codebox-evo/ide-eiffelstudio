...
feature {NONE} -- NSToolbar Externals
	...
	objc_set_full_screen_accessory_view_ (an_item: POINTER; a_view: POINTER)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(NSToolbar *)$an_item setFullScreenAccessoryView:$a_view];
			 ]"
		end

	objc_full_screen_accessory_view (an_item: POINTER): POINTER
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return (EIF_POINTER)[(NSToolbar *)$an_item fullScreenAccessoryView];
			 ]"
		end

	objc_set_full_screen_accessory_view_min_height_ (an_item: POINTER; a_min_height: REAL_64)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(NSToolbar *)$an_item setFullScreenAccessoryViewMinHeight:$a_min_height];
			 ]"
		end

	objc_set_full_screen_accessory_view_max_height_ (an_item: POINTER; a_max_height: REAL_64)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(NSToolbar *)$an_item setFullScreenAccessoryViewMaxHeight:$a_max_height];
			 ]"
		end

	objc_full_screen_accessory_view_min_height (an_item: POINTER): REAL_64
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(NSToolbar *)$an_item fullScreenAccessoryViewMinHeight];
			 ]"
		end

	objc_full_screen_accessory_view_max_height (an_item: POINTER): REAL_64
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(NSToolbar *)$an_item fullScreenAccessoryViewMaxHeight];
			 ]"
		end
...
feature -- NSToolbar
	...
	set_full_screen_accessory_view_ (a_view: detachable NS_VIEW)
			-- Auto generated Objective-C wrapper.
		local
		...
		do
			...
			objc_set_full_screen_accessory_view_ (item, a_view__item)
		end

	full_screen_accessory_view: detachable NS_VIEW
			-- Auto generated Objective-C wrapper.
		local
			result_pointer: POINTER
		do
			result_pointer := objc_full_screen_accessory_view (item)
			if result_pointer /= default_pointer then
				if attached objc_get_eiffel_object (result_pointer) as existing_eiffel_object then
					check attached {like full_screen_accessory_view} existing_eiffel_object as valid_result then
						Result := valid_result
					end
				else
					check attached {like full_screen_accessory_view} new_eiffel_object (result_pointer, True) as valid_result_pointer then
						Result := valid_result_pointer
					end
				end
			end
	...
	set_full_screen_accessory_view_min_height_ (a_min_height: REAL_64)
			-- Auto generated Objective-C wrapper.
		local
		do
			objc_set_full_screen_accessory_view_min_height_ (item, a_min_height)
		end

	set_full_screen_accessory_view_max_height_ (a_max_height: REAL_64)
			-- Auto generated Objective-C wrapper.
		local
		do
			objc_set_full_screen_accessory_view_max_height_ (item, a_max_height)
		end

	full_screen_accessory_view_min_height: REAL_64
			-- Auto generated Objective-C wrapper.
		local
		do
			Result := objc_full_screen_accessory_view_min_height (item)
		end

	full_screen_accessory_view_max_height: REAL_64
			-- Auto generated Objective-C wrapper.
		local
		do
			Result := objc_full_screen_accessory_view_max_height (item)
		end
