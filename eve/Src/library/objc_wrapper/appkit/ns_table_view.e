...
feature -- NSTableView
	...
	set_grid_style_mask_ (a_grid_style: NATURAL_64)
			-- Auto generated Objective-C wrapper.
		local
		do
			objc_set_grid_style_mask_ (item, a_grid_style)
		end
	...
	set_row_size_style_ (a_row_size_style: INTEGER_64)
			-- Auto generated Objective-C wrapper.
		local
		do
			objc_set_row_size_style_ (item, a_row_size_style)
		end

	row_size_style: INTEGER_64
			-- Auto generated Objective-C wrapper.
		local
		do
	...
	effective_row_size_style: INTEGER_64
			-- Auto generated Objective-C wrapper.
		local
		do
			Result := objc_effective_row_size_style (item)
		end
	...
	column_with_identifier_ (a_identifier: detachable NS_STRING): INTEGER_64
			-- Auto generated Objective-C wrapper.
		local
	...
	table_column_with_identifier_ (a_identifier: detachable NS_STRING): detachable NS_TABLE_COLUMN
			-- Auto generated Objective-C wrapper.
		local
			result_pointer: POINTER
			a_identifier__item: POINTER
...
--		end
	...
	view_at_column__row__make_if_necessary_ (a_column: INTEGER_64; a_row: INTEGER_64; a_make_if_necessary: BOOLEAN): detachable NS_OBJECT
			-- Auto generated Objective-C wrapper.
		local
			result_pointer: POINTER
		do
			result_pointer := objc_view_at_column__row__make_if_necessary_ (item, a_column, a_row, a_make_if_necessary)
			if result_pointer /= default_pointer then
				if attached objc_get_eiffel_object (result_pointer) as existing_eiffel_object then
					check attached {like view_at_column__row__make_if_necessary_} existing_eiffel_object as valid_result then
						Result := valid_result
					end
				else
					check attached {like view_at_column__row__make_if_necessary_} new_eiffel_object (result_pointer, True) as valid_result_pointer then
						Result := valid_result_pointer
					end
				end
			end
	...
	row_view_at_row__make_if_necessary_ (a_row: INTEGER_64; a_make_if_necessary: BOOLEAN): detachable NS_OBJECT
			-- Auto generated Objective-C wrapper.
		local
			result_pointer: POINTER
		do
			result_pointer := objc_row_view_at_row__make_if_necessary_ (item, a_row, a_make_if_necessary)
			if result_pointer /= default_pointer then
				if attached objc_get_eiffel_object (result_pointer) as existing_eiffel_object then
					check attached {like row_view_at_row__make_if_necessary_} existing_eiffel_object as valid_result then
						Result := valid_result
					end
				else
					check attached {like row_view_at_row__make_if_necessary_} new_eiffel_object (result_pointer, True) as valid_result_pointer then
						Result := valid_result_pointer
					end
				end
			end
	...
	row_for_view_ (a_view: detachable NS_VIEW): INTEGER_64
			-- Auto generated Objective-C wrapper.
		local
		...
		do
			...
			Result := objc_row_for_view_ (item, a_view__item)
		end

	column_for_view_ (a_view: detachable NS_VIEW): INTEGER_64
			-- Auto generated Objective-C wrapper.
		local
			a_view__item: POINTER
		do
			...
			Result := objc_column_for_view_ (item, a_view__item)
		end

	make_view_with_identifier__owner_ (a_identifier: detachable NS_STRING; a_owner: detachable NS_OBJECT): detachable NS_OBJECT
			-- Auto generated Objective-C wrapper.
		local
			result_pointer: POINTER
			a_identifier__item: POINTER
		...
		do
			...
			result_pointer := objc_make_view_with_identifier__owner_ (item, a_identifier__item, a_owner__item)
			if result_pointer /= default_pointer then
				if attached objc_get_eiffel_object (result_pointer) as existing_eiffel_object then
					check attached {like make_view_with_identifier__owner_} existing_eiffel_object as valid_result then
						Result := valid_result
					end
				else
					check attached {like make_view_with_identifier__owner_} new_eiffel_object (result_pointer, True) as valid_result_pointer then
						Result := valid_result_pointer
					end
				end
			end
...
--	enumerate_available_row_views_using_block_ (a_handler: UNSUPPORTED_TYPE)
--			-- Auto generated Objective-C wrapper.
--		local
--		do
--			objc_enumerate_available_row_views_using_block_ (item, )
--		end

	floats_group_rows: BOOLEAN
			-- Auto generated Objective-C wrapper.
		local
		do
			Result := objc_floats_group_rows (item)
		end

	set_floats_group_rows_ (a_value: BOOLEAN)
			-- Auto generated Objective-C wrapper.
		local
		do
			objc_set_floats_group_rows_ (item, a_value)
		end
	...
	end_updates
		...
		local
		do
			objc_end_updates (item)
		end

	insert_rows_at_indexes__with_animation_ (a_indexes: detachable NS_INDEX_SET; a_animation_options: NATURAL_64)
			-- Auto generated Objective-C wrapper.
		local
			a_indexes__item: POINTER
		do
			...
			objc_insert_rows_at_indexes__with_animation_ (item, a_indexes__item, a_animation_options)
		end

	remove_rows_at_indexes__with_animation_ (a_indexes: detachable NS_INDEX_SET; a_animation_options: NATURAL_64)
			-- Auto generated Objective-C wrapper.
		local
			a_indexes__item: POINTER
		do
			...
			objc_remove_rows_at_indexes__with_animation_ (item, a_indexes__item, a_animation_options)
		end

	move_row_at_index__to_index_ (a_old_index: INTEGER_64; a_new_index: INTEGER_64)
			-- Auto generated Objective-C wrapper.
		local
		do
			objc_move_row_at_index__to_index_ (item, a_old_index, a_new_index)
		end
...
feature {NONE} -- NSTableView Externals
	...
	objc_set_grid_style_mask_ (an_item: POINTER; a_grid_style: NATURAL_64)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(NSTableView *)$an_item setGridStyleMask:$a_grid_style];
			 ]"
		end
	...
	objc_set_row_size_style_ (an_item: POINTER; a_row_size_style: INTEGER_64)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(NSTableView *)$an_item setRowSizeStyle:$a_row_size_style];
			 ]"
		end
	...
	objc_row_size_style (an_item: POINTER): INTEGER_64
		...
		alias
			"[
				return [(NSTableView *)$an_item rowSizeStyle];
			 ]"
		end

	objc_effective_row_size_style (an_item: POINTER): INTEGER_64
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(NSTableView *)$an_item effectiveRowSizeStyle];
			 ]"
		end
...
--		end
	...
	objc_view_at_column__row__make_if_necessary_ (an_item: POINTER; a_column: INTEGER_64; a_row: INTEGER_64; a_make_if_necessary: BOOLEAN): POINTER
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return (EIF_POINTER)[(NSTableView *)$an_item viewAtColumn:$a_column row:$a_row makeIfNecessary:$a_make_if_necessary];
			 ]"
		end

	objc_row_view_at_row__make_if_necessary_ (an_item: POINTER; a_row: INTEGER_64; a_make_if_necessary: BOOLEAN): POINTER
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return (EIF_POINTER)[(NSTableView *)$an_item rowViewAtRow:$a_row makeIfNecessary:$a_make_if_necessary];
			 ]"
		end

	objc_row_for_view_ (an_item: POINTER; a_view: POINTER): INTEGER_64
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(NSTableView *)$an_item rowForView:$a_view];
			 ]"
		end

	objc_column_for_view_ (an_item: POINTER; a_view: POINTER): INTEGER_64
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(NSTableView *)$an_item columnForView:$a_view];
			 ]"
		end

	objc_make_view_with_identifier__owner_ (an_item: POINTER; a_identifier: POINTER; a_owner: POINTER): POINTER
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return (EIF_POINTER)[(NSTableView *)$an_item makeViewWithIdentifier:$a_identifier owner:$a_owner];
			 ]"
		end

--	objc_enumerate_available_row_views_using_block_ (an_item: POINTER; a_handler: UNSUPPORTED_TYPE)
--			-- Auto generated Objective-C wrapper.
--		external
--			"C inline use <AppKit/AppKit.h>"
--		alias
--			"[
--				[(NSTableView *)$an_item enumerateAvailableRowViewsUsingBlock:];
--			 ]"
--		end

	objc_floats_group_rows (an_item: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(NSTableView *)$an_item floatsGroupRows];
			 ]"
		end

	objc_set_floats_group_rows_ (an_item: POINTER; a_value: BOOLEAN)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(NSTableView *)$an_item setFloatsGroupRows:$a_value];
			 ]"
		end

	objc_begin_updates (an_item: POINTER)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(NSTableView *)$an_item beginUpdates];
			 ]"
		end

	objc_end_updates (an_item: POINTER)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(NSTableView *)$an_item endUpdates];
			 ]"
		end

	objc_insert_rows_at_indexes__with_animation_ (an_item: POINTER; a_indexes: POINTER; a_animation_options: NATURAL_64)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(NSTableView *)$an_item insertRowsAtIndexes:$a_indexes withAnimation:$a_animation_options];
			 ]"
		end

	objc_remove_rows_at_indexes__with_animation_ (an_item: POINTER; a_indexes: POINTER; a_animation_options: NATURAL_64)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(NSTableView *)$an_item removeRowsAtIndexes:$a_indexes withAnimation:$a_animation_options];
			 ]"
		end

	objc_move_row_at_index__to_index_ (an_item: POINTER; a_old_index: INTEGER_64; a_new_index: INTEGER_64)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(NSTableView *)$an_item moveRowAtIndex:$a_old_index toIndex:$a_new_index];
			 ]"
		end
