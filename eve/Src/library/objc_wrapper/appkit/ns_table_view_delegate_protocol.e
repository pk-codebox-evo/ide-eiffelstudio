...
feature -- Optional Methods
	...
	table_view__view_for_table_column__row_ (a_table_view: detachable NS_TABLE_VIEW; a_table_column: detachable NS_TABLE_COLUMN; a_row: INTEGER_64): detachable NS_VIEW
			-- Auto generated Objective-C wrapper.
		require
			has_table_view__view_for_table_column__row_: has_table_view__view_for_table_column__row_
		local
		...
		do
			...
			result_pointer := objc_table_view__view_for_table_column__row_ (item, a_table_view__item, a_table_column__item, a_row)
			if result_pointer /= default_pointer then
				if attached objc_get_eiffel_object (result_pointer) as existing_eiffel_object then
					check attached {like table_view__view_for_table_column__row_} existing_eiffel_object as valid_result then
						Result := valid_result
					end
				else
					check attached {like table_view__view_for_table_column__row_} new_eiffel_object (result_pointer, True) as valid_result_pointer then
	...
	table_view__row_view_for_row_ (a_table_view: detachable NS_TABLE_VIEW; a_row: INTEGER_64): detachable NS_TABLE_ROW_VIEW
			-- Auto generated Objective-C wrapper.
		require
			has_table_view__row_view_for_row_: has_table_view__row_view_for_row_
		local
			result_pointer: POINTER
			a_table_view__item: POINTER
		do
			...
			result_pointer := objc_table_view__row_view_for_row_ (item, a_table_view__item, a_row)
			if result_pointer /= default_pointer then
				if attached objc_get_eiffel_object (result_pointer) as existing_eiffel_object then
					check attached {like table_view__row_view_for_row_} existing_eiffel_object as valid_result then
						Result := valid_result
					end
				else
					check attached {like table_view__row_view_for_row_} new_eiffel_object (result_pointer, True) as valid_result_pointer then
						Result := valid_result_pointer
					end
				end
			end
	...
	table_view__did_add_row_view__for_row_ (a_table_view: detachable NS_TABLE_VIEW; a_row_view: detachable NS_TABLE_ROW_VIEW; a_row: INTEGER_64)
			-- Auto generated Objective-C wrapper.
		require
			has_table_view__did_add_row_view__for_row_: has_table_view__did_add_row_view__for_row_
		local
			a_table_view__item: POINTER
		...
		do
			...
			objc_table_view__did_add_row_view__for_row_ (item, a_table_view__item, a_row_view__item, a_row)
		end

	table_view__did_remove_row_view__for_row_ (a_table_view: detachable NS_TABLE_VIEW; a_row_view: detachable NS_TABLE_ROW_VIEW; a_row: INTEGER_64)
			-- Auto generated Objective-C wrapper.
		require
			has_table_view__did_remove_row_view__for_row_: has_table_view__did_remove_row_view__for_row_
		local
			a_table_view__item: POINTER
			a_row_view__item: POINTER
		do
			...
			objc_table_view__did_remove_row_view__for_row_ (item, a_table_view__item, a_row_view__item, a_row)
		end
...
feature -- Status Report
	...
	has_table_view__view_for_table_column__row_: BOOLEAN
			-- Auto generated Objective-C wrapper.
		do
			Result := objc_has_table_view__view_for_table_column__row_ (item)
		end

	has_table_view__row_view_for_row_: BOOLEAN
			-- Auto generated Objective-C wrapper.
		do
			Result := objc_has_table_view__row_view_for_row_ (item)
		end

	has_table_view__did_add_row_view__for_row_: BOOLEAN
			-- Auto generated Objective-C wrapper.
		do
			Result := objc_has_table_view__did_add_row_view__for_row_ (item)
		end

	has_table_view__did_remove_row_view__for_row_: BOOLEAN
			-- Auto generated Objective-C wrapper.
		do
			Result := objc_has_table_view__did_remove_row_view__for_row_ (item)
		end
...
feature -- Status Report Externals
	...
	objc_has_table_view__view_for_table_column__row_ (an_item: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(id)$an_item respondsToSelector:@selector(tableView:viewForTableColumn:row:)];
			 ]"
		end

	objc_has_table_view__row_view_for_row_ (an_item: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(id)$an_item respondsToSelector:@selector(tableView:rowViewForRow:)];
			 ]"
		end

	objc_has_table_view__did_add_row_view__for_row_ (an_item: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(id)$an_item respondsToSelector:@selector(tableView:didAddRowView:forRow:)];
			 ]"
		end

	objc_has_table_view__did_remove_row_view__for_row_ (an_item: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(id)$an_item respondsToSelector:@selector(tableView:didRemoveRowView:forRow:)];
			 ]"
		end
...
feature {NONE} -- Optional Methods Externals
	...
	objc_table_view__view_for_table_column__row_ (an_item: POINTER; a_table_view: POINTER; a_table_column: POINTER; a_row: INTEGER_64): POINTER
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return (EIF_POINTER)[(id <NSTableViewDelegate>)$an_item tableView:$a_table_view viewForTableColumn:$a_table_column row:$a_row];
			 ]"
		end

	objc_table_view__row_view_for_row_ (an_item: POINTER; a_table_view: POINTER; a_row: INTEGER_64): POINTER
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return (EIF_POINTER)[(id <NSTableViewDelegate>)$an_item tableView:$a_table_view rowViewForRow:$a_row];
			 ]"
		end

	objc_table_view__did_add_row_view__for_row_ (an_item: POINTER; a_table_view: POINTER; a_row_view: POINTER; a_row: INTEGER_64)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(id <NSTableViewDelegate>)$an_item tableView:$a_table_view didAddRowView:$a_row_view forRow:$a_row];
			 ]"
		end

	objc_table_view__did_remove_row_view__for_row_ (an_item: POINTER; a_table_view: POINTER; a_row_view: POINTER; a_row: INTEGER_64)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(id <NSTableViewDelegate>)$an_item tableView:$a_table_view didRemoveRowView:$a_row_view forRow:$a_row];
			 ]"
		end
