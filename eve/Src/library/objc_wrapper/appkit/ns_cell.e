...
--		end
	...
	objc_dragging_image_components_with_frame__in_view_ (an_item: POINTER; a_frame: POINTER; a_view: POINTER): POINTER
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return (EIF_POINTER)[(NSCell *)$an_item draggingImageComponentsWithFrame:*((NSRect *)$a_frame) inView:$a_view];
			 ]"
		end
...
--		end
	...
	dragging_image_components_with_frame__in_view_ (a_frame: NS_RECT; a_view: detachable NS_VIEW): detachable NS_ARRAY
			-- Auto generated Objective-C wrapper.
		local
			result_pointer: POINTER
			a_view__item: POINTER
		do
			...
			result_pointer := objc_dragging_image_components_with_frame__in_view_ (item, a_frame.item, a_view__item)
			if result_pointer /= default_pointer then
				if attached objc_get_eiffel_object (result_pointer) as existing_eiffel_object then
					check attached {like dragging_image_components_with_frame__in_view_} existing_eiffel_object as valid_result then
						Result := valid_result
					end
				else
					check attached {like dragging_image_components_with_frame__in_view_} new_eiffel_object (result_pointer, True) as valid_result_pointer then
						Result := valid_result_pointer
					end
				end
			end
...
feature -- NSKeyboardUI
	...
	draw_focus_ring_mask_with_frame__in_view_ (a_cell_frame: NS_RECT; a_control_view: detachable NS_VIEW)
			-- Auto generated Objective-C wrapper.
		local
			a_control_view__item: POINTER
		do
			...
			objc_draw_focus_ring_mask_with_frame__in_view_ (item, a_cell_frame.item, a_control_view__item)
		end

	focus_ring_mask_bounds_for_frame__in_view_ (a_cell_frame: NS_RECT; a_control_view: detachable NS_VIEW): NS_RECT
			-- Auto generated Objective-C wrapper.
		local
			a_control_view__item: POINTER
		do
			...
			create Result.make
			objc_focus_ring_mask_bounds_for_frame__in_view_ (item, Result.item, a_cell_frame.item, a_control_view__item)
		end
...
feature {NONE} -- NSKeyboardUI Externals
	...
	objc_draw_focus_ring_mask_with_frame__in_view_ (an_item: POINTER; a_cell_frame: POINTER; a_control_view: POINTER)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(NSCell *)$an_item drawFocusRingMaskWithFrame:*((NSRect *)$a_cell_frame) inView:$a_control_view];
			 ]"
		end

	objc_focus_ring_mask_bounds_for_frame__in_view_ (an_item: POINTER; result_pointer: POINTER; a_cell_frame: POINTER; a_control_view: POINTER)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				*(NSRect *)$result_pointer = [(NSCell *)$an_item focusRingMaskBoundsForFrame:*((NSRect *)$a_cell_frame) inView:$a_control_view];
			 ]"
		end
