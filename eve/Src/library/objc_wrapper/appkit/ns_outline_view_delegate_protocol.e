...
feature -- Optional Methods
	...
	outline_view__view_for_table_column__item_ (a_outline_view: detachable NS_OUTLINE_VIEW; a_table_column: detachable NS_TABLE_COLUMN; a_item: detachable NS_OBJECT): detachable NS_VIEW
			-- Auto generated Objective-C wrapper.
		require
			has_outline_view__view_for_table_column__item_: has_outline_view__view_for_table_column__item_
		local
		...
		do
			...
			result_pointer := objc_outline_view__view_for_table_column__item_ (item, a_outline_view__item, a_table_column__item, a_item__item)
			if result_pointer /= default_pointer then
				if attached objc_get_eiffel_object (result_pointer) as existing_eiffel_object then
					check attached {like outline_view__view_for_table_column__item_} existing_eiffel_object as valid_result then
						Result := valid_result
					end
				else
					check attached {like outline_view__view_for_table_column__item_} new_eiffel_object (result_pointer, True) as valid_result_pointer then
	...
	outline_view__row_view_for_item_ (a_outline_view: detachable NS_OUTLINE_VIEW; a_item: detachable NS_OBJECT): detachable NS_TABLE_ROW_VIEW
			-- Auto generated Objective-C wrapper.
		require
			has_outline_view__row_view_for_item_: has_outline_view__row_view_for_item_
		local
			result_pointer: POINTER
			a_outline_view__item: POINTER
			a_item__item: POINTER
		do
			...
			result_pointer := objc_outline_view__row_view_for_item_ (item, a_outline_view__item, a_item__item)
			if result_pointer /= default_pointer then
				if attached objc_get_eiffel_object (result_pointer) as existing_eiffel_object then
					check attached {like outline_view__row_view_for_item_} existing_eiffel_object as valid_result then
						Result := valid_result
					end
				else
					check attached {like outline_view__row_view_for_item_} new_eiffel_object (result_pointer, True) as valid_result_pointer then
						Result := valid_result_pointer
					end
				end
			end
	...
	outline_view__did_add_row_view__for_row_ (a_outline_view: detachable NS_OUTLINE_VIEW; a_row_view: detachable NS_TABLE_ROW_VIEW; a_row: INTEGER_64)
			-- Auto generated Objective-C wrapper.
		require
			has_outline_view__did_add_row_view__for_row_: has_outline_view__did_add_row_view__for_row_
		local
			a_outline_view__item: POINTER
			a_row_view__item: POINTER
		do
			if attached a_outline_view as a_outline_view_attached then
				a_outline_view__item := a_outline_view_attached.item
			end
			if attached a_row_view as a_row_view_attached then
				a_row_view__item := a_row_view_attached.item
			end
			objc_outline_view__did_add_row_view__for_row_ (item, a_outline_view__item, a_row_view__item, a_row)
		end

	outline_view__did_remove_row_view__for_row_ (a_outline_view: detachable NS_OUTLINE_VIEW; a_row_view: detachable NS_TABLE_ROW_VIEW; a_row: INTEGER_64)
			-- Auto generated Objective-C wrapper.
		require
			has_outline_view__did_remove_row_view__for_row_: has_outline_view__did_remove_row_view__for_row_
		local
			a_outline_view__item: POINTER
			a_row_view__item: POINTER
		do
			...
			objc_outline_view__did_remove_row_view__for_row_ (item, a_outline_view__item, a_row_view__item, a_row)
		end
...
--		end
	...
	outline_view_selection_did_change_ (a_notification: detachable NS_NOTIFICATION)
			-- Auto generated Objective-C wrapper.
		require
			has_outline_view_selection_did_change_: has_outline_view_selection_did_change_
		local
		...
		do
			...
			objc_outline_view_selection_did_change_ (item, a_notification__item)
		end

	outline_view_column_did_move_ (a_notification: detachable NS_NOTIFICATION)
			-- Auto generated Objective-C wrapper.
		require
			has_outline_view_column_did_move_: has_outline_view_column_did_move_
		local
			a_notification__item: POINTER
		do
			if attached a_notification as a_notification_attached then
			...
			objc_outline_view_column_did_move_ (item, a_notification__item)
		end

	outline_view_column_did_resize_ (a_notification: detachable NS_NOTIFICATION)
			-- Auto generated Objective-C wrapper.
		require
			has_outline_view_column_did_resize_: has_outline_view_column_did_resize_
		local
			a_notification__item: POINTER
		do
			if attached a_notification as a_notification_attached then
			...
			objc_outline_view_column_did_resize_ (item, a_notification__item)
		end

	outline_view_selection_is_changing_ (a_notification: detachable NS_NOTIFICATION)
			-- Auto generated Objective-C wrapper.
		require
			has_outline_view_selection_is_changing_: has_outline_view_selection_is_changing_
		local
			a_notification__item: POINTER
		do
			if attached a_notification as a_notification_attached then
			...
			objc_outline_view_selection_is_changing_ (item, a_notification__item)
		end

	outline_view_item_will_expand_ (a_notification: detachable NS_NOTIFICATION)
			-- Auto generated Objective-C wrapper.
		require
			has_outline_view_item_will_expand_: has_outline_view_item_will_expand_
		local
			a_notification__item: POINTER
		do
			if attached a_notification as a_notification_attached then
			...
			objc_outline_view_item_will_expand_ (item, a_notification__item)
		end

	outline_view_item_did_expand_ (a_notification: detachable NS_NOTIFICATION)
			-- Auto generated Objective-C wrapper.
		require
			has_outline_view_item_did_expand_: has_outline_view_item_did_expand_
		local
			a_notification__item: POINTER
		do
			if attached a_notification as a_notification_attached then
			...
			objc_outline_view_item_did_expand_ (item, a_notification__item)
		end

	outline_view_item_will_collapse_ (a_notification: detachable NS_NOTIFICATION)
			-- Auto generated Objective-C wrapper.
		require
			has_outline_view_item_will_collapse_: has_outline_view_item_will_collapse_
		local
			a_notification__item: POINTER
		do
			if attached a_notification as a_notification_attached then
			...
			objc_outline_view_item_will_collapse_ (item, a_notification__item)
		end

	outline_view_item_did_collapse_ (a_notification: detachable NS_NOTIFICATION)
			-- Auto generated Objective-C wrapper.
		require
			has_outline_view_item_did_collapse_: has_outline_view_item_did_collapse_
		local
			a_notification__item: POINTER
		do
			if attached a_notification as a_notification_attached then
			...
			objc_outline_view_item_did_collapse_ (item, a_notification__item)
		end

feature -- Status Report

	has_outline_view__view_for_table_column__item_: BOOLEAN
			-- Auto generated Objective-C wrapper.
		do
			Result := objc_has_outline_view__view_for_table_column__item_ (item)
		end

	has_outline_view__row_view_for_item_: BOOLEAN
			-- Auto generated Objective-C wrapper.
		do
			Result := objc_has_outline_view__row_view_for_item_ (item)
		end

	has_outline_view__did_add_row_view__for_row_: BOOLEAN
			-- Auto generated Objective-C wrapper.
		do
			Result := objc_has_outline_view__did_add_row_view__for_row_ (item)
		end

	has_outline_view__did_remove_row_view__for_row_: BOOLEAN
			-- Auto generated Objective-C wrapper.
		do
			Result := objc_has_outline_view__did_remove_row_view__for_row_ (item)
		end
...
--		end
	...
	has_outline_view_selection_did_change_: BOOLEAN
			-- Auto generated Objective-C wrapper.
		do
			Result := objc_has_outline_view_selection_did_change_ (item)
		end

	has_outline_view_column_did_move_: BOOLEAN
			-- Auto generated Objective-C wrapper.
		do
			Result := objc_has_outline_view_column_did_move_ (item)
		end

	has_outline_view_column_did_resize_: BOOLEAN
			-- Auto generated Objective-C wrapper.
		do
			Result := objc_has_outline_view_column_did_resize_ (item)
		end

	has_outline_view_selection_is_changing_: BOOLEAN
			-- Auto generated Objective-C wrapper.
		do
			Result := objc_has_outline_view_selection_is_changing_ (item)
		end

	has_outline_view_item_will_expand_: BOOLEAN
			-- Auto generated Objective-C wrapper.
		do
			Result := objc_has_outline_view_item_will_expand_ (item)
		end

	has_outline_view_item_did_expand_: BOOLEAN
			-- Auto generated Objective-C wrapper.
		do
			Result := objc_has_outline_view_item_did_expand_ (item)
		end

	has_outline_view_item_will_collapse_: BOOLEAN
			-- Auto generated Objective-C wrapper.
		do
			Result := objc_has_outline_view_item_will_collapse_ (item)
		end

	has_outline_view_item_did_collapse_: BOOLEAN
			-- Auto generated Objective-C wrapper.
		do
			Result := objc_has_outline_view_item_did_collapse_ (item)
		end

feature -- Status Report Externals

	objc_has_outline_view__view_for_table_column__item_ (an_item: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(id)$an_item respondsToSelector:@selector(outlineView:viewForTableColumn:item:)];
			 ]"
		end

	objc_has_outline_view__row_view_for_item_ (an_item: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(id)$an_item respondsToSelector:@selector(outlineView:rowViewForItem:)];
			 ]"
		end

	objc_has_outline_view__did_add_row_view__for_row_ (an_item: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(id)$an_item respondsToSelector:@selector(outlineView:didAddRowView:forRow:)];
			 ]"
		end

	objc_has_outline_view__did_remove_row_view__for_row_ (an_item: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(id)$an_item respondsToSelector:@selector(outlineView:didRemoveRowView:forRow:)];
			 ]"
		end
...
--		end
	...
	objc_has_outline_view_selection_did_change_ (an_item: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(id)$an_item respondsToSelector:@selector(outlineViewSelectionDidChange:)];
			 ]"
		end

	objc_has_outline_view_column_did_move_ (an_item: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(id)$an_item respondsToSelector:@selector(outlineViewColumnDidMove:)];
			 ]"
		end

	objc_has_outline_view_column_did_resize_ (an_item: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(id)$an_item respondsToSelector:@selector(outlineViewColumnDidResize:)];
			 ]"
		end

	objc_has_outline_view_selection_is_changing_ (an_item: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(id)$an_item respondsToSelector:@selector(outlineViewSelectionIsChanging:)];
			 ]"
		end

	objc_has_outline_view_item_will_expand_ (an_item: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(id)$an_item respondsToSelector:@selector(outlineViewItemWillExpand:)];
			 ]"
		end

	objc_has_outline_view_item_did_expand_ (an_item: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(id)$an_item respondsToSelector:@selector(outlineViewItemDidExpand:)];
			 ]"
		end

	objc_has_outline_view_item_will_collapse_ (an_item: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(id)$an_item respondsToSelector:@selector(outlineViewItemWillCollapse:)];
			 ]"
		end

	objc_has_outline_view_item_did_collapse_ (an_item: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(id)$an_item respondsToSelector:@selector(outlineViewItemDidCollapse:)];
			 ]"
		end

feature {NONE} -- Optional Methods Externals

	objc_outline_view__view_for_table_column__item_ (an_item: POINTER; a_outline_view: POINTER; a_table_column: POINTER; a_item: POINTER): POINTER
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return (EIF_POINTER)[(id <NSOutlineViewDelegate>)$an_item outlineView:$a_outline_view viewForTableColumn:$a_table_column item:$a_item];
			 ]"
		end

	objc_outline_view__row_view_for_item_ (an_item: POINTER; a_outline_view: POINTER; a_item: POINTER): POINTER
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return (EIF_POINTER)[(id <NSOutlineViewDelegate>)$an_item outlineView:$a_outline_view rowViewForItem:$a_item];
			 ]"
		end

	objc_outline_view__did_add_row_view__for_row_ (an_item: POINTER; a_outline_view: POINTER; a_row_view: POINTER; a_row: INTEGER_64)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(id <NSOutlineViewDelegate>)$an_item outlineView:$a_outline_view didAddRowView:$a_row_view forRow:$a_row];
			 ]"
		end

	objc_outline_view__did_remove_row_view__for_row_ (an_item: POINTER; a_outline_view: POINTER; a_row_view: POINTER; a_row: INTEGER_64)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(id <NSOutlineViewDelegate>)$an_item outlineView:$a_outline_view didRemoveRowView:$a_row_view forRow:$a_row];
			 ]"
		end
...
--		end
	...
	objc_outline_view_selection_did_change_ (an_item: POINTER; a_notification: POINTER)
		...
		alias
			"[
				[(id <NSOutlineViewDelegate>)$an_item outlineViewSelectionDidChange:$a_notification];
			 ]"
		end
	...
	objc_outline_view_column_did_move_ (an_item: POINTER; a_notification: POINTER)
		...
		alias
			"[
				[(id <NSOutlineViewDelegate>)$an_item outlineViewColumnDidMove:$a_notification];
			 ]"
		end
	...
	objc_outline_view_column_did_resize_ (an_item: POINTER; a_notification: POINTER)
		...
		alias
			"[
				[(id <NSOutlineViewDelegate>)$an_item outlineViewColumnDidResize:$a_notification];
			 ]"
		end
	...
	objc_outline_view_selection_is_changing_ (an_item: POINTER; a_notification: POINTER)
		...
		alias
			"[
				[(id <NSOutlineViewDelegate>)$an_item outlineViewSelectionIsChanging:$a_notification];
			 ]"
		end
	...
	objc_outline_view_item_will_expand_ (an_item: POINTER; a_notification: POINTER)
		...
		alias
			"[
				[(id <NSOutlineViewDelegate>)$an_item outlineViewItemWillExpand:$a_notification];
			 ]"
		end
	...
	objc_outline_view_item_did_expand_ (an_item: POINTER; a_notification: POINTER)
		...
		alias
			"[
				[(id <NSOutlineViewDelegate>)$an_item outlineViewItemDidExpand:$a_notification];
			 ]"
		end
	...
	objc_outline_view_item_will_collapse_ (an_item: POINTER; a_notification: POINTER)
		...
		alias
			"[
				[(id <NSOutlineViewDelegate>)$an_item outlineViewItemWillCollapse:$a_notification];
			 ]"
		end
	...
	objc_outline_view_item_did_collapse_ (an_item: POINTER; a_notification: POINTER)
		...
		alias
			"[
				[(id <NSOutlineViewDelegate>)$an_item outlineViewItemDidCollapse:$a_notification];
			 ]"
		end
