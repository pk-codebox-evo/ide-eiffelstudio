...
feature -- NSScroller
	...
	knob_style: INTEGER_64
			-- Auto generated Objective-C wrapper.
		local
		do
			Result := objc_knob_style (item)
		end

	set_knob_style_ (a_new_knob_style: INTEGER_64)
			-- Auto generated Objective-C wrapper.
		local
		do
			objc_set_knob_style_ (item, a_new_knob_style)
		end
...
feature {NONE} -- NSScroller Externals
	...
	objc_scroller_style (an_item: POINTER): INTEGER_64
		...
		alias
			"[
				return [(NSScroller *)$an_item scrollerStyle];
			 ]"
		end
	...
	objc_set_scroller_style_ (an_item: POINTER; a_new_scroller_style: INTEGER_64)
		...
		alias
			"[
				[(NSScroller *)$an_item setScrollerStyle:$a_new_scroller_style];
			 ]"
		end

	objc_knob_style (an_item: POINTER): INTEGER_64
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(NSScroller *)$an_item knobStyle];
			 ]"
		end

	objc_set_knob_style_ (an_item: POINTER; a_new_knob_style: INTEGER_64)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(NSScroller *)$an_item setKnobStyle:$a_new_knob_style];
			 ]"
		end
