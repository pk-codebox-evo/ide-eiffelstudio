...
feature -- NSDocumentController
	...
	document_for_ur_l_ (a_url: detachable NS_URL): detachable NS_OBJECT
			-- Auto generated Objective-C wrapper.
		local
			result_pointer: POINTER
			a_url__item: POINTER
		do
			...
			result_pointer := objc_document_for_ur_l_ (item, a_url__item)
			if result_pointer /= default_pointer then
				if attached objc_get_eiffel_object (result_pointer) as existing_eiffel_object then
...
--	open_document_with_contents_of_ur_l__display__completion_handler_ (a_url: detachable NS_URL; a_display_document: BOOLEAN; a_completion_handler: UNSUPPORTED_TYPE)
--			-- Auto generated Objective-C wrapper.
--		local
--			a_url__item: POINTER
--		do
...
--				a_url__item := a_url_attached.item
--			end
--			objc_open_document_with_contents_of_ur_l__display__completion_handler_ (item, a_url__item, a_display_document, )
--		end

--	make_document_with_contents_of_ur_l__of_type__error_ (a_url: detachable NS_URL; a_type_name: detachable NS_STRING; a_out_error: UNSUPPORTED_TYPE): detachable NS_OBJECT
--			-- Auto generated Objective-C wrapper.
--		local
--			result_pointer: POINTER
--			a_url__item: POINTER
...
--				a_out_error__item := a_out_error_attached.item
--			end
--			result_pointer := objc_make_document_with_contents_of_ur_l__of_type__error_ (item, a_url__item, a_type_name__item, a_out_error__item)
--			if result_pointer /= default_pointer then
--				if attached objc_get_eiffel_object (result_pointer) as existing_eiffel_object then
...
--	reopen_document_for_ur_l__with_contents_of_ur_l__display__completion_handler_ (a_url_or_nil: detachable NS_URL; a_contents_url: detachable NS_URL; a_display_document: BOOLEAN; a_completion_handler: UNSUPPORTED_TYPE)
--			-- Auto generated Objective-C wrapper.
--		local
...
--			end
--			objc_reopen_document_for_ur_l__with_contents_of_ur_l__display__completion_handler_ (item, a_url_or_nil__item, a_contents_url__item, a_display_document, )
--		end

--	make_document_for_ur_l__with_contents_of_ur_l__of_type__error_ (a_url_or_nil: detachable NS_URL; a_contents_url: detachable NS_URL; a_type_name: detachable NS_STRING; a_out_error: UNSUPPORTED_TYPE): detachable NS_OBJECT
--			-- Auto generated Objective-C wrapper.
--		local
--			result_pointer: POINTER
--			a_url_or_nil__item: POINTER
...
--				a_out_error__item := a_out_error_attached.item
--			end
--			result_pointer := objc_make_document_for_ur_l__with_contents_of_ur_l__of_type__error_ (item, a_url_or_nil__item, a_contents_url__item, a_type_name__item, a_out_error__item)
--			if result_pointer /= default_pointer then
--				if attached objc_get_eiffel_object (result_pointer) as existing_eiffel_object then
...
--	duplicate_document_with_contents_of_ur_l__copying__display_name__error_ (a_url: detachable NS_URL; a_duplicate_by_copying: BOOLEAN; a_display_name_or_nil: detachable NS_STRING; a_out_error: UNSUPPORTED_TYPE): detachable NS_DOCUMENT
--			-- Auto generated Objective-C wrapper.
--		local
--			result_pointer: POINTER
--			a_url__item: POINTER
...
--				a_out_error__item := a_out_error_attached.item
--			end
--			result_pointer := objc_duplicate_document_with_contents_of_ur_l__copying__display_name__error_ (item, a_url__item, a_duplicate_by_copying, a_display_name_or_nil__item, a_out_error__item)
--			if result_pointer /= default_pointer then
--				if attached objc_get_eiffel_object (result_pointer) as existing_eiffel_object then
--					check attached {like duplicate_document_with_contents_of_ur_l__copying__display_name__error_} existing_eiffel_object as valid_result then
--						Result := valid_result
--					end
--				else
--					check attached {like duplicate_document_with_contents_of_ur_l__copying__display_name__error_} new_eiffel_object (result_pointer, False) as valid_result_pointer then
--						Result := valid_result_pointer
--					end
--				end
--			end
...
--		end
	...
	note_new_recent_document_ur_l_ (a_url: detachable NS_URL)
			-- Auto generated Objective-C wrapper.
		local
			a_url__item: POINTER
		do
			...
			objc_note_new_recent_document_ur_l_ (item, a_url__item)
		end
...
--	type_for_contents_of_ur_l__error_ (a_url: detachable NS_URL; a_out_error: UNSUPPORTED_TYPE): detachable NS_STRING
--			-- Auto generated Objective-C wrapper.
--		local
--			result_pointer: POINTER
--			a_url__item: POINTER
...
--				a_out_error__item := a_out_error_attached.item
--			end
--			result_pointer := objc_type_for_contents_of_ur_l__error_ (item, a_url__item, a_out_error__item)
--			if result_pointer /= default_pointer then
--				if attached objc_get_eiffel_object (result_pointer) as existing_eiffel_object then
...
feature {NONE} -- NSDocumentController Externals
	...
	objc_document_for_ur_l_ (an_item: POINTER; a_url: POINTER): POINTER
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return (EIF_POINTER)[(NSDocumentController *)$an_item documentForURL:$a_url];
			 ]"
		end
...
--	objc_open_document_with_contents_of_ur_l__display__completion_handler_ (an_item: POINTER; a_url: POINTER; a_display_document: BOOLEAN; a_completion_handler: UNSUPPORTED_TYPE)
--			-- Auto generated Objective-C wrapper.
--		external
--			"C inline use <AppKit/AppKit.h>"
--		alias
--			"[
--				[(NSDocumentController *)$an_item openDocumentWithContentsOfURL:$a_url display:$a_display_document completionHandler:];
--			 ]"
--		end

--	objc_make_document_with_contents_of_ur_l__of_type__error_ (an_item: POINTER; a_url: POINTER; a_type_name: POINTER; a_out_error: UNSUPPORTED_TYPE): POINTER
--			-- Auto generated Objective-C wrapper.
--		external
--			"C inline use <AppKit/AppKit.h>"
--		alias
--			"[
--				return (EIF_POINTER)[(NSDocumentController *)$an_item makeDocumentWithContentsOfURL:$a_url ofType:$a_type_name error:];
--			 ]"
--		end

--	objc_reopen_document_for_ur_l__with_contents_of_ur_l__display__completion_handler_ (an_item: POINTER; a_url_or_nil: POINTER; a_contents_url: POINTER; a_display_document: BOOLEAN; a_completion_handler: UNSUPPORTED_TYPE)
--			-- Auto generated Objective-C wrapper.
--		external
--			"C inline use <AppKit/AppKit.h>"
--		alias
--			"[
--				[(NSDocumentController *)$an_item reopenDocumentForURL:$a_url_or_nil withContentsOfURL:$a_contents_url display:$a_display_document completionHandler:];
--			 ]"
--		end

--	objc_make_document_for_ur_l__with_contents_of_ur_l__of_type__error_ (an_item: POINTER; a_url_or_nil: POINTER; a_contents_url: POINTER; a_type_name: POINTER; a_out_error: UNSUPPORTED_TYPE): POINTER
--			-- Auto generated Objective-C wrapper.
--		external
--			"C inline use <AppKit/AppKit.h>"
--		alias
--			"[
--				return (EIF_POINTER)[(NSDocumentController *)$an_item makeDocumentForURL:$a_url_or_nil withContentsOfURL:$a_contents_url ofType:$a_type_name error:];
--			 ]"
--		end
...
--	objc_duplicate_document_with_contents_of_ur_l__copying__display_name__error_ (an_item: POINTER; a_url: POINTER; a_duplicate_by_copying: BOOLEAN; a_display_name_or_nil: POINTER; a_out_error: UNSUPPORTED_TYPE): POINTER
--			-- Auto generated Objective-C wrapper.
--		external
--			"C inline use <AppKit/AppKit.h>"
--		alias
--			"[
--				return (EIF_POINTER)[(NSDocumentController *)$an_item duplicateDocumentWithContentsOfURL:$a_url copying:$a_duplicate_by_copying displayName:$a_display_name_or_nil error:];
--			 ]"
--		end
...
--		end
	...
	objc_note_new_recent_document_ur_l_ (an_item: POINTER; a_url: POINTER)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(NSDocumentController *)$an_item noteNewRecentDocumentURL:$a_url];
			 ]"
		end
...
--	objc_type_for_contents_of_ur_l__error_ (an_item: POINTER; a_url: POINTER; a_out_error: UNSUPPORTED_TYPE): POINTER
--			-- Auto generated Objective-C wrapper.
--		external
--			"C inline use <AppKit/AppKit.h>"
--		alias
--			"[
--				return (EIF_POINTER)[(NSDocumentController *)$an_item typeForContentsOfURL:$a_url error:];
--			 ]"
--		end
...
--	open_document_with_contents_of_ur_l__display__error_ (a_url: detachable NS_URL; a_display_document: BOOLEAN; a_out_error: UNSUPPORTED_TYPE): detachable NS_OBJECT
--			-- Auto generated Objective-C wrapper.
--		local
--			result_pointer: POINTER
--			a_url__item: POINTER
...
--				a_out_error__item := a_out_error_attached.item
--			end
--			result_pointer := objc_open_document_with_contents_of_ur_l__display__error_ (item, a_url__item, a_display_document, a_out_error__item)
--			if result_pointer /= default_pointer then
--				if attached objc_get_eiffel_object (result_pointer) as existing_eiffel_object then
...
--	reopen_document_for_ur_l__with_contents_of_ur_l__error_ (a_url: detachable NS_URL; a_contents_url: detachable NS_URL; a_out_error: UNSUPPORTED_TYPE): BOOLEAN
--			-- Auto generated Objective-C wrapper.
--		local
--			a_url__item: POINTER
--			a_contents_url__item: POINTER
...
--				a_out_error__item := a_out_error_attached.item
--			end
--			Result := objc_reopen_document_for_ur_l__with_contents_of_ur_l__error_ (item, a_url__item, a_contents_url__item, a_out_error__item)
--		end

feature {NONE} -- NSDeprecated Externals

--	objc_open_document_with_contents_of_ur_l__display__error_ (an_item: POINTER; a_url: POINTER; a_display_document: BOOLEAN; a_out_error: UNSUPPORTED_TYPE): POINTER
--			-- Auto generated Objective-C wrapper.
--		external
--			"C inline use <AppKit/AppKit.h>"
--		alias
--			"[
--				return (EIF_POINTER)[(NSDocumentController *)$an_item openDocumentWithContentsOfURL:$a_url display:$a_display_document error:];
--			 ]"
--		end

--	objc_reopen_document_for_ur_l__with_contents_of_ur_l__error_ (an_item: POINTER; a_url: POINTER; a_contents_url: POINTER; a_out_error: UNSUPPORTED_TYPE): BOOLEAN
--			-- Auto generated Objective-C wrapper.
--		external
--			"C inline use <AppKit/AppKit.h>"
--		alias
--			"[
--				return [(NSDocumentController *)$an_item reopenDocumentForURL:$a_url withContentsOfURL:$a_contents_url error:];
--			 ]"
--		end
