...
feature -- NSOutlineView
	...
	insert_items_at_indexes__in_parent__with_animation_ (a_indexes: detachable NS_INDEX_SET; a_parent: detachable NS_OBJECT; a_animation_options: NATURAL_64)
			-- Auto generated Objective-C wrapper.
		local
		...
		do
			...
			objc_insert_items_at_indexes__in_parent__with_animation_ (item, a_indexes__item, a_parent__item, a_animation_options)
		end

	remove_items_at_indexes__in_parent__with_animation_ (a_indexes: detachable NS_INDEX_SET; a_parent: detachable NS_OBJECT; a_animation_options: NATURAL_64)
			-- Auto generated Objective-C wrapper.
		local
			a_indexes__item: POINTER
			a_parent__item: POINTER
		do
			...
			objc_remove_items_at_indexes__in_parent__with_animation_ (item, a_indexes__item, a_parent__item, a_animation_options)
		end

	move_item_at_index__in_parent__to_index__in_parent_ (a_from_index: INTEGER_64; a_old_parent: detachable NS_OBJECT; a_to_index: INTEGER_64; a_new_parent: detachable NS_OBJECT)
			-- Auto generated Objective-C wrapper.
		local
			a_old_parent__item: POINTER
			a_new_parent__item: POINTER
		do
			if attached a_old_parent as a_old_parent_attached then
				a_old_parent__item := a_old_parent_attached.item
			end
			if attached a_new_parent as a_new_parent_attached then
				a_new_parent__item := a_new_parent_attached.item
			end
			objc_move_item_at_index__in_parent__to_index__in_parent_ (item, a_from_index, a_old_parent__item, a_to_index, a_new_parent__item)
		end
...
feature {NONE} -- NSOutlineView Externals
	...
	objc_insert_items_at_indexes__in_parent__with_animation_ (an_item: POINTER; a_indexes: POINTER; a_parent: POINTER; a_animation_options: NATURAL_64)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(NSOutlineView *)$an_item insertItemsAtIndexes:$a_indexes inParent:$a_parent withAnimation:$a_animation_options];
			 ]"
		end

	objc_remove_items_at_indexes__in_parent__with_animation_ (an_item: POINTER; a_indexes: POINTER; a_parent: POINTER; a_animation_options: NATURAL_64)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(NSOutlineView *)$an_item removeItemsAtIndexes:$a_indexes inParent:$a_parent withAnimation:$a_animation_options];
			 ]"
		end

	objc_move_item_at_index__in_parent__to_index__in_parent_ (an_item: POINTER; a_from_index: INTEGER_64; a_old_parent: POINTER; a_to_index: INTEGER_64; a_new_parent: POINTER)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(NSOutlineView *)$an_item moveItemAtIndex:$a_from_index inParent:$a_old_parent toIndex:$a_to_index inParent:$a_new_parent];
			 ]"
		end
