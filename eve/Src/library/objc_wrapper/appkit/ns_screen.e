...
--		end
	...
	objc_convert_rect_to_backing_ (an_item: POINTER; result_pointer: POINTER; a_rect: POINTER)
		...
		alias
			"[
				*(NSRect *)$result_pointer = [(NSScreen *)$an_item convertRectToBacking:*((NSRect *)$a_rect)];
			 ]"
		end
	...
	objc_convert_rect_from_backing_ (an_item: POINTER; result_pointer: POINTER; a_rect: POINTER)
		...
		alias
			"[
				*(NSRect *)$result_pointer = [(NSScreen *)$an_item convertRectFromBacking:*((NSRect *)$a_rect)];
			 ]"
		end
	...
	objc_backing_aligned_rect__options_ (an_item: POINTER; result_pointer: POINTER; a_rect: POINTER; a_options: NATURAL_64)
		...
		alias
			"[
				*(NSRect *)$result_pointer = [(NSScreen *)$an_item backingAlignedRect:*((NSRect *)$a_rect) options:$a_options];
			 ]"
		end
	...
	objc_backing_scale_factor (an_item: POINTER): REAL_64
		...
		alias
			"[
				return [(NSScreen *)$an_item backingScaleFactor];
			 ]"
		end
