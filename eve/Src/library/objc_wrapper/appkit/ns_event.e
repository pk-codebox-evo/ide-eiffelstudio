...
feature -- NSEvent
	...
	has_precise_scrolling_deltas: BOOLEAN
			-- Auto generated Objective-C wrapper.
		local
		do
			Result := objc_has_precise_scrolling_deltas (item)
		end

	scrolling_delta_x: REAL_64
			-- Auto generated Objective-C wrapper.
		local
		do
			Result := objc_scrolling_delta_x (item)
		end

	scrolling_delta_y: REAL_64
			-- Auto generated Objective-C wrapper.
		local
		do
			Result := objc_scrolling_delta_y (item)
		end

	momentum_phase: NATURAL_64
			-- Auto generated Objective-C wrapper.
		local
		do
			Result := objc_momentum_phase (item)
		end

	is_direction_inverted_from_device: BOOLEAN
			-- Auto generated Objective-C wrapper.
		local
		do
			Result := objc_is_direction_inverted_from_device (item)
		end
...
--	track_swipe_event_with_options__dampen_amount_threshold_min__max__using_handler_ (a_options: NATURAL_64; a_min_dampen_threshold: REAL_64; a_max_dampen_threshold: REAL_64; a_tracking_handler: UNSUPPORTED_TYPE)
--			-- Auto generated Objective-C wrapper.
--		local
--		do
--			objc_track_swipe_event_with_options__dampen_amount_threshold_min__max__using_handler_ (item, a_options, a_min_dampen_threshold, a_max_dampen_threshold, )
--		end
...
feature {NONE} -- NSEvent Externals
	...
	objc_has_precise_scrolling_deltas (an_item: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(NSEvent *)$an_item hasPreciseScrollingDeltas];
			 ]"
		end

	objc_scrolling_delta_x (an_item: POINTER): REAL_64
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(NSEvent *)$an_item scrollingDeltaX];
			 ]"
		end

	objc_scrolling_delta_y (an_item: POINTER): REAL_64
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(NSEvent *)$an_item scrollingDeltaY];
			 ]"
		end

	objc_momentum_phase (an_item: POINTER): NATURAL_64
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(NSEvent *)$an_item momentumPhase];
			 ]"
		end

	objc_is_direction_inverted_from_device (an_item: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(NSEvent *)$an_item isDirectionInvertedFromDevice];
			 ]"
		end
...
--		end
	...
	objc_phase (an_item: POINTER): NATURAL_64
		...
		alias
			"[
				return [(NSEvent *)$an_item phase];
			 ]"
		end

--	objc_track_swipe_event_with_options__dampen_amount_threshold_min__max__using_handler_ (an_item: POINTER; a_options: NATURAL_64; a_min_dampen_threshold: REAL_64; a_max_dampen_threshold: REAL_64; a_tracking_handler: UNSUPPORTED_TYPE)
--			-- Auto generated Objective-C wrapper.
--		external
--			"C inline use <AppKit/AppKit.h>"
--		alias
--			"[
--				[(NSEvent *)$an_item trackSwipeEventWithOptions:$a_options dampenAmountThresholdMin:$a_min_dampen_threshold max:$a_max_dampen_threshold usingHandler:];
--			 ]"
--		end
