...
--		end
	...
	objc_begin_sheet__modal_for_window__modal_delegate__did_end_selector__context_info_ (an_item: POINTER; a_sheet: POINTER; a_doc_window: POINTER; a_modal_delegate: POINTER; a_did_end_selector: POINTER) --; a_context_info: UNSUPPORTED_TYPE)
		...
		alias
			"[
				[(NSApplication *)$an_item beginSheet:$a_sheet modalForWindow:$a_doc_window modalDelegate:$a_modal_delegate didEndSelector:$a_did_end_selector contextInfo:nil];
			 ]"
		end
	...
	objc_send_action__to__from_ (an_item: POINTER; a_the_action: POINTER; a_the_target: POINTER; a_sender: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>, <objc/runtime.h>"
		alias
			"[
...
feature -- NSRestorableUserInterface

	disable_relaunch_on_login
			-- Auto generated Objective-C wrapper.
		local
		do
			objc_disable_relaunch_on_login (item)
		end

	enable_relaunch_on_login
			-- Auto generated Objective-C wrapper.
		local
		do
			objc_enable_relaunch_on_login (item)
		end

feature {NONE} -- NSRestorableUserInterface Externals

	objc_disable_relaunch_on_login (an_item: POINTER)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(NSApplication *)$an_item disableRelaunchOnLogin];
			 ]"
		end

	objc_enable_relaunch_on_login (an_item: POINTER)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(NSApplication *)$an_item enableRelaunchOnLogin];
			 ]"
		end

feature -- NSRemoteNotifications

	register_for_remote_notification_types_ (a_types: NATURAL_64)
			-- Auto generated Objective-C wrapper.
		local
		do
			objc_register_for_remote_notification_types_ (item, a_types)
		end
	...
	unregister_for_remote_notifications
		...
		local
		do
			objc_unregister_for_remote_notifications (item)
		end

	enabled_remote_notification_types: NATURAL_64
			-- Auto generated Objective-C wrapper.
		local
		do
			Result := objc_enabled_remote_notification_types (item)
		end

feature {NONE} -- NSRemoteNotifications Externals

	objc_register_for_remote_notification_types_ (an_item: POINTER; a_types: NATURAL_64)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(NSApplication *)$an_item registerForRemoteNotificationTypes:$a_types];
			 ]"
		end

	objc_unregister_for_remote_notifications (an_item: POINTER)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(NSApplication *)$an_item unregisterForRemoteNotifications];
			 ]"
		end

	objc_enabled_remote_notification_types (an_item: POINTER): NATURAL_64
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(NSApplication *)$an_item enabledRemoteNotificationTypes];
			 ]"
		end
...
--	restore_window_with_identifier__state__completion_handler_ (a_identifier: detachable NS_STRING; a_state: detachable NS_CODER; a_completion_handler: UNSUPPORTED_TYPE): BOOLEAN
--			-- Auto generated Objective-C wrapper.
--		local
...
--			end
--			Result := objc_restore_window_with_identifier__state__completion_handler_ (item, a_identifier__item, a_state__item, )
--		end

feature {NONE} -- NSWindowRestoration Externals

--	objc_restore_window_with_identifier__state__completion_handler_ (an_item: POINTER; a_identifier: POINTER; a_state: POINTER; a_completion_handler: UNSUPPORTED_TYPE): BOOLEAN
--			-- Auto generated Objective-C wrapper.
--		external
--			"C inline use <AppKit/AppKit.h>"
--		alias
--			"[
--				return [(NSApplication *)$an_item restoreWindowWithIdentifier:$a_identifier state:$a_state completionHandler:];
--			 ]"
--		end

feature -- NSRestorableStateExtension

	extend_state_restoration
			-- Auto generated Objective-C wrapper.
		local
		do
			objc_extend_state_restoration (item)
		end

	complete_state_restoration
			-- Auto generated Objective-C wrapper.
		local
		do
			objc_complete_state_restoration (item)
		end

feature {NONE} -- NSRestorableStateExtension Externals

	objc_extend_state_restoration (an_item: POINTER)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(NSApplication *)$an_item extendStateRestoration];
			 ]"
		end

	objc_complete_state_restoration (an_item: POINTER)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(NSApplication *)$an_item completeStateRestoration];
			 ]"
		end
