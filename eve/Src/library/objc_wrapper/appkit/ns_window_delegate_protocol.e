...
feature -- Optional Methods
	...
	window__will_use_full_screen_content_size_ (a_window: detachable NS_WINDOW; a_proposed_size: NS_SIZE): NS_SIZE
			-- Auto generated Objective-C wrapper.
		require
			has_window__will_use_full_screen_content_size_: has_window__will_use_full_screen_content_size_
		local
			a_window__item: POINTER
		do
			if attached a_window as a_window_attached then
			...
			create Result.make
			objc_window__will_use_full_screen_content_size_ (item, Result.item, a_window__item, a_proposed_size.item)
		end

	window__will_use_full_screen_presentation_options_ (a_window: detachable NS_WINDOW; a_proposed_options: NATURAL_64): NATURAL_64
			-- Auto generated Objective-C wrapper.
		require
			has_window__will_use_full_screen_presentation_options_: has_window__will_use_full_screen_presentation_options_
		local
			a_window__item: POINTER
		do
			if attached a_window as a_window_attached then
			...
			Result := objc_window__will_use_full_screen_presentation_options_ (item, a_window__item, a_proposed_options)
		end

	custom_windows_to_enter_full_screen_for_window_ (a_window: detachable NS_WINDOW): detachable NS_ARRAY
			-- Auto generated Objective-C wrapper.
		require
			has_custom_windows_to_enter_full_screen_for_window_: has_custom_windows_to_enter_full_screen_for_window_
		local
			result_pointer: POINTER
			a_window__item: POINTER
		do
			...
			result_pointer := objc_custom_windows_to_enter_full_screen_for_window_ (item, a_window__item)
			if result_pointer /= default_pointer then
				if attached objc_get_eiffel_object (result_pointer) as existing_eiffel_object then
					check attached {like custom_windows_to_enter_full_screen_for_window_} existing_eiffel_object as valid_result then
						Result := valid_result
					end
				else
					check attached {like custom_windows_to_enter_full_screen_for_window_} new_eiffel_object (result_pointer, True) as valid_result_pointer then
						Result := valid_result_pointer
					end
				end
			end
	...
	window__start_custom_animation_to_enter_full_screen_with_duration_ (a_window: detachable NS_WINDOW; a_duration: REAL_64)
			-- Auto generated Objective-C wrapper.
		require
			has_window__start_custom_animation_to_enter_full_screen_with_duration_: has_window__start_custom_animation_to_enter_full_screen_with_duration_
		local
			a_window__item: POINTER
		do
			if attached a_window as a_window_attached then
			...
			objc_window__start_custom_animation_to_enter_full_screen_with_duration_ (item, a_window__item, a_duration)
		end

	window_did_fail_to_enter_full_screen_ (a_window: detachable NS_WINDOW)
			-- Auto generated Objective-C wrapper.
		require
			has_window_did_fail_to_enter_full_screen_: has_window_did_fail_to_enter_full_screen_
		local
			a_window__item: POINTER
		do
			if attached a_window as a_window_attached then
			...
			objc_window_did_fail_to_enter_full_screen_ (item, a_window__item)
		end

	custom_windows_to_exit_full_screen_for_window_ (a_window: detachable NS_WINDOW): detachable NS_ARRAY
			-- Auto generated Objective-C wrapper.
		require
			has_custom_windows_to_exit_full_screen_for_window_: has_custom_windows_to_exit_full_screen_for_window_
		local
			result_pointer: POINTER
			a_window__item: POINTER
		do
			...
			result_pointer := objc_custom_windows_to_exit_full_screen_for_window_ (item, a_window__item)
			if result_pointer /= default_pointer then
				if attached objc_get_eiffel_object (result_pointer) as existing_eiffel_object then
					check attached {like custom_windows_to_exit_full_screen_for_window_} existing_eiffel_object as valid_result then
						Result := valid_result
					end
				else
					check attached {like custom_windows_to_exit_full_screen_for_window_} new_eiffel_object (result_pointer, True) as valid_result_pointer then
						Result := valid_result_pointer
					end
				end
			end
	...
	window__start_custom_animation_to_exit_full_screen_with_duration_ (a_window: detachable NS_WINDOW; a_duration: REAL_64)
			-- Auto generated Objective-C wrapper.
		require
			has_window__start_custom_animation_to_exit_full_screen_with_duration_: has_window__start_custom_animation_to_exit_full_screen_with_duration_
		local
			a_window__item: POINTER
		do
			if attached a_window as a_window_attached then
			...
			objc_window__start_custom_animation_to_exit_full_screen_with_duration_ (item, a_window__item, a_duration)
		end

	window_did_fail_to_exit_full_screen_ (a_window: detachable NS_WINDOW)
			-- Auto generated Objective-C wrapper.
		require
			has_window_did_fail_to_exit_full_screen_: has_window_did_fail_to_exit_full_screen_
		local
			a_window__item: POINTER
		do
			if attached a_window as a_window_attached then
			...
			objc_window_did_fail_to_exit_full_screen_ (item, a_window__item)
		end

	window__will_resize_for_version_browser_with_max_preferred_size__max_allowed_size_ (a_window: detachable NS_WINDOW; a_max_preferred_frame_size: NS_SIZE; a_max_allowed_frame_size: NS_SIZE): NS_SIZE
			-- Auto generated Objective-C wrapper.
		require
			has_window__will_resize_for_version_browser_with_max_preferred_size__max_allowed_size_: has_window__will_resize_for_version_browser_with_max_preferred_size__max_allowed_size_
		local
			a_window__item: POINTER
		do
			if attached a_window as a_window_attached then
			...
			create Result.make
			objc_window__will_resize_for_version_browser_with_max_preferred_size__max_allowed_size_ (item, Result.item, a_window__item, a_max_preferred_frame_size.item, a_max_allowed_frame_size.item)
		end

	window__will_encode_restorable_state_ (a_window: detachable NS_WINDOW; a_state: detachable NS_CODER)
			-- Auto generated Objective-C wrapper.
		require
			has_window__will_encode_restorable_state_: has_window__will_encode_restorable_state_
		local
			a_window__item: POINTER
		...
		do
			...
			objc_window__will_encode_restorable_state_ (item, a_window__item, a_state__item)
		end

	window__did_decode_restorable_state_ (a_window: detachable NS_WINDOW; a_state: detachable NS_CODER)
			-- Auto generated Objective-C wrapper.
		require
			has_window__did_decode_restorable_state_: has_window__did_decode_restorable_state_
		local
			a_window__item: POINTER
			a_state__item: POINTER
		do
			...
			objc_window__did_decode_restorable_state_ (item, a_window__item, a_state__item)
		end
	...
	window_will_enter_full_screen_ (a_notification: detachable NS_NOTIFICATION)
			-- Auto generated Objective-C wrapper.
		require
			has_window_will_enter_full_screen_: has_window_will_enter_full_screen_
		local
			a_notification__item: POINTER
		do
			if attached a_notification as a_notification_attached then
			...
			objc_window_will_enter_full_screen_ (item, a_notification__item)
		end

	window_did_enter_full_screen_ (a_notification: detachable NS_NOTIFICATION)
			-- Auto generated Objective-C wrapper.
		require
			has_window_did_enter_full_screen_: has_window_did_enter_full_screen_
		local
			a_notification__item: POINTER
		do
			if attached a_notification as a_notification_attached then
			...
			objc_window_did_enter_full_screen_ (item, a_notification__item)
		end

	window_will_exit_full_screen_ (a_notification: detachable NS_NOTIFICATION)
			-- Auto generated Objective-C wrapper.
		require
			has_window_will_exit_full_screen_: has_window_will_exit_full_screen_
		local
			a_notification__item: POINTER
		do
			if attached a_notification as a_notification_attached then
			...
			objc_window_will_exit_full_screen_ (item, a_notification__item)
		end

	window_did_exit_full_screen_ (a_notification: detachable NS_NOTIFICATION)
			-- Auto generated Objective-C wrapper.
		require
			has_window_did_exit_full_screen_: has_window_did_exit_full_screen_
		local
			a_notification__item: POINTER
		do
			if attached a_notification as a_notification_attached then
			...
			objc_window_did_exit_full_screen_ (item, a_notification__item)
		end

	window_will_enter_version_browser_ (a_notification: detachable NS_NOTIFICATION)
			-- Auto generated Objective-C wrapper.
		require
			has_window_will_enter_version_browser_: has_window_will_enter_version_browser_
		local
			a_notification__item: POINTER
		do
			if attached a_notification as a_notification_attached then
			...
			objc_window_will_enter_version_browser_ (item, a_notification__item)
		end

	window_did_enter_version_browser_ (a_notification: detachable NS_NOTIFICATION)
			-- Auto generated Objective-C wrapper.
		require
			has_window_did_enter_version_browser_: has_window_did_enter_version_browser_
		local
			a_notification__item: POINTER
		do
			if attached a_notification as a_notification_attached then
			...
			objc_window_did_enter_version_browser_ (item, a_notification__item)
		end

	window_will_exit_version_browser_ (a_notification: detachable NS_NOTIFICATION)
			-- Auto generated Objective-C wrapper.
		require
			has_window_will_exit_version_browser_: has_window_will_exit_version_browser_
		local
			a_notification__item: POINTER
		do
			if attached a_notification as a_notification_attached then
			...
			objc_window_will_exit_version_browser_ (item, a_notification__item)
		end

	window_did_exit_version_browser_ (a_notification: detachable NS_NOTIFICATION)
			-- Auto generated Objective-C wrapper.
		require
			has_window_did_exit_version_browser_: has_window_did_exit_version_browser_
		local
			a_notification__item: POINTER
		do
			if attached a_notification as a_notification_attached then
			...
			objc_window_did_exit_version_browser_ (item, a_notification__item)
		end
...
feature -- Status Report
	...
	has_window__will_use_full_screen_content_size_: BOOLEAN
			-- Auto generated Objective-C wrapper.
		do
			Result := objc_has_window__will_use_full_screen_content_size_ (item)
		end

	has_window__will_use_full_screen_presentation_options_: BOOLEAN
			-- Auto generated Objective-C wrapper.
		do
			Result := objc_has_window__will_use_full_screen_presentation_options_ (item)
		end

	has_custom_windows_to_enter_full_screen_for_window_: BOOLEAN
			-- Auto generated Objective-C wrapper.
		do
			Result := objc_has_custom_windows_to_enter_full_screen_for_window_ (item)
		end

	has_window__start_custom_animation_to_enter_full_screen_with_duration_: BOOLEAN
			-- Auto generated Objective-C wrapper.
		do
			Result := objc_has_window__start_custom_animation_to_enter_full_screen_with_duration_ (item)
		end

	has_window_did_fail_to_enter_full_screen_: BOOLEAN
			-- Auto generated Objective-C wrapper.
		do
			Result := objc_has_window_did_fail_to_enter_full_screen_ (item)
		end

	has_custom_windows_to_exit_full_screen_for_window_: BOOLEAN
			-- Auto generated Objective-C wrapper.
		do
			Result := objc_has_custom_windows_to_exit_full_screen_for_window_ (item)
		end

	has_window__start_custom_animation_to_exit_full_screen_with_duration_: BOOLEAN
			-- Auto generated Objective-C wrapper.
		do
			Result := objc_has_window__start_custom_animation_to_exit_full_screen_with_duration_ (item)
		end

	has_window_did_fail_to_exit_full_screen_: BOOLEAN
			-- Auto generated Objective-C wrapper.
		do
			Result := objc_has_window_did_fail_to_exit_full_screen_ (item)
		end

	has_window__will_resize_for_version_browser_with_max_preferred_size__max_allowed_size_: BOOLEAN
			-- Auto generated Objective-C wrapper.
		do
			Result := objc_has_window__will_resize_for_version_browser_with_max_preferred_size__max_allowed_size_ (item)
		end

	has_window__will_encode_restorable_state_: BOOLEAN
			-- Auto generated Objective-C wrapper.
		do
			Result := objc_has_window__will_encode_restorable_state_ (item)
		end

	has_window__did_decode_restorable_state_: BOOLEAN
			-- Auto generated Objective-C wrapper.
		do
			Result := objc_has_window__did_decode_restorable_state_ (item)
		end
	...
	has_window_will_enter_full_screen_: BOOLEAN
			-- Auto generated Objective-C wrapper.
		do
			Result := objc_has_window_will_enter_full_screen_ (item)
		end

	has_window_did_enter_full_screen_: BOOLEAN
			-- Auto generated Objective-C wrapper.
		do
			Result := objc_has_window_did_enter_full_screen_ (item)
		end

	has_window_will_exit_full_screen_: BOOLEAN
			-- Auto generated Objective-C wrapper.
		do
			Result := objc_has_window_will_exit_full_screen_ (item)
		end

	has_window_did_exit_full_screen_: BOOLEAN
			-- Auto generated Objective-C wrapper.
		do
			Result := objc_has_window_did_exit_full_screen_ (item)
		end

	has_window_will_enter_version_browser_: BOOLEAN
			-- Auto generated Objective-C wrapper.
		do
			Result := objc_has_window_will_enter_version_browser_ (item)
		end

	has_window_did_enter_version_browser_: BOOLEAN
			-- Auto generated Objective-C wrapper.
		do
			Result := objc_has_window_did_enter_version_browser_ (item)
		end

	has_window_will_exit_version_browser_: BOOLEAN
			-- Auto generated Objective-C wrapper.
		do
			Result := objc_has_window_will_exit_version_browser_ (item)
		end

	has_window_did_exit_version_browser_: BOOLEAN
			-- Auto generated Objective-C wrapper.
		do
			Result := objc_has_window_did_exit_version_browser_ (item)
		end
...
feature -- Status Report Externals
	...
	objc_has_window__will_use_full_screen_content_size_ (an_item: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(id)$an_item respondsToSelector:@selector(window:willUseFullScreenContentSize:)];
			 ]"
		end

	objc_has_window__will_use_full_screen_presentation_options_ (an_item: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(id)$an_item respondsToSelector:@selector(window:willUseFullScreenPresentationOptions:)];
			 ]"
		end

	objc_has_custom_windows_to_enter_full_screen_for_window_ (an_item: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(id)$an_item respondsToSelector:@selector(customWindowsToEnterFullScreenForWindow:)];
			 ]"
		end

	objc_has_window__start_custom_animation_to_enter_full_screen_with_duration_ (an_item: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(id)$an_item respondsToSelector:@selector(window:startCustomAnimationToEnterFullScreenWithDuration:)];
			 ]"
		end

	objc_has_window_did_fail_to_enter_full_screen_ (an_item: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(id)$an_item respondsToSelector:@selector(windowDidFailToEnterFullScreen:)];
			 ]"
		end

	objc_has_custom_windows_to_exit_full_screen_for_window_ (an_item: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(id)$an_item respondsToSelector:@selector(customWindowsToExitFullScreenForWindow:)];
			 ]"
		end

	objc_has_window__start_custom_animation_to_exit_full_screen_with_duration_ (an_item: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(id)$an_item respondsToSelector:@selector(window:startCustomAnimationToExitFullScreenWithDuration:)];
			 ]"
		end

	objc_has_window_did_fail_to_exit_full_screen_ (an_item: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(id)$an_item respondsToSelector:@selector(windowDidFailToExitFullScreen:)];
			 ]"
		end

	objc_has_window__will_resize_for_version_browser_with_max_preferred_size__max_allowed_size_ (an_item: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(id)$an_item respondsToSelector:@selector(window:willResizeForVersionBrowserWithMaxPreferredSize:maxAllowedSize:)];
			 ]"
		end

	objc_has_window__will_encode_restorable_state_ (an_item: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(id)$an_item respondsToSelector:@selector(window:willEncodeRestorableState:)];
			 ]"
		end

	objc_has_window__did_decode_restorable_state_ (an_item: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(id)$an_item respondsToSelector:@selector(window:didDecodeRestorableState:)];
			 ]"
		end
	...
	objc_has_window_will_enter_full_screen_ (an_item: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(id)$an_item respondsToSelector:@selector(windowWillEnterFullScreen:)];
			 ]"
		end

	objc_has_window_did_enter_full_screen_ (an_item: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(id)$an_item respondsToSelector:@selector(windowDidEnterFullScreen:)];
			 ]"
		end

	objc_has_window_will_exit_full_screen_ (an_item: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(id)$an_item respondsToSelector:@selector(windowWillExitFullScreen:)];
			 ]"
		end

	objc_has_window_did_exit_full_screen_ (an_item: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(id)$an_item respondsToSelector:@selector(windowDidExitFullScreen:)];
			 ]"
		end

	objc_has_window_will_enter_version_browser_ (an_item: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(id)$an_item respondsToSelector:@selector(windowWillEnterVersionBrowser:)];
			 ]"
		end

	objc_has_window_did_enter_version_browser_ (an_item: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(id)$an_item respondsToSelector:@selector(windowDidEnterVersionBrowser:)];
			 ]"
		end

	objc_has_window_will_exit_version_browser_ (an_item: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(id)$an_item respondsToSelector:@selector(windowWillExitVersionBrowser:)];
			 ]"
		end

	objc_has_window_did_exit_version_browser_ (an_item: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(id)$an_item respondsToSelector:@selector(windowDidExitVersionBrowser:)];
			 ]"
		end
...
feature {NONE} -- Optional Methods Externals
	...
	objc_window__will_use_full_screen_content_size_ (an_item: POINTER; result_pointer: POINTER; a_window: POINTER; a_proposed_size: POINTER)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				*(NSSize *)$result_pointer = [(id <NSWindowDelegate>)$an_item window:$a_window willUseFullScreenContentSize:*((NSSize *)$a_proposed_size)];
			 ]"
		end

	objc_window__will_use_full_screen_presentation_options_ (an_item: POINTER; a_window: POINTER; a_proposed_options: NATURAL_64): NATURAL_64
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(id <NSWindowDelegate>)$an_item window:$a_window willUseFullScreenPresentationOptions:$a_proposed_options];
			 ]"
		end

	objc_custom_windows_to_enter_full_screen_for_window_ (an_item: POINTER; a_window: POINTER): POINTER
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return (EIF_POINTER)[(id <NSWindowDelegate>)$an_item customWindowsToEnterFullScreenForWindow:$a_window];
			 ]"
		end

	objc_window__start_custom_animation_to_enter_full_screen_with_duration_ (an_item: POINTER; a_window: POINTER; a_duration: REAL_64)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(id <NSWindowDelegate>)$an_item window:$a_window startCustomAnimationToEnterFullScreenWithDuration:$a_duration];
			 ]"
		end

	objc_window_did_fail_to_enter_full_screen_ (an_item: POINTER; a_window: POINTER)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(id <NSWindowDelegate>)$an_item windowDidFailToEnterFullScreen:$a_window];
			 ]"
		end

	objc_custom_windows_to_exit_full_screen_for_window_ (an_item: POINTER; a_window: POINTER): POINTER
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return (EIF_POINTER)[(id <NSWindowDelegate>)$an_item customWindowsToExitFullScreenForWindow:$a_window];
			 ]"
		end

	objc_window__start_custom_animation_to_exit_full_screen_with_duration_ (an_item: POINTER; a_window: POINTER; a_duration: REAL_64)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(id <NSWindowDelegate>)$an_item window:$a_window startCustomAnimationToExitFullScreenWithDuration:$a_duration];
			 ]"
		end

	objc_window_did_fail_to_exit_full_screen_ (an_item: POINTER; a_window: POINTER)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(id <NSWindowDelegate>)$an_item windowDidFailToExitFullScreen:$a_window];
			 ]"
		end

	objc_window__will_resize_for_version_browser_with_max_preferred_size__max_allowed_size_ (an_item: POINTER; result_pointer: POINTER; a_window: POINTER; a_max_preferred_frame_size: POINTER; a_max_allowed_frame_size: POINTER)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				*(NSSize *)$result_pointer = [(id <NSWindowDelegate>)$an_item window:$a_window willResizeForVersionBrowserWithMaxPreferredSize:*((NSSize *)$a_max_preferred_frame_size) maxAllowedSize:*((NSSize *)$a_max_allowed_frame_size)];
			 ]"
		end

	objc_window__will_encode_restorable_state_ (an_item: POINTER; a_window: POINTER; a_state: POINTER)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(id <NSWindowDelegate>)$an_item window:$a_window willEncodeRestorableState:$a_state];
			 ]"
		end

	objc_window__did_decode_restorable_state_ (an_item: POINTER; a_window: POINTER; a_state: POINTER)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(id <NSWindowDelegate>)$an_item window:$a_window didDecodeRestorableState:$a_state];
			 ]"
		end
	...
	objc_window_will_enter_full_screen_ (an_item: POINTER; a_notification: POINTER)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(id <NSWindowDelegate>)$an_item windowWillEnterFullScreen:$a_notification];
			 ]"
		end

	objc_window_did_enter_full_screen_ (an_item: POINTER; a_notification: POINTER)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(id <NSWindowDelegate>)$an_item windowDidEnterFullScreen:$a_notification];
			 ]"
		end

	objc_window_will_exit_full_screen_ (an_item: POINTER; a_notification: POINTER)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(id <NSWindowDelegate>)$an_item windowWillExitFullScreen:$a_notification];
			 ]"
		end

	objc_window_did_exit_full_screen_ (an_item: POINTER; a_notification: POINTER)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(id <NSWindowDelegate>)$an_item windowDidExitFullScreen:$a_notification];
			 ]"
		end

	objc_window_will_enter_version_browser_ (an_item: POINTER; a_notification: POINTER)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(id <NSWindowDelegate>)$an_item windowWillEnterVersionBrowser:$a_notification];
			 ]"
		end

	objc_window_did_enter_version_browser_ (an_item: POINTER; a_notification: POINTER)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(id <NSWindowDelegate>)$an_item windowDidEnterVersionBrowser:$a_notification];
			 ]"
		end

	objc_window_will_exit_version_browser_ (an_item: POINTER; a_notification: POINTER)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(id <NSWindowDelegate>)$an_item windowWillExitVersionBrowser:$a_notification];
			 ]"
		end

	objc_window_did_exit_version_browser_ (an_item: POINTER; a_notification: POINTER)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(id <NSWindowDelegate>)$an_item windowDidExitVersionBrowser:$a_notification];
			 ]"
		end
