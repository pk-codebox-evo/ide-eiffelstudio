...
feature -- NSSpellChecker
	...
	is_automatic_text_replacement_enabled: BOOLEAN
		...
		do
			create l_objc_class.make_with_name (get_class_name)
			check l_objc_class_registered: l_objc_class.registered end
			Result := objc_is_automatic_text_replacement_enabled (l_objc_class.item)
		end
	...
	is_automatic_spelling_correction_enabled: BOOLEAN
		...
		do
			create l_objc_class.make_with_name (get_class_name)
			check l_objc_class_registered: l_objc_class.registered end
			Result := objc_is_automatic_spelling_correction_enabled (l_objc_class.item)
		end
...
feature {NONE} -- NSSpellChecker Externals
	...
	objc_is_automatic_text_replacement_enabled (a_class_object: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(Class)$a_class_object isAutomaticTextReplacementEnabled];
			 ]"
		end

	objc_is_automatic_spelling_correction_enabled (a_class_object: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(Class)$a_class_object isAutomaticSpellingCorrectionEnabled];
			 ]"
		end
