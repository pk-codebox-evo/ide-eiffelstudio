...
--		end
	...
	is_swipe_tracking_from_scroll_events_enabled: BOOLEAN
			-- Auto generated Objective-C wrapper.
		local
			l_objc_class: OBJC_CLASS
		do
			create l_objc_class.make_with_name (get_class_name)
			check l_objc_class_registered: l_objc_class.registered end
			Result := objc_is_swipe_tracking_from_scroll_events_enabled (l_objc_class.item)
		end
...
--		end
	...
	objc_is_swipe_tracking_from_scroll_events_enabled (a_class_object: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(Class)$a_class_object isSwipeTrackingFromScrollEventsEnabled];
			 ]"
		end
