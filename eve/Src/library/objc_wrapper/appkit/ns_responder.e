...
feature -- NSResponder
	...
	wants_scroll_events_for_swipe_tracking_on_axis_ (a_axis: INTEGER_64): BOOLEAN
			-- Auto generated Objective-C wrapper.
		local
		do
			Result := objc_wants_scroll_events_for_swipe_tracking_on_axis_ (item, a_axis)
		end

	wants_forwarded_scroll_events_for_axis_ (a_axis: INTEGER_64): BOOLEAN
			-- Auto generated Objective-C wrapper.
		local
		do
			Result := objc_wants_forwarded_scroll_events_for_axis_ (item, a_axis)
		end

	supplemental_target_for_action__sender_ (a_action: detachable OBJC_SELECTOR; a_sender: detachable NS_OBJECT): detachable NS_OBJECT
			-- Auto generated Objective-C wrapper.
		local
			result_pointer: POINTER
		...
		do
			...
			result_pointer := objc_supplemental_target_for_action__sender_ (item, a_action__item, a_sender__item)
			if result_pointer /= default_pointer then
				if attached objc_get_eiffel_object (result_pointer) as existing_eiffel_object then
					check attached {like supplemental_target_for_action__sender_} existing_eiffel_object as valid_result then
						Result := valid_result
					end
				else
					check attached {like supplemental_target_for_action__sender_} new_eiffel_object (result_pointer, True) as valid_result_pointer then
						Result := valid_result_pointer
					end
				end
			end
...
feature {NONE} -- NSResponder Externals
	...
	objc_wants_scroll_events_for_swipe_tracking_on_axis_ (an_item: POINTER; a_axis: INTEGER_64): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(NSResponder *)$an_item wantsScrollEventsForSwipeTrackingOnAxis:$a_axis];
			 ]"
		end

	objc_wants_forwarded_scroll_events_for_axis_ (an_item: POINTER; a_axis: INTEGER_64): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(NSResponder *)$an_item wantsForwardedScrollEventsForAxis:$a_axis];
			 ]"
		end

	objc_supplemental_target_for_action__sender_ (an_item: POINTER; a_action: POINTER; a_sender: POINTER): POINTER
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return (EIF_POINTER)[(NSResponder *)$an_item supplementalTargetForAction:$a_action sender:$a_sender];
			 ]"
		end
...
feature -- NSControlEditingSupport

	validate_proposed_first_responder__for_event_ (a_responder: detachable NS_RESPONDER; a_event: detachable NS_EVENT): BOOLEAN
			-- Auto generated Objective-C wrapper.
		local
			a_responder__item: POINTER
			a_event__item: POINTER
		do
			...
			Result := objc_validate_proposed_first_responder__for_event_ (item, a_responder__item, a_event__item)
		end

feature {NONE} -- NSControlEditingSupport Externals

	objc_validate_proposed_first_responder__for_event_ (an_item: POINTER; a_responder: POINTER; a_event: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(NSResponder *)$an_item validateProposedFirstResponder:$a_responder forEvent:$a_event];
			 ]"
		end
...
feature -- NSTextFinderSupport

	perform_text_finder_action_ (a_sender: detachable NS_OBJECT)
			-- Auto generated Objective-C wrapper.
		local
			a_sender__item: POINTER
		do
			...
			objc_perform_text_finder_action_ (item, a_sender__item)
		end

feature {NONE} -- NSTextFinderSupport Externals

	objc_perform_text_finder_action_ (an_item: POINTER; a_sender: POINTER)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(NSResponder *)$an_item performTextFinderAction:$a_sender];
			 ]"
		end
...
feature {NONE} -- NSRestorableState Externals
	...
	objc_encode_restorable_state_with_coder_ (an_item: POINTER; a_coder: POINTER)
		...
		alias
			"[
				[(NSResponder *)$an_item encodeRestorableStateWithCoder:$a_coder];
			 ]"
		end
	...
	objc_restore_state_with_coder_ (an_item: POINTER; a_coder: POINTER)
		...
		alias
			"[
				[(NSResponder *)$an_item restoreStateWithCoder:$a_coder];
			 ]"
		end
	...
	objc_invalidate_restorable_state (an_item: POINTER)
		...
		alias
			"[
				[(NSResponder *)$an_item invalidateRestorableState];
			 ]"
		end
