...
--	make_with_contents_of_ur_l__of_type__error_ (a_url: detachable NS_URL; a_type_name: detachable NS_STRING; a_out_error: UNSUPPORTED_TYPE)
--			-- Initialize `Current'.
--		local
--			a_url__item: POINTER
--			a_type_name__item: POINTER
...
--				a_out_error__item := a_out_error_attached.item
--			end
--			make_with_pointer (objc_init_with_contents_of_ur_l__of_type__error_(allocate_object, a_url__item, a_type_name__item, a_out_error__item))
--			if item = default_pointer then
--				-- TODO: handle initialization error.
--			end
--		end

--	make_for_ur_l__with_contents_of_ur_l__of_type__error_ (a_url_or_nil: detachable NS_URL; a_contents_url: detachable NS_URL; a_type_name: detachable NS_STRING; a_out_error: UNSUPPORTED_TYPE)
--			-- Initialize `Current'.
--		local
--			a_url_or_nil__item: POINTER
--			a_contents_url__item: POINTER
--			a_type_name__item: POINTER
--			a_out_error__item: POINTER
--		do
--			if attached a_url_or_nil as a_url_or_nil_attached then
--				a_url_or_nil__item := a_url_or_nil_attached.item
--			end
...
--				a_out_error__item := a_out_error_attached.item
--			end
--			make_with_pointer (objc_init_for_ur_l__with_contents_of_ur_l__of_type__error_(allocate_object, a_url_or_nil__item, a_contents_url__item, a_type_name__item, a_out_error__item))
--			if item = default_pointer then
--				-- TODO: handle initialization error.
--			end
--		end
...
--	objc_init_with_contents_of_ur_l__of_type__error_ (an_item: POINTER; a_url: POINTER; a_type_name: POINTER; a_out_error: UNSUPPORTED_TYPE): POINTER
--			-- Auto generated Objective-C wrapper.
--		external
--			"C inline use <AppKit/AppKit.h>"
--		alias
--			"[
--				return (EIF_POINTER)[(NSDocument *)$an_item initWithContentsOfURL:$a_url ofType:$a_type_name error:];
--			 ]"
--		end

--	objc_init_for_ur_l__with_contents_of_ur_l__of_type__error_ (an_item: POINTER; a_url_or_nil: POINTER; a_contents_url: POINTER; a_type_name: POINTER; a_out_error: UNSUPPORTED_TYPE): POINTER
--			-- Auto generated Objective-C wrapper.
--		external
--			"C inline use <AppKit/AppKit.h>"
--		alias
--			"[
--				return (EIF_POINTER)[(NSDocument *)$an_item initForURL:$a_url_or_nil withContentsOfURL:$a_contents_url ofType:$a_type_name error:];
--			 ]"
--		end
	...
	objc_set_file_ur_l_ (an_item: POINTER; a_url: POINTER)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(NSDocument *)$an_item setFileURL:$a_url];
			 ]"
		end
...
--	objc_perform_activity_with_synchronous_waiting__using_block_ (an_item: POINTER; a_wait_synchronously: BOOLEAN; a_block: UNSUPPORTED_TYPE)
--			-- Auto generated Objective-C wrapper.
--		external
--			"C inline use <AppKit/AppKit.h>"
--		alias
--			"[
--				[(NSDocument *)$an_item performActivityWithSynchronousWaiting:$a_wait_synchronously usingBlock:];
--			 ]"
--		end

--	objc_continue_activity_using_block_ (an_item: POINTER; a_block: UNSUPPORTED_TYPE)
--			-- Auto generated Objective-C wrapper.
--		external
--			"C inline use <AppKit/AppKit.h>"
--		alias
--			"[
--				[(NSDocument *)$an_item continueActivityUsingBlock:];
--			 ]"
--		end

--	objc_continue_asynchronous_work_on_main_thread_using_block_ (an_item: POINTER; a_block: UNSUPPORTED_TYPE)
--			-- Auto generated Objective-C wrapper.
--		external
--			"C inline use <AppKit/AppKit.h>"
--		alias
--			"[
--				[(NSDocument *)$an_item continueAsynchronousWorkOnMainThreadUsingBlock:];
--			 ]"
--		end

--	objc_perform_synchronous_file_access_using_block_ (an_item: POINTER; a_block: UNSUPPORTED_TYPE)
--			-- Auto generated Objective-C wrapper.
--		external
--			"C inline use <AppKit/AppKit.h>"
--		alias
--			"[
--				[(NSDocument *)$an_item performSynchronousFileAccessUsingBlock:];
--			 ]"
--		end

--	objc_perform_asynchronous_file_access_using_block_ (an_item: POINTER; a_block: UNSUPPORTED_TYPE)
--			-- Auto generated Objective-C wrapper.
--		external
--			"C inline use <AppKit/AppKit.h>"
--		alias
--			"[
--				[(NSDocument *)$an_item performAsynchronousFileAccessUsingBlock:];
--			 ]"
--		end
...
--	objc_revert_to_contents_of_ur_l__of_type__error_ (an_item: POINTER; a_url: POINTER; a_type_name: POINTER; a_out_error: UNSUPPORTED_TYPE): BOOLEAN
--			-- Auto generated Objective-C wrapper.
--		external
--			"C inline use <AppKit/AppKit.h>"
--		alias
--			"[
--				return [(NSDocument *)$an_item revertToContentsOfURL:$a_url ofType:$a_type_name error:];
--			 ]"
--		end

--	objc_read_from_ur_l__of_type__error_ (an_item: POINTER; a_url: POINTER; a_type_name: POINTER; a_out_error: UNSUPPORTED_TYPE): BOOLEAN
--			-- Auto generated Objective-C wrapper.
--		external
--			"C inline use <AppKit/AppKit.h>"
--		alias
--			"[
--				return [(NSDocument *)$an_item readFromURL:$a_url ofType:$a_type_name error:];
--			 ]"
--		end
...
--		end
	...
	objc_is_entire_file_loaded (an_item: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(NSDocument *)$an_item isEntireFileLoaded];
			 ]"
		end

--	objc_write_to_ur_l__of_type__error_ (an_item: POINTER; a_url: POINTER; a_type_name: POINTER; a_out_error: UNSUPPORTED_TYPE): BOOLEAN
--			-- Auto generated Objective-C wrapper.
--		external
--			"C inline use <AppKit/AppKit.h>"
--		alias
--			"[
--				return [(NSDocument *)$an_item writeToURL:$a_url ofType:$a_type_name error:];
--			 ]"
--		end
...
--		end
	...
	objc_unblock_user_interaction (an_item: POINTER)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(NSDocument *)$an_item unblockUserInteraction];
			 ]"
		end

	objc_autosaving_is_implicitly_cancellable (an_item: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(NSDocument *)$an_item autosavingIsImplicitlyCancellable];
			 ]"
		end

--	objc_write_safely_to_ur_l__of_type__for_save_operation__error_ (an_item: POINTER; a_url: POINTER; a_type_name: POINTER; a_save_operation: NATURAL_64; a_out_error: UNSUPPORTED_TYPE): BOOLEAN
--			-- Auto generated Objective-C wrapper.
--		external
--			"C inline use <AppKit/AppKit.h>"
--		alias
--			"[
--				return [(NSDocument *)$an_item writeSafelyToURL:$a_url ofType:$a_type_name forSaveOperation:$a_save_operation error:];
--			 ]"
--		end

--	objc_write_to_ur_l__of_type__for_save_operation__original_contents_ur_l__error_ (an_item: POINTER; a_url: POINTER; a_type_name: POINTER; a_save_operation: NATURAL_64; a_absolute_original_contents_url: POINTER; a_out_error: UNSUPPORTED_TYPE): BOOLEAN
--			-- Auto generated Objective-C wrapper.
--		external
--			"C inline use <AppKit/AppKit.h>"
--		alias
--			"[
--				return [(NSDocument *)$an_item writeToURL:$a_url ofType:$a_type_name forSaveOperation:$a_save_operation originalContentsURL:$a_absolute_original_contents_url error:];
--			 ]"
--		end

--	objc_file_attributes_to_write_to_ur_l__of_type__for_save_operation__original_contents_ur_l__error_ (an_item: POINTER; a_url: POINTER; a_type_name: POINTER; a_save_operation: NATURAL_64; a_absolute_original_contents_url: POINTER; a_out_error: UNSUPPORTED_TYPE): POINTER
--			-- Auto generated Objective-C wrapper.
--		external
--			"C inline use <AppKit/AppKit.h>"
--		alias
--			"[
--				return (EIF_POINTER)[(NSDocument *)$an_item fileAttributesToWriteToURL:$a_url ofType:$a_type_name forSaveOperation:$a_save_operation originalContentsURL:$a_absolute_original_contents_url error:];
--			 ]"
--		end
...
--	objc_save_to_ur_l__of_type__for_save_operation__delegate__did_save_selector__context_info_ (an_item: POINTER; a_url: POINTER; a_type_name: POINTER; a_save_operation: NATURAL_64; a_delegate: POINTER; a_did_save_selector: POINTER; a_context_info: UNSUPPORTED_TYPE)
--			-- Auto generated Objective-C wrapper.
--		external
--			"C inline use <AppKit/AppKit.h>"
--		alias
--			"[
--				[(NSDocument *)$an_item saveToURL:$a_url ofType:$a_type_name forSaveOperation:$a_save_operation delegate:$a_delegate didSaveSelector:$a_did_save_selector contextInfo:];
--			 ]"
--		end

--	objc_save_to_ur_l__of_type__for_save_operation__completion_handler_ (an_item: POINTER; a_url: POINTER; a_type_name: POINTER; a_save_operation: NATURAL_64; a_completion_handler: UNSUPPORTED_TYPE)
--			-- Auto generated Objective-C wrapper.
--		external
--			"C inline use <AppKit/AppKit.h>"
--		alias
--			"[
--				[(NSDocument *)$an_item saveToURL:$a_url ofType:$a_type_name forSaveOperation:$a_save_operation completionHandler:];
--			 ]"
--		end

	objc_can_asynchronously_write_to_ur_l__of_type__for_save_operation_ (an_item: POINTER; a_url: POINTER; a_type_name: POINTER; a_save_operation: NATURAL_64): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(NSDocument *)$an_item canAsynchronouslyWriteToURL:$a_url ofType:$a_type_name forSaveOperation:$a_save_operation];
			 ]"
		end

--	objc_check_autosaving_safety_and_return_error_ (an_item: POINTER; a_out_error: UNSUPPORTED_TYPE): BOOLEAN
--			-- Auto generated Objective-C wrapper.
--		external
--			"C inline use <AppKit/AppKit.h>"
--		alias
--			"[
--				return [(NSDocument *)$an_item checkAutosavingSafetyAndReturnError:];
--			 ]"
--		end

	objc_schedule_autosaving (an_item: POINTER)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(NSDocument *)$an_item scheduleAutosaving];
			 ]"
		end
...
--	objc_autosave_with_implicit_cancellability__completion_handler_ (an_item: POINTER; a_autosaving_is_implicitly_cancellable: BOOLEAN; a_completion_handler: UNSUPPORTED_TYPE)
--			-- Auto generated Objective-C wrapper.
--		external
--			"C inline use <AppKit/AppKit.h>"
--		alias
--			"[
--				[(NSDocument *)$an_item autosaveWithImplicitCancellability:$a_autosaving_is_implicitly_cancellable completionHandler:];
--			 ]"
--		end
	...
	objc_set_autosaved_contents_file_ur_l_ (an_item: POINTER; a_url: POINTER)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(NSDocument *)$an_item setAutosavedContentsFileURL:$a_url];
			 ]"
		end
...
--		end
	...
	objc_duplicate_document_ (an_item: POINTER; a_sender: POINTER)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(NSDocument *)$an_item duplicateDocument:$a_sender];
			 ]"
		end

--	objc_duplicate_document_with_delegate__did_duplicate_selector__context_info_ (an_item: POINTER; a_delegate: POINTER; a_did_duplicate_selector: POINTER; a_context_info: UNSUPPORTED_TYPE)
--			-- Auto generated Objective-C wrapper.
--		external
--			"C inline use <AppKit/AppKit.h>"
--		alias
--			"[
--				[(NSDocument *)$an_item duplicateDocumentWithDelegate:$a_delegate didDuplicateSelector:$a_did_duplicate_selector contextInfo:];
--			 ]"
--		end

--	objc_duplicate_and_return_error_ (an_item: POINTER; a_out_error: UNSUPPORTED_TYPE): POINTER
--			-- Auto generated Objective-C wrapper.
--		external
--			"C inline use <AppKit/AppKit.h>"
--		alias
--			"[
--				return (EIF_POINTER)[(NSDocument *)$an_item duplicateAndReturnError:];
--			 ]"
--		end
...
--		end
	...
	objc_is_in_viewing_mode (an_item: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(NSDocument *)$an_item isInViewingMode];
			 ]"
		end
	...
	objc_change_count_token_for_save_operation_ (an_item: POINTER; a_save_operation: NATURAL_64): POINTER
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return (EIF_POINTER)[(NSDocument *)$an_item changeCountTokenForSaveOperation:$a_save_operation];
			 ]"
		end

	objc_update_change_count_with_token__for_save_operation_ (an_item: POINTER; a_change_count_token: POINTER; a_save_operation: NATURAL_64)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(NSDocument *)$an_item updateChangeCountWithToken:$a_change_count_token forSaveOperation:$a_save_operation];
			 ]"
		end
...
--		end
	...
	objc_will_not_present_error_ (an_item: POINTER; a_error: POINTER)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(NSDocument *)$an_item willNotPresentError:$a_error];
			 ]"
		end
...
--		end
	...
	objc_set_display_name_ (an_item: POINTER; a_display_name_or_nil: POINTER)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(NSDocument *)$an_item setDisplayName:$a_display_name_or_nil];
			 ]"
		end
...
feature -- NSDocument
	...
	set_file_ur_l_ (a_url: detachable NS_URL)
			-- Auto generated Objective-C wrapper.
		local
			a_url__item: POINTER
		do
			...
			objc_set_file_ur_l_ (item, a_url__item)
		end
...
--	perform_activity_with_synchronous_waiting__using_block_ (a_wait_synchronously: BOOLEAN; a_block: UNSUPPORTED_TYPE)
--			-- Auto generated Objective-C wrapper.
--		local
--		do
--			objc_perform_activity_with_synchronous_waiting__using_block_ (item, a_wait_synchronously, )
--		end

--	continue_activity_using_block_ (a_block: UNSUPPORTED_TYPE)
--			-- Auto generated Objective-C wrapper.
--		local
--		do
--			objc_continue_activity_using_block_ (item, )
--		end

--	continue_asynchronous_work_on_main_thread_using_block_ (a_block: UNSUPPORTED_TYPE)
--			-- Auto generated Objective-C wrapper.
--		local
--		do
--			objc_continue_asynchronous_work_on_main_thread_using_block_ (item, )
--		end

--	perform_synchronous_file_access_using_block_ (a_block: UNSUPPORTED_TYPE)
--			-- Auto generated Objective-C wrapper.
--		local
--		do
--			objc_perform_synchronous_file_access_using_block_ (item, )
--		end

--	perform_asynchronous_file_access_using_block_ (a_block: UNSUPPORTED_TYPE)
--			-- Auto generated Objective-C wrapper.
--		local
--		do
--			objc_perform_asynchronous_file_access_using_block_ (item, )
--		end
...
--	revert_to_contents_of_ur_l__of_type__error_ (a_url: detachable NS_URL; a_type_name: detachable NS_STRING; a_out_error: UNSUPPORTED_TYPE): BOOLEAN
--			-- Auto generated Objective-C wrapper.
--		local
--			a_url__item: POINTER
--			a_type_name__item: POINTER
...
--				a_out_error__item := a_out_error_attached.item
--			end
--			Result := objc_revert_to_contents_of_ur_l__of_type__error_ (item, a_url__item, a_type_name__item, a_out_error__item)
--		end

--	read_from_ur_l__of_type__error_ (a_url: detachable NS_URL; a_type_name: detachable NS_STRING; a_out_error: UNSUPPORTED_TYPE): BOOLEAN
--			-- Auto generated Objective-C wrapper.
--		local
--			a_url__item: POINTER
--			a_type_name__item: POINTER
...
--				a_out_error__item := a_out_error_attached.item
--			end
--			Result := objc_read_from_ur_l__of_type__error_ (item, a_url__item, a_type_name__item, a_out_error__item)
--		end
...
--		end
	...
	is_entire_file_loaded: BOOLEAN
			-- Auto generated Objective-C wrapper.
		local
		do
			Result := objc_is_entire_file_loaded (item)
		end

--	write_to_ur_l__of_type__error_ (a_url: detachable NS_URL; a_type_name: detachable NS_STRING; a_out_error: UNSUPPORTED_TYPE): BOOLEAN
--			-- Auto generated Objective-C wrapper.
--		local
--			a_url__item: POINTER
--			a_type_name__item: POINTER
...
--				a_out_error__item := a_out_error_attached.item
--			end
--			Result := objc_write_to_ur_l__of_type__error_ (item, a_url__item, a_type_name__item, a_out_error__item)
--		end
...
--		end
	...
	unblock_user_interaction
			-- Auto generated Objective-C wrapper.
		local
		do
			objc_unblock_user_interaction (item)
		end

	autosaving_is_implicitly_cancellable: BOOLEAN
			-- Auto generated Objective-C wrapper.
		local
		do
			Result := objc_autosaving_is_implicitly_cancellable (item)
		end

--	write_safely_to_ur_l__of_type__for_save_operation__error_ (a_url: detachable NS_URL; a_type_name: detachable NS_STRING; a_save_operation: NATURAL_64; a_out_error: UNSUPPORTED_TYPE): BOOLEAN
--			-- Auto generated Objective-C wrapper.
--		local
--			a_url__item: POINTER
--			a_type_name__item: POINTER
...
--				a_out_error__item := a_out_error_attached.item
--			end
--			Result := objc_write_safely_to_ur_l__of_type__for_save_operation__error_ (item, a_url__item, a_type_name__item, a_save_operation, a_out_error__item)
--		end

--	write_to_ur_l__of_type__for_save_operation__original_contents_ur_l__error_ (a_url: detachable NS_URL; a_type_name: detachable NS_STRING; a_save_operation: NATURAL_64; a_absolute_original_contents_url: detachable NS_URL; a_out_error: UNSUPPORTED_TYPE): BOOLEAN
--			-- Auto generated Objective-C wrapper.
--		local
--			a_url__item: POINTER
--			a_type_name__item: POINTER
...
--				a_out_error__item := a_out_error_attached.item
--			end
--			Result := objc_write_to_ur_l__of_type__for_save_operation__original_contents_ur_l__error_ (item, a_url__item, a_type_name__item, a_save_operation, a_absolute_original_contents_url__item, a_out_error__item)
--		end

--	file_attributes_to_write_to_ur_l__of_type__for_save_operation__original_contents_ur_l__error_ (a_url: detachable NS_URL; a_type_name: detachable NS_STRING; a_save_operation: NATURAL_64; a_absolute_original_contents_url: detachable NS_URL; a_out_error: UNSUPPORTED_TYPE): detachable NS_DICTIONARY
--			-- Auto generated Objective-C wrapper.
--		local
--			result_pointer: POINTER
--			a_url__item: POINTER
...
--				a_out_error__item := a_out_error_attached.item
--			end
--			result_pointer := objc_file_attributes_to_write_to_ur_l__of_type__for_save_operation__original_contents_ur_l__error_ (item, a_url__item, a_type_name__item, a_save_operation, a_absolute_original_contents_url__item, a_out_error__item)
--			if result_pointer /= default_pointer then
--				if attached objc_get_eiffel_object (result_pointer) as existing_eiffel_object then
...
--	save_to_ur_l__of_type__for_save_operation__delegate__did_save_selector__context_info_ (a_url: detachable NS_URL; a_type_name: detachable NS_STRING; a_save_operation: NATURAL_64; a_delegate: detachable NS_OBJECT; a_did_save_selector: detachable OBJC_SELECTOR; a_context_info: UNSUPPORTED_TYPE)
--			-- Auto generated Objective-C wrapper.
--		local
--			a_url__item: POINTER
--			a_type_name__item: POINTER
...
--				a_context_info__item := a_context_info_attached.item
--			end
--			objc_save_to_ur_l__of_type__for_save_operation__delegate__did_save_selector__context_info_ (item, a_url__item, a_type_name__item, a_save_operation, a_delegate__item, a_did_save_selector__item, a_context_info__item)
--		end

--	save_to_ur_l__of_type__for_save_operation__completion_handler_ (a_url: detachable NS_URL; a_type_name: detachable NS_STRING; a_save_operation: NATURAL_64; a_completion_handler: UNSUPPORTED_TYPE)
--			-- Auto generated Objective-C wrapper.
--		local
--			a_url__item: POINTER
--			a_type_name__item: POINTER
...
--				a_type_name__item := a_type_name_attached.item
--			end
--			objc_save_to_ur_l__of_type__for_save_operation__completion_handler_ (item, a_url__item, a_type_name__item, a_save_operation, )
--		end

	can_asynchronously_write_to_ur_l__of_type__for_save_operation_ (a_url: detachable NS_URL; a_type_name: detachable NS_STRING; a_save_operation: NATURAL_64): BOOLEAN
			-- Auto generated Objective-C wrapper.
		local
			a_url__item: POINTER
			a_type_name__item: POINTER
		do
			...
			Result := objc_can_asynchronously_write_to_ur_l__of_type__for_save_operation_ (item, a_url__item, a_type_name__item, a_save_operation)
		end

--	check_autosaving_safety_and_return_error_ (a_out_error: UNSUPPORTED_TYPE): BOOLEAN
--			-- Auto generated Objective-C wrapper.
--		local
--			a_out_error__item: POINTER
--		do
...
--				a_out_error__item := a_out_error_attached.item
--			end
--			Result := objc_check_autosaving_safety_and_return_error_ (item, a_out_error__item)
--		end
...
--	autosave_with_implicit_cancellability__completion_handler_ (a_autosaving_is_implicitly_cancellable: BOOLEAN; a_completion_handler: UNSUPPORTED_TYPE)
--			-- Auto generated Objective-C wrapper.
--		local
--		do
--			objc_autosave_with_implicit_cancellability__completion_handler_ (item, a_autosaving_is_implicitly_cancellable, )
--		end
	...
	set_autosaved_contents_file_ur_l_ (a_url: detachable NS_URL)
			-- Auto generated Objective-C wrapper.
		local
			a_url__item: POINTER
		do
			...
			objc_set_autosaved_contents_file_ur_l_ (item, a_url__item)
		end
...
--		end
	...
	duplicate_document_ (a_sender: detachable NS_OBJECT)
			-- Auto generated Objective-C wrapper.
		local
			a_sender__item: POINTER
		do
			...
			objc_duplicate_document_ (item, a_sender__item)
		end

--	duplicate_document_with_delegate__did_duplicate_selector__context_info_ (a_delegate: detachable NS_OBJECT; a_did_duplicate_selector: detachable OBJC_SELECTOR; a_context_info: UNSUPPORTED_TYPE)
--			-- Auto generated Objective-C wrapper.
--		local
--			a_delegate__item: POINTER
--			a_did_duplicate_selector__item: POINTER
--			a_context_info__item: POINTER
--		do
--			if attached a_delegate as a_delegate_attached then
--				a_delegate__item := a_delegate_attached.item
--			end
--			if attached a_did_duplicate_selector as a_did_duplicate_selector_attached then
--				a_did_duplicate_selector__item := a_did_duplicate_selector_attached.item
--			end
--			if attached a_context_info as a_context_info_attached then
--				a_context_info__item := a_context_info_attached.item
--			end
--			objc_duplicate_document_with_delegate__did_duplicate_selector__context_info_ (item, a_delegate__item, a_did_duplicate_selector__item, a_context_info__item)
--		end

--	duplicate_and_return_error_ (a_out_error: UNSUPPORTED_TYPE): detachable NS_DOCUMENT
--			-- Auto generated Objective-C wrapper.
--		local
--			result_pointer: POINTER
--			a_out_error__item: POINTER
...
--				a_out_error__item := a_out_error_attached.item
--			end
--			result_pointer := objc_duplicate_and_return_error_ (item, a_out_error__item)
--			if result_pointer /= default_pointer then
--				if attached objc_get_eiffel_object (result_pointer) as existing_eiffel_object then
--					check attached {like duplicate_and_return_error_} existing_eiffel_object as valid_result then
--						Result := valid_result
--					end
--				else
--					check attached {like duplicate_and_return_error_} new_eiffel_object (result_pointer, True) as valid_result_pointer then
--						Result := valid_result_pointer
--					end
--				end
--			end
...
--		end
	...
	is_in_viewing_mode: BOOLEAN
			-- Auto generated Objective-C wrapper.
		local
		do
			Result := objc_is_in_viewing_mode (item)
		end
	...
	change_count_token_for_save_operation_ (a_save_operation: NATURAL_64): detachable NS_OBJECT
			-- Auto generated Objective-C wrapper.
		local
			result_pointer: POINTER
		do
			result_pointer := objc_change_count_token_for_save_operation_ (item, a_save_operation)
			if result_pointer /= default_pointer then
				if attached objc_get_eiffel_object (result_pointer) as existing_eiffel_object then
					check attached {like change_count_token_for_save_operation_} existing_eiffel_object as valid_result then
						Result := valid_result
					end
				else
					check attached {like change_count_token_for_save_operation_} new_eiffel_object (result_pointer, True) as valid_result_pointer then
						Result := valid_result_pointer
					end
				end
			end
	...
	update_change_count_with_token__for_save_operation_ (a_change_count_token: detachable NS_OBJECT; a_save_operation: NATURAL_64)
			-- Auto generated Objective-C wrapper.
		local
			a_change_count_token__item: POINTER
		do
			if attached a_change_count_token as a_change_count_token_attached then
				a_change_count_token__item := a_change_count_token_attached.item
			end
			objc_update_change_count_with_token__for_save_operation_ (item, a_change_count_token__item, a_save_operation)
		end
...
--		end
	...
	will_not_present_error_ (a_error: detachable NS_ERROR)
			-- Auto generated Objective-C wrapper.
		local
			a_error__item: POINTER
		do
			...
			objc_will_not_present_error_ (item, a_error__item)
		end
...
--		end
	...
	set_display_name_ (a_display_name_or_nil: detachable NS_STRING)
			-- Auto generated Objective-C wrapper.
		local
			a_display_name_or_nil__item: POINTER
		do
			if attached a_display_name_or_nil as a_display_name_or_nil_attached then
				a_display_name_or_nil__item := a_display_name_or_nil_attached.item
			end
			objc_set_display_name_ (item, a_display_name_or_nil__item)
		end
...
--	save_to_ur_l__of_type__for_save_operation__error_ (a_url: detachable NS_URL; a_type_name: detachable NS_STRING; a_save_operation: NATURAL_64; a_out_error: UNSUPPORTED_TYPE): BOOLEAN
--			-- Auto generated Objective-C wrapper.
--		local
--			a_url__item: POINTER
--			a_type_name__item: POINTER
...
--				a_out_error__item := a_out_error_attached.item
--			end
--			Result := objc_save_to_ur_l__of_type__for_save_operation__error_ (item, a_url__item, a_type_name__item, a_save_operation, a_out_error__item)
--		end

feature {NONE} -- NSDeprecated Externals

--	objc_save_to_ur_l__of_type__for_save_operation__error_ (an_item: POINTER; a_url: POINTER; a_type_name: POINTER; a_save_operation: NATURAL_64; a_out_error: UNSUPPORTED_TYPE): BOOLEAN
--			-- Auto generated Objective-C wrapper.
--		external
--			"C inline use <AppKit/AppKit.h>"
--		alias
--			"[
--				return [(NSDocument *)$an_item saveToURL:$a_url ofType:$a_type_name forSaveOperation:$a_save_operation error:];
--			 ]"
--		end
...
feature -- NSRestorableState

--	restore_document_window_with_identifier__state__completion_handler_ (a_identifier: detachable NS_STRING; a_state: detachable NS_CODER; a_completion_handler: UNSUPPORTED_TYPE)
--			-- Auto generated Objective-C wrapper.
--		local
...
--			end
--			objc_restore_document_window_with_identifier__state__completion_handler_ (item, a_identifier__item, a_state__item, )
--		end

	encode_restorable_state_with_coder_ (a_coder: detachable NS_CODER)
			-- Auto generated Objective-C wrapper.
		local
		...
		do
			...
			objc_encode_restorable_state_with_coder_ (item, a_coder__item)
		end

	restore_state_with_coder_ (a_coder: detachable NS_CODER)
			-- Auto generated Objective-C wrapper.
		local
			a_coder__item: POINTER
		do
			...
			objc_restore_state_with_coder_ (item, a_coder__item)
		end

	invalidate_restorable_state
			-- Auto generated Objective-C wrapper.
		local
		do
			objc_invalidate_restorable_state (item)
		end

feature {NONE} -- NSRestorableState Externals

--	objc_restore_document_window_with_identifier__state__completion_handler_ (an_item: POINTER; a_identifier: POINTER; a_state: POINTER; a_completion_handler: UNSUPPORTED_TYPE)
--			-- Auto generated Objective-C wrapper.
--		external
--			"C inline use <AppKit/AppKit.h>"
--		alias
--			"[
--				[(NSDocument *)$an_item restoreDocumentWindowWithIdentifier:$a_identifier state:$a_state completionHandler:];
--			 ]"
--		end

	objc_encode_restorable_state_with_coder_ (an_item: POINTER; a_coder: POINTER)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(NSDocument *)$an_item encodeRestorableStateWithCoder:$a_coder];
			 ]"
		end

	objc_restore_state_with_coder_ (an_item: POINTER; a_coder: POINTER)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(NSDocument *)$an_item restoreStateWithCoder:$a_coder];
			 ]"
		end

	objc_invalidate_restorable_state (an_item: POINTER)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(NSDocument *)$an_item invalidateRestorableState];
			 ]"
		end
