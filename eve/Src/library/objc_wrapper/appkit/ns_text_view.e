...
feature {NONE} -- NSTextView Externals
	...
	objc_set_layout_orientation_ (an_item: POINTER; a_the_orientation: INTEGER_64)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(NSTextView *)$an_item setLayoutOrientation:$a_the_orientation];
			 ]"
		end

	objc_change_layout_orientation_ (an_item: POINTER; a_sender: POINTER)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(NSTextView *)$an_item changeLayoutOrientation:$a_sender];
			 ]"
		end
...
feature -- NSTextView
	...
	set_layout_orientation_ (a_the_orientation: INTEGER_64)
			-- Auto generated Objective-C wrapper.
		local
		do
			objc_set_layout_orientation_ (item, a_the_orientation)
		end

	change_layout_orientation_ (a_sender: detachable NS_OBJECT)
			-- Auto generated Objective-C wrapper.
		local
			a_sender__item: POINTER
		do
			...
			objc_change_layout_orientation_ (item, a_sender__item)
		end
...
feature -- NSSharing
	...
	uses_inspector_bar: BOOLEAN
			-- Auto generated Objective-C wrapper.
		local
		do
			Result := objc_uses_inspector_bar (item)
		end

	set_uses_inspector_bar_ (a_flag: BOOLEAN)
			-- Auto generated Objective-C wrapper.
		local
		do
			objc_set_uses_inspector_bar_ (item, a_flag)
		end
...
feature {NONE} -- NSSharing Externals
	...
	objc_uses_inspector_bar (an_item: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(NSTextView *)$an_item usesInspectorBar];
			 ]"
		end

	objc_set_uses_inspector_bar_ (an_item: POINTER; a_flag: BOOLEAN)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(NSTextView *)$an_item setUsesInspectorBar:$a_flag];
			 ]"
		end
...
--		end
	...
	set_uses_find_bar_ (a_flag: BOOLEAN)
			-- Auto generated Objective-C wrapper.
		local
		do
			objc_set_uses_find_bar_ (item, a_flag)
		end

	uses_find_bar: BOOLEAN
			-- Auto generated Objective-C wrapper.
		local
		do
			Result := objc_uses_find_bar (item)
		end

	set_incremental_searching_enabled_ (a_flag: BOOLEAN)
			-- Auto generated Objective-C wrapper.
		local
		do
			objc_set_incremental_searching_enabled_ (item, a_flag)
		end

	is_incremental_searching_enabled: BOOLEAN
			-- Auto generated Objective-C wrapper.
		local
		do
...
--		end
	...
	objc_set_uses_find_bar_ (an_item: POINTER; a_flag: BOOLEAN)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(NSTextView *)$an_item setUsesFindBar:$a_flag];
			 ]"
		end

	objc_uses_find_bar (an_item: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(NSTextView *)$an_item usesFindBar];
			 ]"
		end

	objc_set_incremental_searching_enabled_ (an_item: POINTER; a_flag: BOOLEAN)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(NSTextView *)$an_item setIncrementalSearchingEnabled:$a_flag];
			 ]"
		end
	...
	objc_is_incremental_searching_enabled (an_item: POINTER): BOOLEAN
		...
		alias
			"[
				return [(NSTextView *)$an_item isIncrementalSearchingEnabled];
			 ]"
		end

feature -- NSQuickLookPreview

	toggle_quick_look_preview_panel_ (a_sender: detachable NS_OBJECT)
			-- Auto generated Objective-C wrapper.
		local
			a_sender__item: POINTER
		do
			...
			objc_toggle_quick_look_preview_panel_ (item, a_sender__item)
		end

	quick_look_previewable_items_in_ranges_ (a_ranges: detachable NS_ARRAY): detachable NS_ARRAY
			-- Auto generated Objective-C wrapper.
		local
			result_pointer: POINTER
			a_ranges__item: POINTER
		do
			...
			result_pointer := objc_quick_look_previewable_items_in_ranges_ (item, a_ranges__item)
			if result_pointer /= default_pointer then
				if attached objc_get_eiffel_object (result_pointer) as existing_eiffel_object then
					check attached {like quick_look_previewable_items_in_ranges_} existing_eiffel_object as valid_result then
						Result := valid_result
					end
				else
					check attached {like quick_look_previewable_items_in_ranges_} new_eiffel_object (result_pointer, True) as valid_result_pointer then
						Result := valid_result_pointer
					end
				end
			end
	...
	update_quick_look_preview_panel
			-- Auto generated Objective-C wrapper.
		local
		do
			objc_update_quick_look_preview_panel (item)
		end

feature {NONE} -- NSQuickLookPreview Externals

	objc_toggle_quick_look_preview_panel_ (an_item: POINTER; a_sender: POINTER)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(NSTextView *)$an_item toggleQuickLookPreviewPanel:$a_sender];
			 ]"
		end

	objc_quick_look_previewable_items_in_ranges_ (an_item: POINTER; a_ranges: POINTER): POINTER
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return (EIF_POINTER)[(NSTextView *)$an_item quickLookPreviewableItemsInRanges:$a_ranges];
			 ]"
		end

	objc_update_quick_look_preview_panel (an_item: POINTER)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				[(NSTextView *)$an_item updateQuickLookPreviewPanel];
			 ]"
		end
