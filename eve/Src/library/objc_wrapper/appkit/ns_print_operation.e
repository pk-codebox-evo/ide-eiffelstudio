...
feature -- NSPrintOperation
	...
	preferred_rendering_quality: INTEGER_64
			-- Auto generated Objective-C wrapper.
		local
		do
			Result := objc_preferred_rendering_quality (item)
		end
...
feature {NONE} -- NSPrintOperation Externals
	...
	objc_preferred_rendering_quality (an_item: POINTER): INTEGER_64
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return [(NSPrintOperation *)$an_item preferredRenderingQuality];
			 ]"
		end
