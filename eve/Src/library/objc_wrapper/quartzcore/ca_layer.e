...
feature -- Properties
	...
	contents_scale: REAL_64 assign set_contents_scale
			-- Auto generated Objective-C wrapper.
		do
			Result := objc_contents_scale (item)
		end

	set_contents_scale (an_arg: REAL_64)
			-- Auto generated Objective-C wrapper.
		local
		do
			objc_set_contents_scale (item, an_arg)
		end
...
--		end
	...
	should_rasterize: BOOLEAN assign set_should_rasterize
			-- Auto generated Objective-C wrapper.
		do
			Result := objc_should_rasterize (item)
		end

	set_should_rasterize (an_arg: BOOLEAN)
			-- Auto generated Objective-C wrapper.
		local
		do
			objc_set_should_rasterize (item, an_arg)
		end

	rasterization_scale: REAL_64 assign set_rasterization_scale
			-- Auto generated Objective-C wrapper.
		do
			Result := objc_rasterization_scale (item)
		end

	set_rasterization_scale (an_arg: REAL_64)
			-- Auto generated Objective-C wrapper.
		local
		do
			objc_set_rasterization_scale (item, an_arg)
		end
...
--	shadow_path: UNSUPPORTED_TYPE assign set_shadow_path
--			-- Auto generated Objective-C wrapper.
--		local
--			result_pointer: POINTER
--		do
--			result_pointer := objc_shadow_path (item)
--			if result_pointer /= default_pointer then
--				if attached objc_get_eiffel_object (result_pointer) as existing_eiffel_object then
--					check attached {like shadow_path} existing_eiffel_object as valid_result then
--						Result := valid_result
--					end
--				else
--					check attached {like shadow_path} new_eiffel_object (result_pointer, True) as valid_result_pointer then
--						Result := valid_result_pointer
--					end
--				end
--			end
...
--	set_shadow_path (an_arg: UNSUPPORTED_TYPE)
--			-- Auto generated Objective-C wrapper.
--		local
--			an_arg__item: POINTER
--		do
...
--				an_arg__item := an_arg_attached.item
--			end
--			objc_set_shadow_path (item, an_arg__item)
--		end
...
feature {NONE} -- Properties Externals
	...
	objc_contents_scale (an_item: POINTER): REAL_64
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <QuartzCore/QuartzCore.h>"
		alias
			"[
				return [(CALayer *)$an_item contentsScale];
			 ]"
		end

	objc_set_contents_scale (an_item: POINTER; an_arg: REAL_64)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <QuartzCore/QuartzCore.h>"
		alias
			"[
				[(CALayer *)$an_item setContentsScale:$an_arg]
			 ]"
		end
...
--		end
	...
	objc_should_rasterize (an_item: POINTER): BOOLEAN
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <QuartzCore/QuartzCore.h>"
		alias
			"[
				return [(CALayer *)$an_item shouldRasterize];
			 ]"
		end

	objc_set_should_rasterize (an_item: POINTER; an_arg: BOOLEAN)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <QuartzCore/QuartzCore.h>"
		alias
			"[
				[(CALayer *)$an_item setShouldRasterize:$an_arg]
			 ]"
		end

	objc_rasterization_scale (an_item: POINTER): REAL_64
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <QuartzCore/QuartzCore.h>"
		alias
			"[
				return [(CALayer *)$an_item rasterizationScale];
			 ]"
		end

	objc_set_rasterization_scale (an_item: POINTER; an_arg: REAL_64)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <QuartzCore/QuartzCore.h>"
		alias
			"[
				[(CALayer *)$an_item setRasterizationScale:$an_arg]
			 ]"
		end
...
--	objc_shadow_path (an_item: POINTER): POINTER
--			-- Auto generated Objective-C wrapper.
--		external
--			"C inline use <QuartzCore/QuartzCore.h>"
--		alias
--			"[
--				return (EIF_POINTER)[(CALayer *)$an_item shadowPath];
--			 ]"
--		end

--	objc_set_shadow_path (an_item: POINTER; an_arg: UNSUPPORTED_TYPE)
--			-- Auto generated Objective-C wrapper.
--		external
--			"C inline use <QuartzCore/QuartzCore.h>"
--		alias
--			"[
--				[(CALayer *)$an_item setShadowPath:$ARG]
--			 ]"
--		end
