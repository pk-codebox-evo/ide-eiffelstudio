...
/*
TODO:
 - mysql_fetch_field_direct() [column name]    column_at (i)
 - mysql_data_seek() [jump to row]     go_i_th (i), start
 - mysql_stmt_data_seek() [jump to row]     go_i_th (i), start
 - mysql_stmt_result_metadata() [column name]    column_at (i), is_integer (i), is_string (i), ...
*/
