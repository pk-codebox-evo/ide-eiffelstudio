...
You can give the \lstinline!like!-operator a pattern string as a value, which can contain the wildcard characters \lstinline!*! and \lstinline!?!.
...
The first one is the more traditional one, using \lstinline!CRITERION_FACTORY.new_agent! or \lstinline!CRITERION_FACTORY.new_predefined!.
...
The result is an iterator over a list of tuples in which the attributes of an object are collected. The order of these attributes is the one defined in \lstinline!TUPLE_QUERY.projection!
