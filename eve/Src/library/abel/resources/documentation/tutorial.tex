...
You can see how this is done in Section \todo{TODO: insert section reference} in the technical documentation, where the whole concept of an object graphs and its depth is described more detailed.
...
\item \todo {Create all error types... }
\end{itemize}
