...
\lstinline!PS_REPOSITORY!. In this case we will be creating a more specific object of type \lstinline!PS_IN_MEMORY_REPOSITORY!. More in general, ABEL provides support for creating \lstinline{PS_RELATIONAL_REPOSITORY} objects with the factory class \lstinline!PS_REPOSITORY_FACTORY!.\\
