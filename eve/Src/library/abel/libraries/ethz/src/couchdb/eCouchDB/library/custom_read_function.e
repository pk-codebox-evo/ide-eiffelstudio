...
create
    ...
    make_with_data
feature -- Redefine
    make_with_data2 ( a_data : STRING)
        local
            l_file : RAW_FILE
        do
            make
            create l_file.make ("temp_json_data.json")
    ...
    read_function2 (a_data_pointer: POINTER; a_size, a_nmemb: INTEGER_32; a_object_id: POINTER): INTEGER_32
            -- <Precursor>
        local
