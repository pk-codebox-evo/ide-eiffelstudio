note
	...
	description: "[
				 Xpath-like path based on openEHR ADL. This abstraction allows ADL style paths to be created and manipulated. 
	...
	file:        "$URL: https://svn.origo.ethz.ch/abel/trunk/libraries/openehr/src/object_graph/path/og_path.e $"
