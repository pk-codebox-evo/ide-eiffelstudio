note
	...
	description: "[
				 Path segment of a path of a node in an object graph. Consists of an attribute name and an object id, 
				 which is either empty, as in the case of single attributes, or some identifier, needed to discriminate
				 among objects in a container referenced by the attribute.
				 ]"
	keywords:    "paths"
	author:      "Thomas Beale <thomas.beale@oceaninformatics.com>"
	support:     "http://www.openehr.org/issues/browse/AWB"
	copyright:   "Copyright (c) 2007-2010 openEHR Foundation <http://www.openEHR.org>"
	license:     "See notice at bottom of class"

	file:        "$URL: https://svn.origo.ethz.ch/abel/trunk/libraries/openehr/src/object_graph/path/og_path_item.e $"
...
feature -- Initialisation
	...
	make_with_object_id(an_attr_name, an_object_id: attached STRING)
	...
	make_feature_call(a_feat_name: attached STRING)
		require
	...
	make_from_other(other: attached OG_PATH_ITEM)
...
feature -- Access
	...
	attr_name: attached STRING
			-- name of attribute of this path segment

	object_id: attached STRING
...
feature -- Modification
	...
	set_object_id(an_object_id: attached STRING)
			-- make a path segment with an attribute name and an object id -
...
feature {OG_PATH} -- Modification
	...
	set_compressed_attr(a_path: attached STRING)
