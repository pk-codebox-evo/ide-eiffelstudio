...
feature -- Token codes
	...
	SYM_INFINITY: INTEGER = 278
	SYM_INTERVAL_DELIM: INTEGER = 279
	SYM_DT_UNKNOWN: INTEGER = 280
	SYM_TRUE: INTEGER = 281
	SYM_FALSE: INTEGER = 282
	SYM_LT: INTEGER = 283
	SYM_GT: INTEGER = 284
	SYM_LE: INTEGER = 285
	SYM_GE: INTEGER = 286
	ERR_CHARACTER: INTEGER = 287
	ERR_STRING: INTEGER = 288
	ERR_CADL_MISPLACED: INTEGER = 289
	ERR_V_QUALIFIED_TERM_CODE_REF: INTEGER = 290
	ERR_V_LOCAL_TERM_CODE_REF: INTEGER = 291
