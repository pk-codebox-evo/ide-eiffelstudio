note
	...
	description: "[
				 Node of primitive type in an Data Tree. Primitive types include: 
				 STRING_N, INTEGER_N, REAL_N, CHARACTER_N, BOOLEAN, date/time types.
			     ]"
	keywords:    "Data Tree"
	...
	file:        "$URL: https://svn.origo.ethz.ch/abel/trunk/libraries/openehr/src/data_tree/dt_primitive_object_list.e $"
...
feature -- Modification
	...
	set_value(a_value: like value)
		do
			value := a_value
			rm_type_name := eiffel_to_uml_typename(a_value.generating_type)
		end
