note
	...
	file:        "$URL: https://svn.origo.ethz.ch/abel/trunk/libraries/openehr/src/app_framework/config_file/shared_config_file_access.e $"
	revision:    "$LastChangedRevision$"
	last_change: "$LastChangedDate$"

class SHARED_CONFIG_FILE_ACCESS
