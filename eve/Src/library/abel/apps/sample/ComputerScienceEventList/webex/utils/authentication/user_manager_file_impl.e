...
feature -- Basic operations
	...
	persist_data
		...
		do
			...
			if user_list_data_file.is_open_read then
				user_list_data_file.reopen_write (data_path+file_name)
			elseif user_list_data_file.is_open_append or user_list_data_file.is_open_write then
				-- how can we sleep here couple seconds?
				user_list_data_file.reopen_write (data_path+file_name)
			elseif user_list_data_file.exists then
				user_list_data_file.open_write
			else
				user_list_data_file.create_read_write
			end
