indexing
	...
	file:        "$URL: http://www.openehr.org/svn/ref_impl_eiffel/TRUNK/libraries/openehr/src/am/archetype/constraint_model/c_attribute.e $"
...
feature -- Initialisation
	...
	default_create is
		...
		do
			...
			set_existence (create {INTERVAL_EHR [INTEGER]}.make_bounded (1, 1, True, True))
		end
...
feature -- Access
	...
	existence: INTERVAL_EHR [INTEGER]
...
feature -- Modification
	...
	set_existence(an_interval: INTERVAL_EHR[INTEGER]) is
