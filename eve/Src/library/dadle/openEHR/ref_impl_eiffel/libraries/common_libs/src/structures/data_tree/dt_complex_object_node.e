indexing
	...
	file:        "$URL: http://www.openehr.org/svn/ref_impl_eiffel/TRUNK/libraries/common_libs/src/structures/data_tree/dt_complex_object_node.e $"
...
feature -- Access
	...
	attribute_with_name(an_attr_name: STRING): DT_ATTRIBUTE_NODE is
...
feature -- Conversion
	...
	as_object(a_type_id: INTEGER): ANY is
			...
			-- of this DT_OBJECT
		do
			Result := object_converter.dt_to_object_internal(Current, a_type_id)
		end
