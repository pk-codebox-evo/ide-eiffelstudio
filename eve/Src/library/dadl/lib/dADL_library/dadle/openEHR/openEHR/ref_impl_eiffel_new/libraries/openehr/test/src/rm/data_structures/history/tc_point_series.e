indexing
	...
	file:        "$URL: http://www.openehr.org/svn/ref_impl_eiffel/TRUNK/libraries/openehr/test/src/rm/data_structures/history/tc_point_series.e $"
	revision:    "$LastChangedRevision$"
	last_change: "$LastChangedDate$"

class TC_POINT_SERIES
...
feature -- Initialisation
	...
	execute is
		local
			...
			h3: HISTORY [ITEM_TABLE]
			h4: HISTORY [ITEM_TREE]

			evs1: POINT_EVENT [ITEM_SINGLE]
			evs2: POINT_EVENT [ITEM_LIST]
			evs3: POINT_EVENT [ITEM_TABLE]
			evs4: POINT_EVENT [ITEM_TREE]
		do
