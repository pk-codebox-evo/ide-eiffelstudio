note
	...
	file:        "$URL: http://www.openehr.org/svn/ref_impl_eiffel/BRANCHES/specialisation/components/adl_parser/test/src/basic/archetypes/test_repository.e $"
...
--| License.
--|
--| The Original Code is test_repository.e.
--|
