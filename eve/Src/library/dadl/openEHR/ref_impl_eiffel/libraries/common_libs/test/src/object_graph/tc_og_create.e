indexing
	...
	file:        "$URL: http://www.openehr.org/svn/ref_impl_eiffel/TRUNK/libraries/common_libs/test/src/object_graph/tc_og_create.e $"
...
feature -- Access
	...
	title:STRING is "Object Graph CREATE test"
...
feature -- Initialisation
	...
	execute is
		...
		do
			...
			-- add two attributes
			create attr_node.make_single("name", Void)
			root_node.put_child(attr_node)

			create attr_node.make_single("items", Void)
			root_node.put_child(attr_node)
			...
			create attr_node.make_single("count", Void)
