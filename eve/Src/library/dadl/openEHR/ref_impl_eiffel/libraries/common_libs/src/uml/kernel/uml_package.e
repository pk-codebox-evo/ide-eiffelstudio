indexing
	...
	file:        "$URL: http://www.openehr.org/svn/ref_impl_eiffel/TRUNK/libraries/common_libs/src/uml/kernel/uml_package.e $"
...
feature -- Modification
	...
	add_nested_package(a_pkg: UML_PACKAGE) is
	...
	add_class(a_class: UML_CLASS) is
			-- add another class
		require
	...
	set_nesting_package(a_pkg: UML_PACKAGE) is
			-- set parent
		require
			a_package_exists: a_pkg /= Void
		do
