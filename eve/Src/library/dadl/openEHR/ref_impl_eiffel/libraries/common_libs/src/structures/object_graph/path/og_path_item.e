indexing
	...
	file:        "$URL: http://www.openehr.org/svn/ref_impl_eiffel/TRUNK/libraries/common_libs/src/structures/object_graph/path/og_path_item.e $"
...
feature -- Modification
	...
	set_attr_name(a_name:STRING) is
			-- sets attribute name
			-- not really used - just because of parser fix at the moment
			-- (see OG_PATH make_from_string)
		do
			attr_name := a_name
		end
