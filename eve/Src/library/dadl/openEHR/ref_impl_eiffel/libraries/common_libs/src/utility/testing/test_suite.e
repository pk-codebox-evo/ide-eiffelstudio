indexing
	...
	file:        "$URL: http://www.openehr.org/svn/ref_impl_eiffel/TRUNK/libraries/common_libs/src/utility/testing/test_suite.e $"
...
feature -- Access
	...
	test_cases: LINKED_LIST[TEST_CASE_UTIL] is
			-- the list of tests available
		deferred
		end
		
	test_case_index: HASH_TABLE [TEST_CASE_UTIL, STRING] is
		do
...
feature {NONE} -- Implementation
	...
	stored_test_case_index: HASH_TABLE [TEST_CASE_UTIL, STRING]
