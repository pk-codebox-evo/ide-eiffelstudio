indexing
	...
	file:        "$URL: http://www.openehr.org/svn/ref_impl_eiffel/TRUNK/libraries/openehr/src/am/openehr_profile/data_types/quantity/c_quantity_item.e $"
...
feature -- Initialisation
	...
	make(a_units: STRING; a_magnitude: INTERVAL_EHR[REAL]; a_precision: INTERVAL_EHR[INTEGER]) is
...
feature -- Access
	...
	magnitude: INTERVAL_EHR [REAL]
			-- constraint on magnitude
			
	precision: INTERVAL_EHR [INTEGER]
