indexing
	...
	file:        "$URL: http://www.openehr.org/svn/ref_impl_eiffel/TRUNK/components/adl_parser/src/wrapper/c/c_adl_objects.e $"
...
feature {SHARED_ADL_OBJECTS} -- Handles
	...
	real_intervals: HASH_TABLE[INTERVAL_EHR[REAL], INTEGER]

	integer_intervals: HASH_TABLE[INTERVAL_EHR[INTEGER], INTEGER]
