...
feature -- Default tuples to handle basic refactorings
	...
	attribute_changed_name (old_name: STRING): TUPLE [LIST [STRING], FUNCTION [ANY, TUPLE [LIST [ANY]], ANY]] is
	...
	attribute_constant_initialization (value: ANY): TUPLE [LIST [STRING], FUNCTION [ANY, TUPLE [LIST [ANY]], ANY]] is
	...
	attribute_changed_type (old_name: STRING; conv_function: FUNCTION[ANY, TUPLE, ANY]): TUPLE [LIST [STRING], FUNCTION [ANY, TUPLE [LIST [ANY]], ANY]] is
...
feature{NONE} -- Utility functions
	...
	change_name (var: LIST [ANY]): ANY is
			-- Change the name.
		do
			Result := var.i_th (1)
		end

	constant_function (value: ANY; var: LIST [ANY]): ANY is
			-- Assign a constant value.
		do
			Result := value
		end

	change_type (var: LIST[ANY];conv_function: FUNCTION[ANY,TUPLE,ANY]): ANY is
			-- Change the type.
		do
