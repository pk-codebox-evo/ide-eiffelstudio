note
	...
	description: "[
				 Abstract characteristics of a node that contains a reference to another node, 
	             implemented by paths. Serialises an object non-containment reference.
				 ]"
	keywords:    "Data Tree"
	...
	file:        "$URL: https://svn.origo.ethz.ch/abel/trunk/libraries/openehr/src/data_tree/dt_reference.e $"
