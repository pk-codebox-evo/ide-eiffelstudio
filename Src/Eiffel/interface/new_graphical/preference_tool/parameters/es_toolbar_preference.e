...
feature {NONE} -- Implementation
	...
	retrieve_toolbar_items (a_command_pool: LIST [EB_TOOLBARABLE_COMMAND]; a_layout: ARRAY [STRING]): ARRAYED_SET [SD_TOOL_BAR_ITEM] is
