...
feature -- Command
	...
	init_commands is
		...
		do
			...
			develop_window.uis.set_editors (l_editors)
		end
	...
	prepare_editor_tool is
		...
		do
			...
			develop_window.uis.set_editors_widget (l_editors_widget)
...
feature{NONE} -- Implementation
	...
	build_features_tool is
		...
		do
			...
			create l_show_cmd.make (develop_window, l_features_tool.content)
	...
	build_cluster_tool is
		...
		do
			...
			create l_show_cmd.make (develop_window, l_cluster_tool.content)
	...
	build_output_tool is
		...
		do
			...
			create l_show_cmd.make (develop_window, l_output_tool.content)
	...
	build_diagram_tool is
		...
		do
			if develop_window.has_case then
				...
				create l_show_cmd.make (develop_window, l_diagram_tool.content)
	...
	build_class_tool is
		...
		do
			...
			create l_show_cmd.make (develop_window, l_class_tool.content)
	...
	build_features_relation_tool is
		...
		do
			...
			create l_show_cmd.make (develop_window, l_features_relation_tool.content)
	...
	build_metric_tool is
		...
		do
			...
			create l_show_cmd.make (develop_window, l_metric_tool.content)
	...
	build_external_output_tool is
		...
		do
			...
			create l_show_cmd.make (develop_window, l_external_output_tool.content)
	...
	build_c_output_tool is
		...
		do
			...
			create l_show_cmd.make (develop_window, l_c_output_tool.content)
	...
	build_warnings_tool is
		...
		do
			...
			create l_show_cmd.make (develop_window, l_warnings_tool.content)
	...
	build_errors_tool is
		...
		do
			...
			create l_show_cmd.make (develop_window, l_errors_tool.content)
	...
	build_search_and_report_tool is
		...
		do
			...
			create l_show_cmd.make (develop_window, l_search_tool.content)
			...
			create l_show_report_cmd.make (develop_window, l_search_report_tool.content)
	...
	build_breakpoints_tool is
		...
		do
			...
			create l_show_cmd.make (develop_window, l_breakpoints_tool.content)
	...
	build_favorites_tool is
		...
		do
			...
			create l_show_cmd.make (develop_window, l_favorites_tool.content)
	...
	build_properties_tool is
		...
		do
			...
			create l_show_cmd.make (develop_window, l_properties_tool.content)
	...
	build_windows_tool is
		...
		do
			...
			create l_show_cmd.make (develop_window, l_windows_tool.content)
