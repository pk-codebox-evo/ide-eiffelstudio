...
feature -- Building commands
	...
	build_general_toolbar is
		...
		do
			...
			-- Remove "&" in string
			l_tool_bar_name := develop_window.Interface_names.m_general_toolbar
			l_tool_bar_name.replace_substring_all ("&", "")
	...
	build_address_toolbar is
		...
		local
			...
			l_content: SD_TOOL_BAR_CONTENT
			l_tool_bar_name: STRING
			l_formatters: ARRAYED_LIST [EB_CLASS_TEXT_FORMATTER]
		do
			...
			-- Remove "&" in string
			l_tool_bar_name := develop_window.Interface_names.m_address_toolbar
			l_tool_bar_name.replace_substring_all ("&", "")
	...
	build_project_toolbar is
		...
		do
			...
			-- Remove "&" in string
			l_tool_bar_name := develop_window.Interface_names.m_project_toolbar
			l_tool_bar_name.replace_substring_all ("&", "")
	...
	build_refactoring_toolbar is
		...
		do
			...
			-- Remove "&" in string
			l_tool_bar_name := develop_window.Interface_names.m_refactoring_toolbar
			l_tool_bar_name.replace_substring_all ("&", "")
