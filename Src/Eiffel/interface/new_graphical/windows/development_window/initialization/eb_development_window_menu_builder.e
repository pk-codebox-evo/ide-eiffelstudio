	...
	build_edit_menu is
		...
		do
			...
			develop_window.menus.edit_menu.extend (create {EV_MENU_SEPARATOR})
				...
				-- Search
			create l_cmd.make
			l_cmd.set_menu_name (develop_window.Interface_names.m_search + "%T" + develop_window.preferences.editor_data.shortcuts.item ("show_search_panel").display_string)
			...
			develop_window.menus.edit_menu.extend (l_command_menu_item)
				...
				-- Replace
			create l_cmd.make
			l_cmd.set_menu_name (develop_window.Interface_names.m_replace + "%T" + develop_window.preferences.editor_data.shortcuts.item ("show_search_and_replace_panel").display_string)
			...
			create l_sub_menu.make_with_text (develop_window.Interface_names.m_find)
				...
				-- Find next
			create l_cmd.make
			l_cmd.set_menu_name (develop_window.Interface_names.m_find_next + "%T" + develop_window.preferences.editor_data.shortcuts.item ("search_forward").display_string)
			...
			l_sub_menu.extend (l_command_menu_item)
				...
				-- Find previous
			create l_cmd.make
			l_cmd.set_menu_name (develop_window.Interface_names.m_find_previous + "%T" + develop_window.preferences.editor_data.shortcuts.item ("search_backward").display_string)
			...
			create l_os_cmd.make (develop_window)
			l_os_cmd.set_menu_name (develop_window.Interface_names.m_find_next_selection + "%T" + develop_window.preferences.editor_data.shortcuts.item ("search_selection_forward").display_string)
			...
			create l_os_cmd.make (develop_window)
			l_os_cmd.set_menu_name (develop_window.Interface_names.m_find_previous_selection + "%T" + develop_window.preferences.editor_data.shortcuts.item ("search_selection_backward").display_string)
			l_os_cmd.add_agent (agent develop_window.find_next_selection)
			l_command_menu_item := l_os_cmd.new_menu_item
			l_command_controller.add_selection_command (l_os_cmd)
			develop_window.add_recyclable (l_command_menu_item)
			...
			create l_cmd.make
			l_cmd.set_needs_editable (True)
			l_cmd.set_menu_name (develop_window.Interface_names.m_complete_word + "%T" + develop_window.preferences.editor_data.shortcuts.item ("autocomplete").display_string)
			l_command_menu_item := l_cmd.new_menu_item
			l_command_controller.add_edition_command (l_cmd)
			...
			create l_cmd.make
			l_cmd.set_needs_editable (True)
			l_cmd.set_menu_name (develop_window.Interface_names.m_complete_class_name + "%T" + develop_window.preferences.editor_data.shortcuts.item ("class_autocomplete").display_string)
			l_command_menu_item := l_cmd.new_menu_item
			l_command_controller.add_edition_command (l_cmd)
			...
			create l_cmd.make
			if develop_window.editors_manager.current_editor.view_invisible_symbols then
