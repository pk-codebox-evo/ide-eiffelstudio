...
feature {NONE} -- Initialization
	...
	build_interface is
		...
		do
			...
			create cdd_test_suite_view.make_with_tool (development_window, Current)
			...
			notebook.extend (cdd_test_suite_view.widget)
			if eiffel_layout.has_metrics then
			...
			notebook.item_tab (cdd_test_suite_view.widget).set_pixmap (icon_pixmaps.tool_feature_icon)
			...
			notebook.set_item_text (cdd_test_suite_view.widget, "Testing")
			if eiffel_layout.has_metrics then
...
feature -- Access
	...
	cdd_test_suite_view: CDD_CONTEXT_TOOL
...
feature -- Memory management
	...
	recycle is
		...
		do
			...
			feature_view := Void
			cdd_test_suite_view.recycle
			cdd_test_suite_view := Void
