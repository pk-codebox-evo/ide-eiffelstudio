...
feature -- Properties
	...
	symbol: ARRAY [EV_PIXMAP] is
		...
		once
			...
			Result.put (pixmaps.icon_pixmaps.class_features_deferred_icon, 1)
...
feature {NONE} -- Properties
	...
	command_name: STRING is
			-- Name of the command.
		do
			Result := Interface_names.l_Deferreds.as_lower
		end
...
feature {NONE} -- Implementation
	...
	criterion: QL_CRITERION is
		...
		do
			...
			Result := l_factory.simple_criterion_with_index (l_factory.c_is_deferred)
		end
