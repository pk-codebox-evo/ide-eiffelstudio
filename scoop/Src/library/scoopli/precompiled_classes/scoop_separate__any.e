...
feature -- Output
	...
	out (a_caller_: SCOOP_SEPARATE_TYPE): STRING -- paedde SCOOP_SEPARATE__STRING_8 is -- should it return SEPARATE_STRING?
		local
			a_function_to_evaluate: FUNCTION [ANY, TUPLE, STRING] -- paedde STRING_8]
 		do
