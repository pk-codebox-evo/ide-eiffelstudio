...
feature -- Token codes
	...
	TE_HANDLER: INTEGER is 345
	TE_INDEXING: INTEGER is 346
	TE_INHERIT: INTEGER is 347
	TE_INSPECT: INTEGER is 348
	TE_INVARIANT: INTEGER is 349
	TE_LIKE: INTEGER is 350
	TE_LOCAL: INTEGER is 351
	TE_LOOP: INTEGER is 352
	TE_NOTE: INTEGER is 353
	TE_OBSOLETE: INTEGER is 354
	TE_ONCE: INTEGER is 355
	TE_ONCE_STRING: INTEGER is 356
	TE_REDEFINE: INTEGER is 357
	TE_REFERENCE: INTEGER is 358
	TE_RENAME: INTEGER is 359
	TE_REQUIRE: INTEGER is 360
	TE_RESCUE: INTEGER is 361
	TE_SELECT: INTEGER is 362
	TE_SEPARATE: INTEGER is 363
	TE_THEN: INTEGER is 364
	TE_UNDEFINE: INTEGER is 365
	TE_UNTIL: INTEGER is 366
	TE_VARIANT: INTEGER is 367
	TE_WHEN: INTEGER is 368
	TE_STRING: INTEGER is 369
