...
feature {NONE} -- Implementation
	...
	display_state_text is
		...
		do
			...
			title.set_text ("Add user to EMU Project (Step 3).")
			subtitle.set_text ("Connect to the server and add user to project.")
			message.set_text ("The wizard has collected all the information%N" +
							  "it needs to add the user to the EMU project.%N" +
							  "Click on 'next' to connect to the EMU server and %N" +
							  "add a new user to a project using following settings: %N%N%N"+
							  "server host: %T" + system.server_host + "%N" +
							  "server port: %T" + system.server_port.out + "%N%N" +
							  "project name: %T%T" + system.project_name + "%N" +
							  "project password: %T" + system.project_password + "%N%N" +
							  "user name: %T" + system.user_name + "%N" +
							  "user password: %T" + system.user_pass)
		end
