...
feature -- Token codes
	...
	TE_ATTRIBUTE: INTEGER is 328
	TE_BIT: INTEGER is 329
	TE_CHECK: INTEGER is 330
	TE_CLASS: INTEGER is 331
	TE_CONVERT: INTEGER is 332
	TE_CREATE: INTEGER is 333
	TE_DEBUG: INTEGER is 334
	TE_DO: INTEGER is 335
	TE_ELSE: INTEGER is 336
	TE_ELSEIF: INTEGER is 337
	TE_ENSURE: INTEGER is 338
	TE_EXPANDED: INTEGER is 339
	TE_EXPORT: INTEGER is 340
	TE_EXTERNAL: INTEGER is 341
	TE_FEATURE: INTEGER is 342
	TE_FROM: INTEGER is 343
	TE_IF: INTEGER is 344
	TE_INDEXING: INTEGER is 345
	TE_INHERIT: INTEGER is 346
	TE_INSPECT: INTEGER is 347
	TE_INVARIANT: INTEGER is 348
	TE_LIKE: INTEGER is 349
	TE_LOCAL: INTEGER is 350
	TE_LOOP: INTEGER is 351
	TE_NOTE: INTEGER is 352
	TE_OBSOLETE: INTEGER is 353
	TE_ONCE: INTEGER is 354
	...
	TE_USE: INTEGER is 368
	TE_MODIFY: INTEGER is 369
