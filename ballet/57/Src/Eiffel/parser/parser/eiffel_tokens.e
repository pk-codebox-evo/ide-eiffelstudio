...
feature -- Token codes
	...
	TE_CONFINED: INTEGER is 281
	TE_DOT: INTEGER is 282
	TE_LPARAN: INTEGER is 283
	TE_ID: INTEGER is 284
	TE_TUPLE: INTEGER is 285
	TE_A_BIT: INTEGER is 286
	TE_INTEGER: INTEGER is 287
	TE_REAL: INTEGER is 288
	TE_CHAR: INTEGER is 289
	TE_LSQURE: INTEGER is 290
	TE_RSQURE: INTEGER is 291
	TE_ACCEPT: INTEGER is 292
	TE_ADDRESS: INTEGER is 293
	TE_CURLYTILDE: INTEGER is 294
	...
	TE_USE: INTEGER is 353
	TE_MODIFY: INTEGER is 354
	TE_ONCE_STRING: INTEGER is 355
	TE_REDEFINE: INTEGER is 356
	TE_REFERENCE: INTEGER is 357
	TE_RENAME: INTEGER is 358
	TE_REQUIRE: INTEGER is 359
	TE_RESCUE: INTEGER is 360
	TE_SELECT: INTEGER is 361
	TE_SEPARATE: INTEGER is 362
	TE_THEN: INTEGER is 363
	TE_UNDEFINE: INTEGER is 364
	TE_UNTIL: INTEGER is 365
	TE_VARIANT: INTEGER is 366
	TE_WHEN: INTEGER is 367
	TE_STRING: INTEGER is 368
	TE_EMPTY_STRING: INTEGER is 369
	TE_VERBATIM_STRING: INTEGER is 370
	TE_EMPTY_VERBATIM_STRING: INTEGER is 371
	TE_STR_LT: INTEGER is 372
	TE_STR_LE: INTEGER is 373
	TE_STR_GT: INTEGER is 374
	TE_STR_GE: INTEGER is 375
	TE_STR_MINUS: INTEGER is 376
	TE_STR_PLUS: INTEGER is 377
	TE_STR_STAR: INTEGER is 378
	TE_STR_SLASH: INTEGER is 379
	TE_STR_MOD: INTEGER is 380
	TE_STR_DIV: INTEGER is 381
	TE_STR_POWER: INTEGER is 382
	TE_STR_AND: INTEGER is 383
	TE_STR_AND_THEN: INTEGER is 384
	TE_STR_IMPLIES: INTEGER is 385
	TE_STR_OR: INTEGER is 386
	TE_STR_OR_ELSE: INTEGER is 387
	TE_STR_XOR: INTEGER is 388
	TE_STR_NOT: INTEGER is 389
	TE_STR_FREE: INTEGER is 390
	TE_STR_BRACKET: INTEGER is 391
