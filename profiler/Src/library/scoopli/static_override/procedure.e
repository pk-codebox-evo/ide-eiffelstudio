...
convert
	proxy_: {
			SCOOP_SEPARATE__PROCEDURE[BASE_TYPE, OPEN_ARGS],
			SCOOP_SEPARATE__ANY, SCOOP_SEPARATE_PROXY
	}
...
feature -- Calls
	...
	call (args: detachable OPEN_ARGS)
		-- This is a non-separate call, this means that we do not have to do anything here.
		local
...
feature -- Proxy
	proxy_ : SCOOP_SEPARATE__PROCEDURE[BASE_TYPE, OPEN_ARGS]
