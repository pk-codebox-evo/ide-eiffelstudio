...
feature -- Basic operations
	...
	has_implication (a_list1: LINEAR [EPA_EXPRESSION]; a_list2: LINEAR [EPA_EXPRESSION]; a_theory: EPA_THEORY): BOOLEAN
...
feature -- Access
	...
	valid_premises (a_premises: EPA_STATE_SKELETON; a_consequence: EPA_EXPRESSION; a_theory: EPA_THEORY): EPA_STATE_SKELETON
			-- A state skeleton, in which all element e -> a_consequence
		local
			l_premise: EPA_EXPRESSION
			l_implication: EPA_EXPRESSION
			l_implication_skeleton: EPA_STATE_SKELETON
	...
	simplified_skeleton (a_skeleton: EPA_STATE_SKELETON): EPA_STATE_SKELETON
		...
		local
			...
			l_tautologies: EPA_STATE_SKELETON
		do
			...
			a_skeleton.do_if (
				...
				agent (a_expr: EPA_EXPRESSION; a_tau: EPA_STATE_SKELETON): BOOLEAN
						do
	...
	tautologies (a_skeleton: EPA_STATE_SKELETON): EPA_STATE_SKELETON
	...
	expression_validity (a_expressions: LINEAR [EPA_EXPRESSION]; a_theory: EPA_THEORY): LINKED_LIST [BOOLEAN]
	...
	valid_expressions (a_expressions: LINEAR [EPA_EXPRESSION]; a_theory: EPA_THEORY): LINKED_LIST [EPA_EXPRESSION]
	...
	minimized_premises (a_skeleton: EPA_STATE_SKELETON; a_predicate: EPA_EXPRESSION; a_context: EPA_STATE_SKELETON): detachable EPA_STATE_SKELETON
	...
	minimal_premises_ddmin (a_skeleton: EPA_STATE_SKELETON; a_granularity: INTEGER; a_predicate: EPA_EXPRESSION; a_context: detachable EPA_STATE_SKELETON): detachable EPA_STATE_SKELETON
		...
		local
			l_slices: LINKED_LIST [detachable EPA_STATE_SKELETON]
			l_done: BOOLEAN
			l_subset: detachable EPA_STATE_SKELETON
			l_premises: detachable EPA_STATE_SKELETON
		do
	...
	predicates_with_satisfiability (a_predicates: DS_HASH_SET [EPA_EXPRESSION]; a_satisfiability: NATURAL_8; a_theory: EPA_THEORY): DS_HASH_SET [EPA_EXPRESSION]
	...
	predicate_satisfiability (a_predicates: DS_HASH_SET [EPA_EXPRESSION]; a_theory: EPA_THEORY): HASH_TABLE [NATURAL_8, EPA_EXPRESSION]
...
feature{NONE} -- Implementation
	...
	expression_validity_internal (a_expressions: LINEAR [EPA_EXPRESSION]; a_theory: EPA_THEORY): LINKED_LIST [BOOLEAN]
			-- Validity status of `a_expressions' in the context of `a_theory'.
			-- Result is a list of status, True means the corresponding expression in `a_expressions'
			-- is valid, otherwise, is not valid.
		local
