...
feature -- Basic operations
	...
	process_class (a_class: !CLASS_C)
		...
		do
				-- MML switch
			if a_class.name_in_upper.starts_with ("MML_") then
					-- Don't create code for MML classes
			else
...
-- TODO: this is a hack
					if a_class.is_generic then
						process_generic_creation_routine (l_attached_feature, a_class.actual_type)
					else
...
-- TODO: this is a hack
					if a_class.is_generic then
						process_generic_feature (l_attached_feature, a_class.actual_type)
					else
