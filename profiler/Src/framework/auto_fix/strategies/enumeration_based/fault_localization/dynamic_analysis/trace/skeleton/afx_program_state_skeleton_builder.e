...
feature -- Basic operation
	...
	build_skeleton (a_expressions_monitored: EPA_HASH_SET [AFX_PROGRAM_STATE_EXPRESSION])
		...
		local
			l_boolean_expressions, l_integer_expressions, l_reference_expressions: EPA_HASH_SET [AFX_PROGRAM_STATE_EXPRESSION]
...
--				l_reference_expressions := reference_expressions (a_expressions_monitored)
--				l_reference_count := l_reference_expressions.count

				last_built_skeleton.resize (l_boolean_count * 2 + 3 * l_integer_count * (l_integer_count + 1) + 2 * l_reference_count)
...
--				last_built_skeleton.append (skeleton_based_on_references (l_reference_expressions))
			else
...
feature{NONE} -- Program state aspects
	...
	skeleton_based_on_references (a_expressions: like current_expressions_monitored): AFX_PROGRAM_STATE_SKELETON
		...
		do
			...
			loop
				...
				create l_aspect.make_void_check (l_exp.context_class, l_exp.feature_, l_exp.written_class, 0,
				...
				create l_aspect_neg.make_void_check (l_exp.context_class, l_exp.feature_, l_exp.written_class, 0,
