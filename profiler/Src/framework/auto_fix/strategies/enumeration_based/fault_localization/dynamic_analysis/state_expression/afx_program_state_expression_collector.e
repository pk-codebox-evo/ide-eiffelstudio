...
feature -- Basic operation
	...
	collect_from_ast (a_context_class: CLASS_C; a_feature: FEATURE_I; a_ast: AST_EIFFEL; a_should_reset_collector: BOOLEAN)
			-- Collect all sub-expressions of `a_ast', in the context of `a_context_class'.`a_feature'.
		do
			if a_should_reset_collector then
				reset_collector
			end
