...
feature{NONE} -- Implementation
	...
	passing_test_cases: HASH_TABLE [ARRAYED_LIST [STRING], EPA_TEST_CASE_SIGNATURE]
...
--				l_list.put_i_th (a_test_case_name, random.item \\ max_test_case_number + 1)
	...
	is_test_case_contain_new_state (a_test_case_name: STRING; a_tc_info: EPA_TEST_CASE_SIGNATURE): BOOLEAN
