	...
	frozen print_short_help (a_text_formatter: TEXT_FORMATTER)
		...
		do
			...
			if not l_text.is_empty then
				...
				a_text_formatter.add ("No help available for this error (Cannot read file: ")
				a_text_formatter.add (help_file_name)
				a_text_formatter.add (")");
				a_text_formatter.add_new_line
				a_text_formatter.add ("An error message should always be available. Please contact Eiffel Software.");
				a_text_formatter.add_new_line
			end
			a_text_formatter.add_new_line
		end
