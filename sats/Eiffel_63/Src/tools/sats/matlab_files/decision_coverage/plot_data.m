function [faults, branches]= plot_data (base_directory_name, start_index, end_index, original, start_time, end_time, time_unit, graph_title)
...
[cfaults, cbranches]=central_branch_coverage_data (faults, branches, start_time, end_time, time_unit, 'median');
plot_accumulated_fault_branch_time (cfaults, cbranches, branches, 1, start_time, end_time, time_unit);
title (graph_title);
