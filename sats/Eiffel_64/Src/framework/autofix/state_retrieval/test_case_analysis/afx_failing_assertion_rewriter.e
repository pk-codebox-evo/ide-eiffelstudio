...
feature -- Access
	...
	original_assertion: detachable AFX_EXPRESSION
...
feature{NONE} -- Implementation
	...
	analyze_precondtion_violation (a_tc: AFX_TEST_CASE_INFO; a_structure: AFX_FEATURE_AST_STRUCTURE_NODE; a_trace: STRING)
		...
		do
			...
			create {AFX_AST_EXPRESSION} original_assertion.make_with_text (l_failing_precondition.context_class, feature_of_assertion, l_failing_precondition.text, l_failing_precondition.written_class)
			create l_rewriter
			l_rewriter.rewrite (l_failing_precondition.ast, feature_of_assertion, l_failing_classc, a_tc.recipient_class_, l_target_expression, l_calling_args)
				...
				-- Generate result.
			create {AFX_AST_EXPRESSION} assertion.make_with_text (a_tc.recipient_class_, a_tc.recipient_, l_rewriter.assertion, a_tc.recipient_class_)
			from
