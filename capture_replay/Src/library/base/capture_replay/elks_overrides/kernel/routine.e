...
feature -- Basic operations
	...
	call_from_cr_management_code(args:OPEN_ARGS) is
			-- Make a call from capture_replay management code into the application code and
			-- reenable capture/replay for the duration of the call.
		require
			valid_operands: valid_operands (args)
		deferred
		end
