...
feature{NONE} -- Implementation
	...
	analyze_void_call_target (a_tc: EPA_TEST_CASE_INFO; a_structure: AFX_FEATURE_AST_STRUCTURE_NODE; a_trace: STRING)
			-- Analyze void-call-target violation in `a_tc'.
		local
			l_feature_of_void_target: STRING
			l_culprit_ast: AFX_AST_STRUCTURE_NODE
			l_sub_expression_collector: AFX_PROGRAM_STATE_EXPRESSION_COLLECTOR
			l_sub_expressions: EPA_HASH_SET [AFX_PROGRAM_STATE_EXPRESSION]
			l_expression_ast_text_table: DS_HASH_TABLE [AFX_PROGRAM_STATE_EXPRESSION, STRING]
			l_expression_texts: DS_ARRAYED_LIST [STRING]
			l_sub_expr: AFX_PROGRAM_STATE_EXPRESSION
		...
		do
			...
			l_sub_expression_collector.collect_from_ast (l_culprit_ast.written_class, l_culprit_ast.feature_, l_culprit_ast.ast.ast, True)
			l_sub_expressions := l_sub_expression_collector.last_collection_in_written_class
