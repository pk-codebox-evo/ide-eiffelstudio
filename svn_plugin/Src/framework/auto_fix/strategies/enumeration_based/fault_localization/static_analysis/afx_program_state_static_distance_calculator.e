...
feature{NONE} -- Implementation
	...
	relevance_to_expression (a_expression: AFX_PROGRAM_STATE_EXPRESSION; a_expr_set: DS_HASH_SET [AFX_PROGRAM_STATE_EXPRESSION]): REAL_64
...
--			l_common := l_sub_expressions1.intersection (l_sub_expressions2).count
--			l_total := l_sub_expressions1.count + l_sub_expressions2.count - l_common
--			Result := l_common / l_total
		end
