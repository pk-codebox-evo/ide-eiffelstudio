...
feature -- Repositories handling

	repositories_manager: EB_REPOSITORIES_MANAGER
			-- Graphical manager for repositories, contains the repository trees

	set_repositories_manager (a_repositories_manager: EB_REPOSITORIES_MANAGER)
			-- Set `repositories_manager' to `a_repositories_manager'.
		do
